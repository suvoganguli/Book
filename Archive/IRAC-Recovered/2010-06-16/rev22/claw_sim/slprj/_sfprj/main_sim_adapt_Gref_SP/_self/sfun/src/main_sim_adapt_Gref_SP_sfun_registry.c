...
unsigned int sf_process_check_sum_call( int nlhs, mxArray * plhs[], int nrhs,
  const mxArray * prhs[] )
{
  extern unsigned int sf_main_sim_adapt_Gref_SP_process_check_sum_call( int nlhs,
  ...
  extern unsigned int sf_engine_T2_lib_process_check_sum_call( int nlhs, mxArray
    * plhs[], int nrhs, const mxArray * prhs[] );
  if (sf_main_sim_adapt_Gref_SP_process_check_sum_call(nlhs,plhs,nrhs,prhs))
    return 1;
...
{
  extern unsigned int sf_main_sim_adapt_Gref_SP_autoinheritance_info( int nlhs,
    mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  if (sf_main_sim_adapt_Gref_SP_autoinheritance_info(nlhs,plhs,nrhs,prhs))
    return 1;
  return 0;
}
...
unsigned int sf_process_get_eml_resolved_functions_info_call( int nlhs, mxArray *
  plhs[], int nrhs, const mxArray * prhs[] )
{
  extern unsigned int sf_main_sim_adapt_Gref_SP_get_eml_resolved_functions_info(
  ...
  if (strcmp(machineName, "main_sim_adapt_Gref_SP") == 0) {
    const mxArray *newRhs[2] = { NULL, NULL };

    newRhs[0] = prhs[0];
    newRhs[1] = prhs[2];
    return sf_main_sim_adapt_Gref_SP_get_eml_resolved_functions_info(nlhs,plhs,2,
      newRhs);
  }
...
extern unsigned int sf_main_sim_adapt_Gref_SP_method_dispatcher(SimStruct *S,
...
{
  if (!strcmp(machineName,"main_sim_adapt_Gref_SP")) {
    return(sf_main_sim_adapt_Gref_SP_method_dispatcher(simstructPtr,
...
extern void main_sim_adapt_Gref_SP_terminator(void);
...
void sf_machine_global_terminator(void)
{
  if (sfMachineGlobalTerminatorCallable) {
    ...
    main_sim_adapt_Gref_SP_terminator();
    models_terminator();
...
extern void main_sim_adapt_Gref_SP_initializer(void);
...
extern void main_sim_adapt_Gref_SP_register_exported_symbols(SimStruct* S);
...
extern void main_sim_adapt_Gref_SP_debug_initialize(void);
...
{
  main_sim_adapt_Gref_SP_register_exported_symbols(S);
...
void sf_machine_global_initializer(SimStruct* S)
{
  ...
  if (sfMachineGlobalInitializerCallable) {
    ...
    if (!simModeIsRTWGen) {
      main_sim_adapt_Gref_SP_debug_initialize();
    }

    main_sim_adapt_Gref_SP_initializer();
    if (!simModeIsRTWGen) {
