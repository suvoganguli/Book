  ...
  if (nrhs>2 && mxIsChar(prhs[1])) {
    ...
    if (!strcmp(commandName,"library")) {
      ...
      if (!strcmp(machineName,"GTM_aerolib")) {
        if (nrhs==3) {
          ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(3837164756U);
          ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(875471817U);
          ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(3401560998U);
          ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(1956036898U);
        } else if (nrhs==4) {
