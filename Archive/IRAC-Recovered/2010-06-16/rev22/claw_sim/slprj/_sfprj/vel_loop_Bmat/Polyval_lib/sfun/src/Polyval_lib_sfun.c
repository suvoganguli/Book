  ...
  if (nrhs>2 && mxIsChar(prhs[1])) {
    ...
    if (!strcmp(commandName,"library")) {
      ...
      if (!strcmp(machineName,"Polyval_lib")) {
        if (nrhs==3) {
          ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(3020283599U);
          ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(2988218436U);
          ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(1522996675U);
          ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(2453479061U);
        } else if (nrhs==4) {
