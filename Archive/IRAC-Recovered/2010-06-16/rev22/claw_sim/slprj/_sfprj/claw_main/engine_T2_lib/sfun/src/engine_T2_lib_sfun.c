  ...
  if (nrhs>2 && mxIsChar(prhs[1])) {
    ...
    if (!strcmp(commandName,"library")) {
      ...
      if (!strcmp(machineName,"engine_T2_lib")) {
        if (nrhs==3) {
          ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(3563368013U);
          ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(207666832U);
          ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(4056986838U);
          ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(3762831614U);
        } else if (nrhs==4) {
