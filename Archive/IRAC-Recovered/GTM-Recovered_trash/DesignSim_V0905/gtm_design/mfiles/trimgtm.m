...
switch AircraftType
    ...
    case 'GTM_T2'
        ...
        % Get index offsets to relevant states, EOM, Engine dynamics and actuator servos
        Index.EOM  = find(strcmp(StateNames,['gtm_design/Aircraft Model/EOM/Integrator'])==1);
        Index.Eng = [...
            find(strcmp(StateNames,['gtm_design/Aircraft Model/Engines/Jetcat P70 (Left)/Tunable Lag/Integrator'])==1),...
            find(strcmp(StateNames,['gtm_design/Aircraft Model/Engines/Jetcat P70 (Right)/Tunable Lag/Integrator'])==1)
            ];
        Index.Stb = find(strcmp(StateNames,['gtm_design/Aircraft Model/Actuators/StabilizerServo/Integrator']));
        Index.Ele = [...
            find(strcmp(StateNames,['gtm_design/Aircraft Model/Actuators/ElevatorLOBServo/Integrator'])),...
            find(strcmp(StateNames,['gtm_design/Aircraft Model/Actuators/ElevatorLIBServo/Integrator'])),...
            find(strcmp(StateNames,['gtm_design/Aircraft Model/Actuators/ElevatorROBServo/Integrator'])),...
            find(strcmp(StateNames,['gtm_design/Aircraft Model/Actuators/ElevatorRIBServo/Integrator']))];
        Index.Ail = [...
            find(strcmp(StateNames,['gtm_design/Aircraft Model/Actuators/LeftAileronServo/Integrator'])),...
            find(strcmp(StateNames,['gtm_design/Aircraft Model/Actuators/RightAileronServo/Integrator']))];
        Index.Rud =  [...
            find(strcmp(StateNames,['gtm_design/Aircraft Model/Actuators/RudderUServo/Integrator'])),...
            find(strcmp(StateNames,['gtm_design/Aircraft Model/Actuators/RudderLServo/Integrator']))];
end
...
options = struct('MaxIter', 1000);[XU_opt, opt] = simcnstr('trim', @(x) simio(x, Xo, Index, target, TrimWithStab, AircraftType), XU_0, para, XU_lower, XU_upper, [], options);
