...
static void initialize_c2_GTM_aerolib(SFc2_GTM_aerolibInstanceStruct
  *chartInstance);
static void initialize_params_c2_GTM_aerolib(SFc2_GTM_aerolibInstanceStruct
  *chartInstance);
static void enable_c2_GTM_aerolib(SFc2_GTM_aerolibInstanceStruct *chartInstance);
static void disable_c2_GTM_aerolib(SFc2_GTM_aerolibInstanceStruct *chartInstance);
static void update_debugger_state_c2_GTM_aerolib(SFc2_GTM_aerolibInstanceStruct *
  chartInstance);
static const mxArray *get_sim_state_c2_GTM_aerolib
  (SFc2_GTM_aerolibInstanceStruct *chartInstance);
static void set_sim_state_c2_GTM_aerolib(SFc2_GTM_aerolibInstanceStruct
  *chartInstance, const mxArray *c2_st);
static void finalize_c2_GTM_aerolib(SFc2_GTM_aerolibInstanceStruct
  *chartInstance);
static void sf_c2_GTM_aerolib(SFc2_GTM_aerolibInstanceStruct *chartInstance);
static void c2_c2_GTM_aerolib(SFc2_GTM_aerolibInstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c2_machineNumber, uint32_T
  c2_chartNumber);
static void c2_eml_warning(SFc2_GTM_aerolibInstanceStruct *chartInstance);
...
static void init_dsm_address_info(SFc2_GTM_aerolibInstanceStruct *chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c2_is_active_c2_GTM_aerolib = 0U;
}
...
static void sf_c2_GTM_aerolib(SFc2_GTM_aerolibInstanceStruct *chartInstance)
{
  ...
  c2_c2_GTM_aerolib(chartInstance);
...
static const mxArray *c2_sf_marshall(void *chartInstanceVoid, void *c2_u)
{
  ...
  const mxArray *c2_b_y = NULL;
  SFc2_GTM_aerolibInstanceStruct *chartInstance;
  chartInstance = (SFc2_GTM_aerolibInstanceStruct *)chartInstanceVoid;
  c2_y = NULL;
  c2_b_u = *((real_T *)c2_u);
  c2_b_y = NULL;
...
const mxArray *sf_c2_GTM_aerolib_get_eml_resolved_functions_info(void)
{
...
static void c2_info_helper(c2_ResolvedFunctionInfo c2_info[31])
{
  ...
  c2_info[0].name = "class";
  c2_info[0].dominantType = "double";
  c2_info[0].resolved = "[B]class";
  ...
  c2_info[1].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/mtimes.m";
  c2_info[1].fileLength = 2336U;
  c2_info[1].fileTime1 = 1213662890U;
  ...
  c2_info[5].context = "";
  c2_info[5].name = "times";
  c2_info[5].dominantType = "double";
  c2_info[5].resolved = "[B]times";
  ...
  c2_info[7].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/elfun/abs.m";
  c2_info[7].fileLength = 538U;
  c2_info[7].fileTime1 = 1203473128U;
  ...
  c2_info[11].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_div.m";
  c2_info[11].fileLength = 4254U;
  c2_info[11].fileTime1 = 1192491972U;
  c2_info[11].fileTime2 = 0U;
  c2_info[12].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/elfun/cos.m";
  c2_info[12].name = "eml_scalar_cos";
  c2_info[12].dominantType = "double";
  c2_info[12].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/elfun/eml_scalar_cos.m";
  c2_info[12].fileLength = 602U;
  c2_info[12].fileTime1 = 1209355988U;
  c2_info[12].fileTime2 = 0U;
  c2_info[13].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/rdivide.m";
  c2_info[13].name = "gt";
  c2_info[13].dominantType = "double";
  c2_info[13].resolved = "[B]gt";
  ...
  c2_info[14].name = "eml_scalar_sin";
  c2_info[14].dominantType = "double";
  c2_info[14].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/elfun/eml_scalar_sin.m";
  c2_info[14].fileLength = 601U;
  c2_info[14].fileTime1 = 1209355992U;
  ...
  c2_info[16].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/mrdivide.m";
  c2_info[16].name = "nargin";
  c2_info[16].dominantType = "";
  c2_info[16].resolved = "[B]nargin";
  ...
  c2_info[18].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/elfun/abs.m";
  c2_info[18].name = "islogical";
  c2_info[18].dominantType = "double";
  c2_info[18].resolved = "[B]islogical";
  ...
  c2_info[20].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/elfun/sin.m";
  c2_info[20].fileLength = 324U;
  c2_info[20].fileTime1 = 1203473242U;
  c2_info[20].fileTime2 = 0U;
  c2_info[21].context = "";
  c2_info[21].name = "pi";
  c2_info[21].dominantType = "";
  c2_info[21].resolved = "[B]pi";
  c2_info[21].fileLength = 0U;
  c2_info[21].fileTime1 = 0U;
  c2_info[21].fileTime2 = 0U;
  c2_info[22].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/mrdivide.m";
  c2_info[22].name = "rdivide";
  c2_info[22].dominantType = "double";
  c2_info[22].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/rdivide.m";
  c2_info[22].fileLength = 620U;
  c2_info[22].fileTime1 = 1213662890U;
  c2_info[22].fileTime2 = 0U;
  c2_info[23].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_div.m";
  c2_info[23].name = "isinteger";
  c2_info[23].dominantType = "double";
  c2_info[23].resolved = "[B]isinteger";
  ...
  c2_info[24].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/mrdivide.m";
  c2_info[24].fileLength = 755U;
  c2_info[24].fileTime1 = 1209356082U;
  c2_info[24].fileTime2 = 0U;
  c2_info[25].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/mrdivide.m";
  c2_info[25].name = "isscalar";
  c2_info[25].dominantType = "double";
  c2_info[25].resolved = "[B]isscalar";
  ...
  c2_info[26].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/elfun/cos.m";
  c2_info[26].fileLength = 324U;
  c2_info[26].fileTime1 = 1203473152U;
  c2_info[26].fileTime2 = 0U;
  c2_info[27].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/rdivide.m";
  ...
  c2_info[28].fileLength = 262U;
  c2_info[28].fileTime1 = 1213662888U;
...
/* SFunction Glue Code */
void sf_c2_GTM_aerolib_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c2_GTM_aerolib_get_autoinheritance_info(void)
{
...
{
  SFc2_GTM_aerolibInstanceStruct *chartInstance;
  chartInstance = (SFc2_GTM_aerolibInstanceStruct *) ((ChartInfoStruct *)
...
static void sf_opaque_initialize_c2_GTM_aerolib(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc2_GTM_aerolibInstanceStruct*) chartInstanceVar)
    ->S,0);
  initialize_params_c2_GTM_aerolib((SFc2_GTM_aerolibInstanceStruct*)
    chartInstanceVar);
  initialize_c2_GTM_aerolib((SFc2_GTM_aerolibInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c2_GTM_aerolib(void *chartInstanceVar)
{
  enable_c2_GTM_aerolib((SFc2_GTM_aerolibInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c2_GTM_aerolib(void *chartInstanceVar)
{
  disable_c2_GTM_aerolib((SFc2_GTM_aerolibInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c2_GTM_aerolib(void *chartInstanceVar)
{
  sf_c2_GTM_aerolib((SFc2_GTM_aerolibInstanceStruct*) chartInstanceVar);
}

static mxArray* sf_opaque_get_sim_state_c2_GTM_aerolib(void *chartInstanceVar)
{
  mxArray *st = (mxArray *) get_sim_state_c2_GTM_aerolib
    ((SFc2_GTM_aerolibInstanceStruct*) chartInstanceVar);
  return st;
}

static void sf_opaque_set_sim_state_c2_GTM_aerolib(void *chartInstanceVar, const
  mxArray *st)
{
  set_sim_state_c2_GTM_aerolib((SFc2_GTM_aerolibInstanceStruct*)
    chartInstanceVar, sf_mex_dup(st));
}

static void sf_opaque_terminate_c2_GTM_aerolib(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc2_GTM_aerolibInstanceStruct*) chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
    }

    finalize_c2_GTM_aerolib((SFc2_GTM_aerolibInstanceStruct*) chartInstanceVar);
...
static void mdlProcessParameters_c2_GTM_aerolib(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c2_GTM_aerolib(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    int_T chartIsInlinable =
      (int_T)sf_is_chart_inlinable("GTM_aerolib","gtm_design",2);
    ssSetStateflowIsInlinable(S,chartIsInlinable);
    ssSetRTWCG(S,sf_rtw_info_uint_prop("GTM_aerolib","gtm_design",2,"RTWCG"));
    ssSetEnableFcnIsTrivial(S,1);
    ssSetDisableFcnIsTrivial(S,1);
    ssSetNotMultipleInlinable(S,sf_rtw_info_uint_prop("GTM_aerolib","gtm_design",
    ...
    if (chartIsInlinable) {
      ...
      sf_mark_chart_expressionable_inputs(S,"GTM_aerolib","gtm_design",2,6);
      sf_mark_chart_reusable_outputs(S,"GTM_aerolib","gtm_design",2,2);
    }

    sf_set_rtw_dwork_info(S,"GTM_aerolib","gtm_design",2);
...
static void mdlRTW_c2_GTM_aerolib(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
    sf_write_symbol_mapping(S, "GTM_aerolib", "gtm_design",2);
    ssWriteRTWStrParam(S, "StateflowChartType", "Embedded MATLAB");
  }
}

static void mdlStart_c2_GTM_aerolib(SimStruct *S)
{
  SFc2_GTM_aerolibInstanceStruct *chartInstance;
  chartInstance = (SFc2_GTM_aerolibInstanceStruct *)malloc(sizeof
    (SFc2_GTM_aerolibInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c2_GTM_aerolib;
  chartInstance->chartInfo.initializeChart = sf_opaque_initialize_c2_GTM_aerolib;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c2_GTM_aerolib;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c2_GTM_aerolib;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c2_GTM_aerolib;
  chartInstance->chartInfo.getSimState = sf_opaque_get_sim_state_c2_GTM_aerolib;
  chartInstance->chartInfo.setSimState = sf_opaque_set_sim_state_c2_GTM_aerolib;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c2_GTM_aerolib;
  chartInstance->chartInfo.mdlStart = mdlStart_c2_GTM_aerolib;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c2_GTM_aerolib;
...
void c2_GTM_aerolib_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c2_GTM_aerolib(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c2_GTM_aerolib(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c2_GTM_aerolib(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c2_GTM_aerolib_method_dispatcher.\n"
