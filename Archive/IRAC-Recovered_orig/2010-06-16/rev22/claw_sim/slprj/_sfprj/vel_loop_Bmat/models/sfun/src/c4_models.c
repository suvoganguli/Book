...
static void c4_info_helper(c4_ResolvedFunctionInfo c4_info[45])
{
  ...
  c4_info[2].name = "nargout";
  c4_info[2].dominantType = "";
  c4_info[2].resolved = "[B]nargout";
  ...
  c4_info[3].name = "eml_index_class";
  c4_info[3].dominantType = "";
  c4_info[3].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_index_class.m";
  c4_info[3].fileLength = 909U;
  c4_info[3].fileTime1 = 1192491982U;
  ...
  c4_info[6].context = "";
  c4_info[6].name = "times";
  c4_info[6].dominantType = "double";
  c4_info[6].resolved = "[B]times";
  ...
  c4_info[13].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/datafun/min.m";
  c4_info[13].name = "le";
  c4_info[13].dominantType = "double";
  c4_info[13].resolved = "[B]le";
  c4_info[13].fileLength = 0U;
  c4_info[13].fileTime1 = 0U;
  c4_info[13].fileTime2 = 0U;
  c4_info[14].context =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_assert_valid_size_arg.m/isintegral";
  c4_info[14].name = "true";
  c4_info[14].dominantType = "";
  c4_info[14].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/true.m";
  c4_info[14].fileLength = 237U;
  c4_info[14].fileTime1 = 1192491962U;
  c4_info[14].fileTime2 = 0U;
  c4_info[15].context =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_assert_valid_size_arg.m/isintegral";
  c4_info[15].name = "isinteger";
  c4_info[15].dominantType = "double";
  c4_info[15].resolved = "[B]isinteger";
  ...
  c4_info[19].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/datafun/min.m";
  c4_info[19].fileLength = 308U;
  c4_info[19].fileTime1 = 1192491834U;
  ...
  c4_info[21].context =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_min_or_max.m";
  c4_info[21].name = "isnumeric";
  c4_info[21].dominantType = "double";
  c4_info[21].resolved = "[B]isnumeric";
  ...
  c4_info[24].name = "double";
  c4_info[24].dominantType = "double";
  c4_info[24].resolved = "[B]double";
  c4_info[24].fileLength = 0U;
  c4_info[24].fileTime1 = 0U;
  c4_info[24].fileTime2 = 0U;
  c4_info[25].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_alloc.m";
  c4_info[25].name = "eml_assert_valid_size_arg";
  c4_info[25].dominantType = "double";
  c4_info[25].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_assert_valid_size_arg.m";
  c4_info[25].fileLength = 2835U;
  c4_info[25].fileTime1 = 1210895844U;
  ...
  c4_info[27].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/datafun/min.m";
  c4_info[27].name = "gt";
  c4_info[27].dominantType = "double";
  c4_info[27].resolved = "[B]gt";
  c4_info[27].fileLength = 0U;
  c4_info[27].fileTime1 = 0U;
  c4_info[27].fileTime2 = 0U;
  c4_info[28].context =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_assert_valid_size_arg.m";
  c4_info[28].name = "isvector";
  c4_info[28].dominantType = "double";
  c4_info[28].resolved = "[B]isvector";
  ...
  c4_info[30].context =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/isfinite.m";
  c4_info[30].name = "isinf";
  c4_info[30].dominantType = "double";
  c4_info[30].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/isinf.m";
  c4_info[30].fileLength = 472U;
  c4_info[30].fileTime1 = 1192491934U;
  c4_info[30].fileTime2 = 0U;
  c4_info[31].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/datafun/min.m";
  c4_info[31].name = "nargin";
  c4_info[31].dominantType = "";
  c4_info[31].resolved = "[B]nargin";
  ...
  c4_info[32].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/mtimes.m";
  c4_info[32].fileLength = 2336U;
  c4_info[32].fileTime1 = 1213662890U;
  c4_info[32].fileTime2 = 0U;
  c4_info[33].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/intmax.m";
  c4_info[33].name = "int32";
  c4_info[33].dominantType = "double";
  c4_info[33].resolved = "[B]int32";
  c4_info[33].fileLength = 0U;
  c4_info[33].fileTime1 = 0U;
  c4_info[33].fileTime2 = 0U;
  c4_info[34].context =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_scalexp_size.m";
  c4_info[34].name = "eml_scalexp_compatible";
  c4_info[34].dominantType = "double";
  c4_info[34].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_scalexp_compatible.m";
  c4_info[34].fileLength = 502U;
  c4_info[34].fileTime1 = 1208205258U;
  c4_info[34].fileTime2 = 0U;
  c4_info[35].context =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_scalexp_compatible.m";
  c4_info[35].name = "isscalar";
  c4_info[35].dominantType = "double";
  c4_info[35].resolved = "[B]isscalar";
  c4_info[35].fileLength = 0U;
  c4_info[35].fileTime1 = 0U;
  c4_info[35].fileTime2 = 0U;
  c4_info[36].context =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_assert_valid_size_arg.m";
  c4_info[36].name = "intmax";
  c4_info[36].dominantType = "char";
  c4_info[36].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/intmax.m";
  c4_info[36].fileLength = 1535U;
  c4_info[36].fileTime1 = 1192491928U;
  c4_info[36].fileTime2 = 0U;
  c4_info[37].context =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_min_or_max.m/eml_bin_extremum";
  c4_info[37].name = "eml_alloc";
  c4_info[37].dominantType = "double";
  c4_info[37].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_alloc.m";
  c4_info[37].fileLength = 2627U;
  c4_info[37].fileTime1 = 1213662886U;
  c4_info[37].fileTime2 = 0U;
  c4_info[38].context =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_min_or_max.m";
  c4_info[38].name = "ischar";
  c4_info[38].dominantType = "char";
  c4_info[38].resolved = "[B]ischar";
  c4_info[38].fileLength = 0U;
  c4_info[38].fileTime1 = 0U;
  c4_info[38].fileTime2 = 0U;
  c4_info[39].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_alloc.m";
  c4_info[39].name = "zeros";
  c4_info[39].dominantType = "double";
  c4_info[39].resolved = "[B]zeros";
  c4_info[39].fileLength = 0U;
  c4_info[39].fileTime1 = 0U;
  c4_info[39].fileTime2 = 0U;
  c4_info[40].context =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_min_or_max.m";
  c4_info[40].name = "class";
  c4_info[40].dominantType = "double";
  c4_info[40].resolved = "[B]class";
  c4_info[40].fileLength = 0U;
  c4_info[40].fileTime1 = 0U;
  c4_info[40].fileTime2 = 0U;
  c4_info[41].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/false.m";
  c4_info[41].name = "logical";
  c4_info[41].dominantType = "double";
  c4_info[41].resolved = "[B]logical";
  ...
  c4_info[42].name = "eml_min_or_max";
  c4_info[42].dominantType = "char";
  c4_info[42].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_min_or_max.m";
  c4_info[42].fileLength = 7562U;
  c4_info[42].fileTime1 = 1213662886U;
  c4_info[42].fileTime2 = 0U;
  c4_info[43].context =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_assert_valid_size_arg.m/isintegral";
  c4_info[43].name = "ne";
  c4_info[43].dominantType = "double";
  c4_info[43].resolved = "[B]ne";
...
static void mdlSetWorkWidths_c4_models(SimStruct *S)
{
  ...
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    int_T chartIsInlinable =
      (int_T)sf_is_chart_inlinable("models","vel_loop_Bmat",4);
    ssSetStateflowIsInlinable(S,chartIsInlinable);
    ssSetRTWCG(S,sf_rtw_info_uint_prop("models","vel_loop_Bmat",4,"RTWCG"));
    ssSetEnableFcnIsTrivial(S,1);
    ssSetDisableFcnIsTrivial(S,1);
    ssSetNotMultipleInlinable(S,sf_rtw_info_uint_prop("models","vel_loop_Bmat",4,
      "gatewayCannotBeInlinedMultipleTimes"));
    if (chartIsInlinable) {
      ssSetInputPortOptimOpts(S, 0, SS_REUSABLE_AND_LOCAL);
      sf_mark_chart_expressionable_inputs(S,"models","vel_loop_Bmat",4,1);
      sf_mark_chart_reusable_outputs(S,"models","vel_loop_Bmat",4,1);
    }

    sf_set_rtw_dwork_info(S,"models","vel_loop_Bmat",4);
...
{
  if (sim_mode_is_rtw_gen(S)) {
    sf_write_symbol_mapping(S, "models", "vel_loop_Bmat",4);
