  ...
  unsigned int chartFileNumber, int_T method, void *data)
{
  if (chartFileNumber==1) {
    c1_engine_T2_lib_method_dispatcher(simstructPtr, method, data);
    return 1;
  }
  ...
  if (nrhs>2 && mxIsChar(prhs[1])) {
    ...
    if (!strcmp(commandName,"library")) {
      ...
      if (!strcmp(machineName,"engine_T2_lib")) {
        if (nrhs==3) {
          ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(1648717248U);
          ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(2612113129U);
          ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(2366546237U);
          ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(2751144859U);
        } else if (nrhs==4) {
          ...
          switch (chartFileNumber) {
           case 1:
            {
              extern void sf_c1_engine_T2_lib_get_check_sum(mxArray *plhs[]);
              sf_c1_engine_T2_lib_get_check_sum(plhs);
              break;
            }
  ...
  int nrhs, const mxArray * prhs[] )
{
...

  {
    ...
    switch (chartFileNumber) {
     case 1:
      {
        extern mxArray *sf_c1_engine_T2_lib_get_autoinheritance_info(void);
        plhs[0] = sf_c1_engine_T2_lib_get_autoinheritance_info();
        break;
      }
     ...
     case 1:
      {
        extern const mxArray
          *sf_c1_engine_T2_lib_get_eml_resolved_functions_info(void);
        mxArray *persistentMxArray = (mxArray *)
          sf_c1_engine_T2_lib_get_eml_resolved_functions_info();
