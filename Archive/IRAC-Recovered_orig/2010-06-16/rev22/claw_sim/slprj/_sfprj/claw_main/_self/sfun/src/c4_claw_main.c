...
#include "claw_main_sfun_debug_macros.h"
...
static SFc4_claw_mainInstanceStruct chartInstance;

/* Function Declarations */
static void initialize_c4_claw_main(void);
static void initialize_params_c4_claw_main(void);
static void enable_c4_claw_main(void);
static void disable_c4_claw_main(void);
static void update_debugger_state_c4_claw_main(void);
static const mxArray *get_sim_state_c4_claw_main(void);
static void set_sim_state_c4_claw_main(const mxArray *c4_st);
static void finalize_c4_claw_main(void);
static void sf_c4_claw_main(void);
static void c4_c4_claw_main(void);
...
static void initialize_c4_claw_main(void)
{
  ...
  chartInstance.c4_is_active_c4_claw_main = 0U;
}
...
static void sf_c4_claw_main(void)
{
  ...
  sf_debug_check_for_state_inconsistency(_claw_mainMachineNumber_,
...
const mxArray *sf_c4_claw_main_get_eml_resolved_functions_info(void)
{
...
static void c4_info_helper(c4_ResolvedFunctionInfo c4_info[88])
{
  ...
  c4_info[0].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/datafun/max.m";
  c4_info[0].fileLength = 308U;
  c4_info[0].fileTime1 = 1192491830U;
  c4_info[0].fileTime2 = 0U;
  c4_info[1].context = "";
  c4_info[1].name = "abs";
  c4_info[1].dominantType = "double";
  c4_info[1].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/elfun/abs.m";
  c4_info[1].fileLength = 538U;
  c4_info[1].fileTime1 = 1203473128U;
  c4_info[1].fileTime2 = 0U;
  c4_info[2].context = "";
  c4_info[2].name = "times";
  c4_info[2].dominantType = "double";
  c4_info[2].resolved = "[B]times";
  ...
  c4_info[7].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/mtimes.m";
  c4_info[7].name = "class";
  c4_info[7].dominantType = "double";
  c4_info[7].resolved = "[B]class";
  c4_info[7].fileLength = 0U;
  c4_info[7].fileTime1 = 0U;
  c4_info[7].fileTime2 = 0U;
  c4_info[8].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/isfinite.m";
  c4_info[8].name = "isnan";
  c4_info[8].dominantType = "double";
  c4_info[8].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/isnan.m";
  c4_info[8].fileLength = 472U;
  c4_info[8].fileTime1 = 1192491936U;
  c4_info[8].fileTime2 = 0U;
  c4_info[9].context = "";
  c4_info[9].name = "minus";
  c4_info[9].dominantType = "double";
  c4_info[9].resolved = "[B]minus";
  c4_info[9].fileLength = 0U;
  c4_info[9].fileTime1 = 0U;
  c4_info[9].fileTime2 = 0U;
  c4_info[10].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/mtimes.m";
  ...
  c4_info[11].resolved = "[B]le";
  c4_info[11].fileLength = 0U;
  c4_info[11].fileTime1 = 0U;
  c4_info[11].fileTime2 = 0U;
  c4_info[12].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/all.m";
  c4_info[12].name = "eml_all_or_any";
  c4_info[12].dominantType = "char";
  c4_info[12].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_all_or_any.m";
  c4_info[12].fileLength = 3423U;
  c4_info[12].fileTime1 = 1213662886U;
  c4_info[12].fileTime2 = 0U;
  c4_info[13].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_alloc.m";
  c4_info[13].name = "eml_assert_valid_size_arg";
  c4_info[13].dominantType = "double";
  c4_info[13].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_assert_valid_size_arg.m";
  c4_info[13].fileLength = 2835U;
  c4_info[13].fileTime1 = 1210895844U;
  c4_info[13].fileTime2 = 0U;
  c4_info[14].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/mrdivide.m";
  c4_info[14].name = "rdivide";
  c4_info[14].dominantType = "double";
  c4_info[14].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/rdivide.m";
  c4_info[14].fileLength = 620U;
  c4_info[14].fileTime1 = 1213662890U;
  c4_info[14].fileTime2 = 0U;
  c4_info[15].context =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/blas/eml_xcabs1.m";
  c4_info[15].name = "imag";
  c4_info[15].dominantType = "double";
  c4_info[15].resolved = "[B]imag";
  ...
  c4_info[16].name = "isfinite";
  c4_info[16].dominantType = "double";
  c4_info[16].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/isfinite.m";
  c4_info[16].fileLength = 341U;
  c4_info[16].fileTime1 = 1192491934U;
  c4_info[16].fileTime2 = 0U;
  c4_info[17].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/mtimes.m";
  c4_info[17].name = "nargin";
  c4_info[17].dominantType = "";
  c4_info[17].resolved = "[B]nargin";
  c4_info[17].fileLength = 0U;
  c4_info[17].fileTime1 = 0U;
  c4_info[17].fileTime2 = 0U;
  c4_info[18].context =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_assert_valid_size_arg.m";
  c4_info[18].name = "isreal";
  c4_info[18].dominantType = "double";
  c4_info[18].resolved = "[B]isreal";
  ...
  c4_info[19].name = "eml_refblas_xdotx";
  c4_info[19].dominantType = "int32";
  c4_info[19].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/blas/refblas/eml_refblas_xdotx.m";
  c4_info[19].fileLength = 1786U;
  c4_info[19].fileTime1 = 1210895856U;
  c4_info[19].fileTime2 = 0U;
  c4_info[20].context =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/isfinite.m";
  c4_info[20].name = "and";
  c4_info[20].dominantType = "logical";
  c4_info[20].resolved = "[B]and";
  ...
  c4_info[21].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/all.m";
  c4_info[21].fileLength = 400U;
  c4_info[21].fileTime1 = 1192492104U;
  c4_info[21].fileTime2 = 0U;
  c4_info[22].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/mpower.m";
  c4_info[22].name = "ndims";
  c4_info[22].dominantType = "double";
  c4_info[22].resolved = "[B]ndims";
  c4_info[22].fileLength = 0U;
  c4_info[22].fileTime1 = 0U;
  c4_info[22].fileTime2 = 0U;
  c4_info[23].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/mpower.m";
  c4_info[23].name = "power";
  c4_info[23].dominantType = "double";
  c4_info[23].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/power.m";
  c4_info[23].fileLength = 5131U;
  c4_info[23].fileTime1 = 1213662890U;
  c4_info[23].fileTime2 = 0U;
  c4_info[24].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/mtimes.m";
  c4_info[24].name = "isscalar";
  c4_info[24].dominantType = "double";
  c4_info[24].resolved = "[B]isscalar";
  c4_info[24].fileLength = 0U;
  c4_info[24].fileTime1 = 0U;
  c4_info[24].fileTime2 = 0U;
  c4_info[25].context = "";
  c4_info[25].name = "sqrt";
  c4_info[25].dominantType = "double";
  c4_info[25].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/elfun/sqrt.m";
  c4_info[25].fileLength = 572U;
  c4_info[25].fileTime1 = 1203473246U;
  c4_info[25].fileTime2 = 0U;
  c4_info[26].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/mpower.m";
  c4_info[26].name = "assert";
  c4_info[26].dominantType = "char";
  c4_info[26].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/lang/assert.m";
  c4_info[26].fileLength = 2684U;
  c4_info[26].fileTime1 = 1210895856U;
  c4_info[26].fileTime2 = 0U;
  c4_info[27].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/mtimes.m";
  c4_info[27].name = "eml_xgemm";
  c4_info[27].dominantType = "int32";
  c4_info[27].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/blas/eml_xgemm.m";
  c4_info[27].fileLength = 3184U;
  c4_info[27].fileTime1 = 1209356052U;
  c4_info[27].fileTime2 = 0U;
  c4_info[28].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/datafun/max.m";
  c4_info[28].name = "eml_min_or_max";
  c4_info[28].dominantType = "char";
  c4_info[28].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_min_or_max.m";
  c4_info[28].fileLength = 7562U;
  c4_info[28].fileTime1 = 1213662886U;
  c4_info[28].fileTime2 = 0U;
  c4_info[29].context =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_assert_valid_size_arg.m";
  c4_info[29].name = "intmax";
  c4_info[29].dominantType = "char";
  c4_info[29].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/intmax.m";
  c4_info[29].fileLength = 1535U;
  c4_info[29].fileTime1 = 1192491928U;
  c4_info[29].fileTime2 = 0U;
  c4_info[30].context = "";
  c4_info[30].name = "mtimes";
  c4_info[30].dominantType = "double";
  c4_info[30].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/mtimes.m";
  c4_info[30].fileLength = 2336U;
  c4_info[30].fileTime1 = 1213662890U;
  c4_info[30].fileTime2 = 0U;
  c4_info[31].context =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/blas/internal/eml_blas_xgemm.m";
  c4_info[31].name = "eml_refblas_xgemm";
  c4_info[31].dominantType = "int32";
  c4_info[31].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/blas/refblas/eml_refblas_xgemm.m";
  c4_info[31].fileLength = 5746U;
  c4_info[31].fileTime1 = 1210895858U;
  c4_info[31].fileTime2 = 0U;
  c4_info[32].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/power.m";
  c4_info[32].name = "eml_scalexp_size";
  c4_info[32].dominantType = "double";
  c4_info[32].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_scalexp_size.m";
  c4_info[32].fileLength = 1373U;
  c4_info[32].fileTime1 = 1208205260U;
  c4_info[32].fileTime2 = 0U;
  c4_info[33].context = "";
  c4_info[33].name = "min";
  c4_info[33].dominantType = "double";
  c4_info[33].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/datafun/min.m";
  c4_info[33].fileLength = 308U;
  c4_info[33].fileTime1 = 1192491834U;
  c4_info[33].fileTime2 = 0U;
  c4_info[34].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/mtimes.m";
  c4_info[34].name = "isempty";
  c4_info[34].dominantType = "double";
  c4_info[34].resolved = "[B]isempty";
  ...
  c4_info[35].name = "eml_blas_xdot";
  c4_info[35].dominantType = "int32";
  c4_info[35].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/blas/internal/eml_blas_xdot.m";
  c4_info[35].fileLength = 238U;
  c4_info[35].fileTime1 = 1192492052U;
  c4_info[35].fileTime2 = 0U;
  c4_info[36].context = "";
  c4_info[36].name = "uminus";
  c4_info[36].dominantType = "double";
  c4_info[36].resolved = "[B]uminus";
  c4_info[36].fileLength = 0U;
  c4_info[36].fileTime1 = 0U;
  c4_info[36].fileTime2 = 0U;
  c4_info[37].context =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_all_or_any.m";
  c4_info[37].name = "eml_set_singleton_dim";
  c4_info[37].dominantType = "double";
  c4_info[37].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_set_singleton_dim.m";
  c4_info[37].fileLength = 398U;
  c4_info[37].fileTime1 = 1209356038U;
  c4_info[37].fileTime2 = 0U;
  c4_info[38].context = "";
  c4_info[38].name = "atan2";
  c4_info[38].dominantType = "double";
  c4_info[38].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/elfun/atan2.m";
  c4_info[38].fileLength = 674U;
  c4_info[38].fileTime1 = 1203473148U;
  c4_info[38].fileTime2 = 0U;
  c4_info[39].context =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_assert_valid_size_arg.m/isintegral";
  c4_info[39].name = "ne";
  c4_info[39].dominantType = "double";
  c4_info[39].resolved = "[B]ne";
  c4_info[39].fileLength = 0U;
  c4_info[39].fileTime1 = 0U;
  c4_info[39].fileTime2 = 0U;
  c4_info[40].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/intmax.m";
  c4_info[40].name = "ischar";
  c4_info[40].dominantType = "char";
  c4_info[40].resolved = "[B]ischar";
  c4_info[40].fileLength = 0U;
  c4_info[40].fileTime1 = 0U;
  c4_info[40].fileTime2 = 0U;
  c4_info[41].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/elfun/abs.m";
  c4_info[41].name = "eml_scalar_abs";
  c4_info[41].dominantType = "double";
  c4_info[41].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/elfun/eml_scalar_abs.m";
  c4_info[41].fileLength = 461U;
  c4_info[41].fileTime1 = 1203473160U;
  c4_info[41].fileTime2 = 0U;
  c4_info[42].context =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/blas/refblas/eml_refblas_xdotx.m";
  c4_info[42].name = "eml_index_minus";
  c4_info[42].dominantType = "";
  c4_info[42].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_index_minus.m";
  c4_info[42].fileLength = 277U;
  c4_info[42].fileTime1 = 1192491984U;
  c4_info[42].fileTime2 = 0U;
  c4_info[43].context =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/datatypes/cast.m";
  c4_info[43].name = "ge";
  c4_info[43].dominantType = "double";
  c4_info[43].resolved = "[B]ge";
  c4_info[43].fileLength = 0U;
  c4_info[43].fileTime1 = 0U;
  c4_info[43].fileTime2 = 0U;
  c4_info[44].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_alloc.m";
  c4_info[44].name = "isstruct";
  c4_info[44].dominantType = "double";
  c4_info[44].resolved = "[B]isstruct";
  c4_info[44].fileLength = 0U;
  c4_info[44].fileTime1 = 0U;
  c4_info[44].fileTime2 = 0U;
  c4_info[45].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/power.m";
  c4_info[45].name = "eml_scalar_floor";
  c4_info[45].dominantType = "double";
  c4_info[45].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/elfun/eml_scalar_floor.m";
  c4_info[45].fileLength = 260U;
  c4_info[45].fileTime1 = 1209355990U;
  c4_info[45].fileTime2 = 0U;
  c4_info[46].context =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_scalexp_size.m";
  c4_info[46].name = "eml_scalexp_compatible";
  c4_info[46].dominantType = "double";
  c4_info[46].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_scalexp_compatible.m";
  c4_info[46].fileLength = 502U;
  c4_info[46].fileTime1 = 1208205258U;
  c4_info[46].fileTime2 = 0U;
  c4_info[47].context = "";
  c4_info[47].name = "mrdivide";
  c4_info[47].dominantType = "double";
  c4_info[47].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/mrdivide.m";
  c4_info[47].fileLength = 755U;
  c4_info[47].fileTime1 = 1209356082U;
  c4_info[47].fileTime2 = 0U;
  c4_info[48].context = "";
  c4_info[48].name = "plus";
  c4_info[48].dominantType = "double";
  c4_info[48].resolved = "[B]plus";
  c4_info[48].fileLength = 0U;
  c4_info[48].fileTime1 = 0U;
  c4_info[48].fileTime2 = 0U;
  c4_info[49].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/power.m";
  c4_info[49].name = "eml_alloc";
  c4_info[49].dominantType = "double";
  c4_info[49].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_alloc.m";
  c4_info[49].fileLength = 2627U;
  c4_info[49].fileTime1 = 1213662886U;
  ...
  c4_info[51].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/isequal.m";
  c4_info[51].name = "eml_isequal_core";
  c4_info[51].dominantType = "char";
  c4_info[51].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_isequal_core.m";
  c4_info[51].fileLength = 3543U;
  c4_info[51].fileTime1 = 1213662886U;
  ...
  c4_info[53].context = "";
  c4_info[53].name = "ctranspose";
  c4_info[53].dominantType = "double";
  c4_info[53].resolved = "[B]ctranspose";
  c4_info[53].fileLength = 0U;
  c4_info[53].fileTime1 = 0U;
  c4_info[53].fileTime2 = 0U;
  c4_info[54].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/false.m";
  c4_info[54].name = "logical";
  c4_info[54].dominantType = "double";
  c4_info[54].resolved = "[B]logical";
  c4_info[54].fileLength = 0U;
  c4_info[54].fileTime1 = 0U;
  c4_info[54].fileTime2 = 0U;
  c4_info[55].context =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/blas/internal/eml_blas_xdot.m";
  c4_info[55].name = "eml_refblas_xdot";
  c4_info[55].dominantType = "int32";
  c4_info[55].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/blas/refblas/eml_refblas_xdot.m";
  c4_info[55].fileLength = 343U;
  c4_info[55].fileTime1 = 1210895856U;
  c4_info[55].fileTime2 = 0U;
  c4_info[56].context =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_assert_valid_size_arg.m";
  c4_info[56].name = "isnumeric";
  c4_info[56].dominantType = "double";
  c4_info[56].resolved = "[B]isnumeric";
  c4_info[56].fileLength = 0U;
  c4_info[56].fileTime1 = 0U;
  c4_info[56].fileTime2 = 0U;
  c4_info[57].context = "";
  c4_info[57].name = "mldivide";
  c4_info[57].dominantType = "double";
  c4_info[57].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/mldivide.m";
  c4_info[57].fileLength = 937U;
  c4_info[57].fileTime1 = 1210895856U;
  c4_info[57].fileTime2 = 0U;
  c4_info[58].context =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_assert_valid_size_arg.m/numel_for_size";
  c4_info[58].name = "double";
  c4_info[58].dominantType = "double";
  c4_info[58].resolved = "[B]double";
  ...
  c4_info[59].name = "cast";
  c4_info[59].dominantType = "double";
  c4_info[59].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/datatypes/cast.m";
  c4_info[59].fileLength = 866U;
  c4_info[59].fileTime1 = 1192491844U;
  ...
  c4_info[61].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/mtimes.m";
  c4_info[61].name = "eq";
  c4_info[61].dominantType = "double";
  c4_info[61].resolved = "[B]eq";
  ...
  c4_info[62].resolved = "[B]not";
  c4_info[62].fileLength = 0U;
  c4_info[62].fileTime1 = 0U;
  c4_info[62].fileTime2 = 0U;
  c4_info[63].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/power.m";
  c4_info[63].name = "lt";
  c4_info[63].dominantType = "double";
  c4_info[63].resolved = "[B]lt";
...
static void c4_b_info_helper(c4_ResolvedFunctionInfo c4_info[88])
{
  c4_info[64].context =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/blas/eml_xcabs1.m";
  c4_info[64].name = "real";
  c4_info[64].dominantType = "double";
  c4_info[64].resolved = "[B]real";
  ...
  c4_info[65].name = "eml_xdotu";
  c4_info[65].dominantType = "int32";
  c4_info[65].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/blas/eml_xdotu.m";
  c4_info[65].fileLength = 1453U;
  c4_info[65].fileTime1 = 1209356052U;
  c4_info[65].fileTime2 = 0U;
  c4_info[66].context =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_assert_valid_size_arg.m";
  c4_info[66].name = "eml_index_class";
  c4_info[66].dominantType = "";
  c4_info[66].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_index_class.m";
  c4_info[66].fileLength = 909U;
  c4_info[66].fileTime1 = 1192491982U;
  c4_info[66].fileTime2 = 0U;
  c4_info[67].context =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_assert_valid_size_arg.m/isintegral";
  c4_info[67].name = "false";
  c4_info[67].dominantType = "";
  c4_info[67].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/false.m";
  c4_info[67].fileLength = 238U;
  c4_info[67].fileTime1 = 1192491920U;
  c4_info[67].fileTime2 = 0U;
  c4_info[68].context =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_assert_valid_size_arg.m/isintegral";
  c4_info[68].name = "true";
  c4_info[68].dominantType = "";
  c4_info[68].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/true.m";
  c4_info[68].fileLength = 237U;
  c4_info[68].fileTime1 = 1192491962U;
  c4_info[68].fileTime2 = 0U;
  c4_info[69].context =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/isfinite.m";
  c4_info[69].name = "isinf";
  c4_info[69].dominantType = "double";
  c4_info[69].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/isinf.m";
  c4_info[69].fileLength = 472U;
  c4_info[69].fileTime1 = 1192491934U;
  c4_info[69].fileTime2 = 0U;
  c4_info[70].context = "";
  c4_info[70].name = "zeros";
  c4_info[70].dominantType = "double";
  c4_info[70].resolved = "[B]zeros";
  ...
  c4_info[71].name = "ones";
  c4_info[71].dominantType = "char";
  c4_info[71].resolved = "[B]ones";
  c4_info[71].fileLength = 0U;
  c4_info[71].fileTime1 = 0U;
  c4_info[71].fileTime2 = 0U;
  c4_info[72].context =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/blas/eml_xgemm.m";
  c4_info[72].name = "eml_blas_xgemm";
  c4_info[72].dominantType = "int32";
  c4_info[72].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/blas/internal/eml_blas_xgemm.m";
  c4_info[72].fileLength = 355U;
  c4_info[72].fileTime1 = 1192492054U;
  c4_info[72].fileTime2 = 0U;
  c4_info[73].context =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/blas/refblas/eml_refblas_xdotx.m";
  c4_info[73].name = "eml_index_plus";
  c4_info[73].dominantType = "";
  c4_info[73].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_index_plus.m";
  c4_info[73].fileLength = 272U;
  c4_info[73].fileTime1 = 1192491986U;
  c4_info[73].fileTime2 = 0U;
  c4_info[74].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/rdivide.m";
  c4_info[74].name = "eml_warning";
  c4_info[74].dominantType = "char";
  c4_info[74].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_warning.m";
  c4_info[74].fileLength = 262U;
  c4_info[74].fileTime1 = 1213662888U;
  ...
  c4_info[76].context =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_all_or_any.m";
  c4_info[76].name = "eml_nonsingleton_dim";
  c4_info[76].dominantType = "logical";
  c4_info[76].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_nonsingleton_dim.m";
  c4_info[76].fileLength = 404U;
  c4_info[76].fileTime1 = 1192492000U;
  c4_info[76].fileTime2 = 0U;
  c4_info[77].context = "";
  c4_info[77].name = "mpower";
  c4_info[77].dominantType = "double";
  c4_info[77].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/mpower.m";
  c4_info[77].fileLength = 3547U;
  c4_info[77].fileTime1 = 1213662888U;
  c4_info[77].fileTime2 = 0U;
  c4_info[78].context =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/blas/refblas/eml_refblas_xdotx.m";
  c4_info[78].name = "eml_zeros";
  c4_info[78].dominantType = "double";
  c4_info[78].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_zeros.m";
  c4_info[78].fileLength = 1083U;
  c4_info[78].fileTime1 = 1213662888U;
  c4_info[78].fileTime2 = 0U;
  c4_info[79].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/elfun/sqrt.m";
  c4_info[79].name = "eml_scalar_sqrt";
  c4_info[79].dominantType = "double";
  c4_info[79].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/elfun/eml_scalar_sqrt.m";
  c4_info[79].fileLength = 664U;
  c4_info[79].fileTime1 = 1209355994U;
  c4_info[79].fileTime2 = 0U;
  c4_info[80].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/intmax.m";
  c4_info[80].name = "int32";
  c4_info[80].dominantType = "double";
  c4_info[80].resolved = "[B]int32";
  c4_info[80].fileLength = 0U;
  c4_info[80].fileTime1 = 0U;
  c4_info[80].fileTime2 = 0U;
  c4_info[81].context =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/blas/eml_xdotu.m";
  c4_info[81].name = "eml_xdot";
  c4_info[81].dominantType = "int32";
  c4_info[81].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/blas/eml_xdot.m";
  c4_info[81].fileLength = 1330U;
  c4_info[81].fileTime1 = 1209356050U;
  c4_info[81].fileTime2 = 0U;
  c4_info[82].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/lang/assert.m";
  c4_info[82].name = "islogical";
  c4_info[82].dominantType = "logical";
  c4_info[82].resolved = "[B]islogical";
  c4_info[82].fileLength = 0U;
  c4_info[82].fileTime1 = 0U;
  c4_info[82].fileTime2 = 0U;
  c4_info[83].context =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/blas/refblas/eml_refblas_xdotx.m";
  c4_info[83].name = "eml_index_times";
  c4_info[83].dominantType = "int32";
  c4_info[83].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_index_times.m";
  c4_info[83].fileLength = 280U;
  c4_info[83].fileTime1 = 1192491988U;
  c4_info[83].fileTime2 = 0U;
  c4_info[84].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/mtimes.m";
  c4_info[84].name = "gt";
  c4_info[84].dominantType = "double";
  c4_info[84].resolved = "[B]gt";
  c4_info[84].fileLength = 0U;
  c4_info[84].fileTime1 = 0U;
  c4_info[84].fileTime2 = 0U;
  c4_info[85].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/power.m";
  c4_info[85].name = "eml_error";
  c4_info[85].dominantType = "char";
  c4_info[85].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_error.m";
  c4_info[85].fileLength = 315U;
  c4_info[85].fileTime1 = 1213662886U;
  ...
  c4_info[86].fileTime1 = 1209356048U;
  c4_info[86].fileTime2 = 0U;
  c4_info[87].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/datafun/max.m";
  c4_info[87].name = "nargout";
  c4_info[87].dominantType = "";
  c4_info[87].resolved = "[B]nargout";
...
/* SFunction Glue Code */
void sf_c4_claw_main_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c4_claw_main_get_autoinheritance_info(void)
{
  ...
  fullDebuggerInitialization)
{
  if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
    ...
    if (!sim_mode_is_rtw_gen(S)) {
      {
        ...
        chartAlreadyPresent = sf_debug_initialize_chart(_claw_mainMachineNumber_,
          4,
          1,
          1,
          16,
        ...
        if (chartAlreadyPresent==0) {
          ...
          init_script_number_translation(_claw_mainMachineNumber_,
            chartInstance.chartNumber);
          sf_debug_set_chart_disable_implicit_casting(_claw_mainMachineNumber_,
            chartInstance.chartNumber,1);
          sf_debug_set_chart_event_thresholds(_claw_mainMachineNumber_,
            chartInstance.chartNumber,
            0,
            0,
            0);
    ...
    sf_debug_reset_current_state_configuration(_claw_mainMachineNumber_,
      chartInstance.chartNumber,chartInstance.instanceNumber);
  }
}

static void sf_opaque_initialize_c4_claw_main(void *chartInstanceVar)
{
  chart_debug_initialization(chartInstance.S,0);
  initialize_params_c4_claw_main();
  initialize_c4_claw_main();
}

static void sf_opaque_enable_c4_claw_main(void *chartInstanceVar)
{
  enable_c4_claw_main();
}

static void sf_opaque_disable_c4_claw_main(void *chartInstanceVar)
{
  disable_c4_claw_main();
}

static void sf_opaque_gateway_c4_claw_main(void *chartInstanceVar)
{
  sf_c4_claw_main();
}

static mxArray* sf_opaque_get_sim_state_c4_claw_main(void *chartInstanceVar)
{
  mxArray *st = (mxArray *) get_sim_state_c4_claw_main();
  return st;
}

static void sf_opaque_set_sim_state_c4_claw_main(void *chartInstanceVar, const
  mxArray *st)
{
  set_sim_state_c4_claw_main(sf_mex_dup(st));
}

static void sf_opaque_terminate_c4_claw_main(void *chartInstanceVar)
{
  ...
  finalize_c4_claw_main();
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c4_claw_main(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c4_claw_main(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    int_T chartIsInlinable =
      (int_T)sf_is_chart_inlinable("claw_main","claw_main",4);
    ssSetStateflowIsInlinable(S,chartIsInlinable);
    ssSetRTWCG(S,sf_rtw_info_uint_prop("claw_main","claw_main",4,"RTWCG"));
    ssSetEnableFcnIsTrivial(S,1);
    ssSetDisableFcnIsTrivial(S,1);
    ssSetNotMultipleInlinable(S,sf_rtw_info_uint_prop("claw_main","claw_main",4,
    ...
    if (chartIsInlinable) {
      ...
      sf_mark_chart_expressionable_inputs(S,"claw_main","claw_main",4,11);
      sf_mark_chart_reusable_outputs(S,"claw_main","claw_main",4,5);
    }

    sf_set_rtw_dwork_info(S,"claw_main","claw_main",4);
...
static void mdlRTW_c4_claw_main(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
    sf_write_symbol_mapping(S, "claw_main", "claw_main",4);
    ssWriteRTWStrParam(S, "StateflowChartType", "Embedded MATLAB");
  }
}

static void mdlStart_c4_claw_main(SimStruct *S)
{
  chartInstance.chartInfo.chartInstance = NULL;
  chartInstance.chartInfo.isEMLChart = 1;
  chartInstance.chartInfo.chartInitialized = 0;
  chartInstance.chartInfo.sFunctionGateway = sf_opaque_gateway_c4_claw_main;
  chartInstance.chartInfo.initializeChart = sf_opaque_initialize_c4_claw_main;
  chartInstance.chartInfo.terminateChart = sf_opaque_terminate_c4_claw_main;
  chartInstance.chartInfo.enableChart = sf_opaque_enable_c4_claw_main;
  chartInstance.chartInfo.disableChart = sf_opaque_disable_c4_claw_main;
  chartInstance.chartInfo.getSimState = sf_opaque_get_sim_state_c4_claw_main;
  chartInstance.chartInfo.setSimState = sf_opaque_set_sim_state_c4_claw_main;
  chartInstance.chartInfo.zeroCrossings = NULL;
  chartInstance.chartInfo.outputs = NULL;
  chartInstance.chartInfo.derivatives = NULL;
  chartInstance.chartInfo.mdlRTW = mdlRTW_c4_claw_main;
  chartInstance.chartInfo.mdlStart = mdlStart_c4_claw_main;
  chartInstance.chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c4_claw_main;
...
void c4_claw_main_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c4_claw_main(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c4_claw_main(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c4_claw_main(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c4_claw_main_method_dispatcher.\n"
