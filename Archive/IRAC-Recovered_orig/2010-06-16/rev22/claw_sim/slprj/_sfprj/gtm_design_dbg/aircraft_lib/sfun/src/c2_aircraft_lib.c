...
#include "aircraft_lib_sfun.h"
#include "c2_aircraft_lib.h"
#include "mwmathutil.h"
#define CHARTINSTANCE_CHARTNUMBER      (chartInstance->chartNumber)
#define CHARTINSTANCE_INSTANCENUMBER   (chartInstance->instanceNumber)
#include "aircraft_lib_sfun_debug_macros.h"
...
static void initialize_c2_aircraft_lib(SFc2_aircraft_libInstanceStruct
  *chartInstance);
static void initialize_params_c2_aircraft_lib(SFc2_aircraft_libInstanceStruct
  *chartInstance);
static void enable_c2_aircraft_lib(SFc2_aircraft_libInstanceStruct
  *chartInstance);
static void disable_c2_aircraft_lib(SFc2_aircraft_libInstanceStruct
  *chartInstance);
static void update_debugger_state_c2_aircraft_lib
  (SFc2_aircraft_libInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c2_aircraft_lib
  (SFc2_aircraft_libInstanceStruct *chartInstance);
static void set_sim_state_c2_aircraft_lib(SFc2_aircraft_libInstanceStruct
  *chartInstance, const mxArray *c2_st);
static void finalize_c2_aircraft_lib(SFc2_aircraft_libInstanceStruct
  *chartInstance);
static void sf_c2_aircraft_lib(SFc2_aircraft_libInstanceStruct *chartInstance);
static void c2_c2_aircraft_lib(SFc2_aircraft_libInstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c2_machineNumber, uint32_T
  c2_chartNumber);
static void c2_eml_warning(SFc2_aircraft_libInstanceStruct *chartInstance);
...
static void init_dsm_address_info(SFc2_aircraft_libInstanceStruct *chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c2_is_active_c2_aircraft_lib = 0U;
}
...
static void sf_c2_aircraft_lib(SFc2_aircraft_libInstanceStruct *chartInstance)
{
  ...
  c2_c2_aircraft_lib(chartInstance);
  _sfEvent_ = c2_previousEvent;
  sf_debug_check_for_state_inconsistency(_aircraft_libMachineNumber_,
...
static const mxArray *c2_sf_marshall(void *chartInstanceVoid, void *c2_u)
{
  ...
  const mxArray *c2_b_y = NULL;
  SFc2_aircraft_libInstanceStruct *chartInstance;
  chartInstance = (SFc2_aircraft_libInstanceStruct *)chartInstanceVoid;
  c2_y = NULL;
  c2_b_u = *((real_T *)c2_u);
  c2_b_y = NULL;
...
const mxArray *sf_c2_aircraft_lib_get_eml_resolved_functions_info(void)
{
...
static void c2_info_helper(c2_ResolvedFunctionInfo c2_info[31])
{
  c2_info[0].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/mrdivide.m";
  c2_info[0].name = "isscalar";
  c2_info[0].dominantType = "double";
  c2_info[0].resolved = "[B]isscalar";
  c2_info[0].fileLength = 0U;
  c2_info[0].fileTime1 = 0U;
  c2_info[0].fileTime2 = 0U;
  c2_info[1].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/elfun/sin.m";
  c2_info[1].name = "eml_scalar_sin";
  c2_info[1].dominantType = "double";
  c2_info[1].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/elfun/eml_scalar_sin.m";
  c2_info[1].fileLength = 601U;
  c2_info[1].fileTime1 = 1209355992U;
  c2_info[1].fileTime2 = 0U;
  c2_info[2].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/elfun/cos.m";
  c2_info[2].name = "eml_scalar_cos";
  c2_info[2].dominantType = "double";
  c2_info[2].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/elfun/eml_scalar_cos.m";
  c2_info[2].fileLength = 602U;
  c2_info[2].fileTime1 = 1209355988U;
  ...
  c2_info[6].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/elfun/abs.m";
  ...
  c2_info[14].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/rdivide.m";
  c2_info[14].name = "eml_warning";
  c2_info[14].dominantType = "char";
  c2_info[14].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_warning.m";
  c2_info[14].fileLength = 262U;
  c2_info[14].fileTime1 = 1213662888U;
  ...
  c2_info[17].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/mrdivide.m";
  c2_info[17].fileLength = 755U;
  c2_info[17].fileTime1 = 1209356082U;
  c2_info[17].fileTime2 = 0U;
  c2_info[18].context = "";
  c2_info[18].name = "abs";
  c2_info[18].dominantType = "double";
  c2_info[18].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/elfun/abs.m";
  c2_info[18].fileLength = 538U;
  c2_info[18].fileTime1 = 1203473128U;
  ...
  c2_info[20].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/elfun/cos.m";
  c2_info[20].fileLength = 324U;
  c2_info[20].fileTime1 = 1203473152U;
  ...
  c2_info[22].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/mtimes.m";
  c2_info[22].fileLength = 2336U;
  c2_info[22].fileTime1 = 1213662890U;
  ...
  c2_info[25].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/mrdivide.m";
  c2_info[25].name = "nargin";
  c2_info[25].dominantType = "";
  c2_info[25].resolved = "[B]nargin";
  ...
  c2_info[26].name = "size";
  c2_info[26].dominantType = "double";
  c2_info[26].resolved = "[B]size";
  c2_info[26].fileLength = 0U;
  c2_info[26].fileTime1 = 0U;
  c2_info[26].fileTime2 = 0U;
  c2_info[27].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/mrdivide.m";
  c2_info[27].name = "rdivide";
  c2_info[27].dominantType = "double";
  c2_info[27].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/rdivide.m";
  c2_info[27].fileLength = 620U;
  c2_info[27].fileTime1 = 1213662890U;
  c2_info[27].fileTime2 = 0U;
  c2_info[28].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/elfun/abs.m";
  ...
  c2_info[29].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/rdivide.m";
  c2_info[29].name = "isa";
...
/* SFunction Glue Code */
void sf_c2_aircraft_lib_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c2_aircraft_lib_get_autoinheritance_info(void)
{
...
{
  SFc2_aircraft_libInstanceStruct *chartInstance;
  chartInstance = (SFc2_aircraft_libInstanceStruct *) ((ChartInfoStruct *)
  ...
  if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
    ...
    if (!sim_mode_is_rtw_gen(S)) {
      {
        ...
        if (chartAlreadyPresent==0) {
          ...
          init_script_number_translation(_aircraft_libMachineNumber_,
            chartInstance->chartNumber);
          sf_debug_set_chart_disable_implicit_casting
            (_aircraft_libMachineNumber_,chartInstance->chartNumber,1);
          sf_debug_set_chart_event_thresholds(_aircraft_libMachineNumber_,
            chartInstance->chartNumber,
            0,
            0,
            0);
    ...
    sf_debug_reset_current_state_configuration(_aircraft_libMachineNumber_,
      chartInstance->chartNumber,chartInstance->instanceNumber);
  }
}

static void sf_opaque_initialize_c2_aircraft_lib(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc2_aircraft_libInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c2_aircraft_lib((SFc2_aircraft_libInstanceStruct*)
    chartInstanceVar);
  initialize_c2_aircraft_lib((SFc2_aircraft_libInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c2_aircraft_lib(void *chartInstanceVar)
{
  enable_c2_aircraft_lib((SFc2_aircraft_libInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c2_aircraft_lib(void *chartInstanceVar)
{
  disable_c2_aircraft_lib((SFc2_aircraft_libInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c2_aircraft_lib(void *chartInstanceVar)
{
  sf_c2_aircraft_lib((SFc2_aircraft_libInstanceStruct*) chartInstanceVar);
}

static mxArray* sf_opaque_get_sim_state_c2_aircraft_lib(void *chartInstanceVar)
{
  mxArray *st = (mxArray *) get_sim_state_c2_aircraft_lib
    ((SFc2_aircraft_libInstanceStruct*) chartInstanceVar);
  return st;
}

static void sf_opaque_set_sim_state_c2_aircraft_lib(void *chartInstanceVar,
  const mxArray *st)
{
  set_sim_state_c2_aircraft_lib((SFc2_aircraft_libInstanceStruct*)
    chartInstanceVar, sf_mex_dup(st));
}

static void sf_opaque_terminate_c2_aircraft_lib(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc2_aircraft_libInstanceStruct*) chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
    }

    finalize_c2_aircraft_lib((SFc2_aircraft_libInstanceStruct*) chartInstanceVar);
...
static void mdlProcessParameters_c2_aircraft_lib(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c2_aircraft_lib(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    int_T chartIsInlinable =
      (int_T)sf_is_chart_inlinable("aircraft_lib","gtm_design_dbg",2);
    ssSetStateflowIsInlinable(S,chartIsInlinable);
    ssSetRTWCG(S,sf_rtw_info_uint_prop("aircraft_lib","gtm_design_dbg",2,"RTWCG"));
    ssSetEnableFcnIsTrivial(S,1);
    ssSetDisableFcnIsTrivial(S,1);
    ssSetNotMultipleInlinable(S,sf_rtw_info_uint_prop("aircraft_lib",
    ...
    if (chartIsInlinable) {
      ...
      sf_mark_chart_expressionable_inputs(S,"aircraft_lib","gtm_design_dbg",2,6);
      sf_mark_chart_reusable_outputs(S,"aircraft_lib","gtm_design_dbg",2,2);
    }

    sf_set_rtw_dwork_info(S,"aircraft_lib","gtm_design_dbg",2);
...
static void mdlRTW_c2_aircraft_lib(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
    sf_write_symbol_mapping(S, "aircraft_lib", "gtm_design_dbg",2);
    ssWriteRTWStrParam(S, "StateflowChartType", "Embedded MATLAB");
  }
}

static void mdlStart_c2_aircraft_lib(SimStruct *S)
{
  SFc2_aircraft_libInstanceStruct *chartInstance;
  chartInstance = (SFc2_aircraft_libInstanceStruct *)malloc(sizeof
    (SFc2_aircraft_libInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c2_aircraft_lib;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c2_aircraft_lib;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c2_aircraft_lib;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c2_aircraft_lib;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c2_aircraft_lib;
  chartInstance->chartInfo.getSimState = sf_opaque_get_sim_state_c2_aircraft_lib;
  chartInstance->chartInfo.setSimState = sf_opaque_set_sim_state_c2_aircraft_lib;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c2_aircraft_lib;
  chartInstance->chartInfo.mdlStart = mdlStart_c2_aircraft_lib;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c2_aircraft_lib;
...
void c2_aircraft_lib_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c2_aircraft_lib(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c2_aircraft_lib(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c2_aircraft_lib(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c2_aircraft_lib_method_dispatcher.\n"
