...
static void initialize_c3_aeroutilslib(SFc3_aeroutilslibInstanceStruct
  *chartInstance);
static void initialize_params_c3_aeroutilslib(SFc3_aeroutilslibInstanceStruct
  *chartInstance);
static void enable_c3_aeroutilslib(SFc3_aeroutilslibInstanceStruct
  *chartInstance);
static void disable_c3_aeroutilslib(SFc3_aeroutilslibInstanceStruct
  *chartInstance);
static void update_debugger_state_c3_aeroutilslib
  (SFc3_aeroutilslibInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c3_aeroutilslib
  (SFc3_aeroutilslibInstanceStruct *chartInstance);
static void set_sim_state_c3_aeroutilslib(SFc3_aeroutilslibInstanceStruct
  *chartInstance, const mxArray *c3_st);
static void finalize_c3_aeroutilslib(SFc3_aeroutilslibInstanceStruct
  *chartInstance);
static void sf_c3_aeroutilslib(SFc3_aeroutilslibInstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c3_machineNumber, uint32_T
  c3_chartNumber);
static void c3_eml_warning(SFc3_aeroutilslibInstanceStruct *chartInstance);
...
static void init_dsm_address_info(SFc3_aeroutilslibInstanceStruct *chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c3_is_active_c3_aeroutilslib = 0U;
}
...
static const mxArray *c3_sf_marshall(void *chartInstanceVoid, void *c3_u)
{
  ...
  const mxArray *c3_b_y = NULL;
  SFc3_aeroutilslibInstanceStruct *chartInstance;
  chartInstance = (SFc3_aeroutilslibInstanceStruct *)chartInstanceVoid;
  c3_y = NULL;
...
const mxArray *sf_c3_aeroutilslib_get_eml_resolved_functions_info(void)
{
...
static void c3_info_helper(c3_ResolvedFunctionInfo c3_info[24])
{
  ...
  c3_info[0].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/mtimes.m";
  c3_info[0].fileLength = 2336U;
  c3_info[0].fileTime1 = 1213662890U;
  c3_info[0].fileTime2 = 0U;
  c3_info[1].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/mrdivide.m";
  c3_info[1].name = "isscalar";
  c3_info[1].dominantType = "double";
  c3_info[1].resolved = "[B]isscalar";
  ...
  c3_info[2].name = "not";
  c3_info[2].dominantType = "logical";
  c3_info[2].resolved = "[B]not";
  c3_info[2].fileLength = 0U;
  c3_info[2].fileTime1 = 0U;
  c3_info[2].fileTime2 = 0U;
  c3_info[3].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/elfun/sin.m";
  c3_info[3].name = "eml_scalar_sin";
  c3_info[3].dominantType = "double";
  c3_info[3].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/elfun/eml_scalar_sin.m";
  c3_info[3].fileLength = 601U;
  c3_info[3].fileTime1 = 1209355992U;
  c3_info[3].fileTime2 = 0U;
  c3_info[4].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_div.m";
  ...
  c3_info[5].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/elfun/cos.m";
  c3_info[5].name = "gt";
  ...
  c3_info[8].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/mrdivide.m";
  c3_info[8].fileLength = 755U;
  c3_info[8].fileTime1 = 1209356082U;
  c3_info[8].fileTime2 = 0U;
  c3_info[9].context = "";
  c3_info[9].name = "minus";
  c3_info[9].dominantType = "double";
  c3_info[9].resolved = "[B]minus";
  ...
  c3_info[11].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/elfun/cos.m";
  c3_info[11].name = "eml_scalar_cos";
  c3_info[11].dominantType = "double";
  c3_info[11].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/elfun/eml_scalar_cos.m";
  c3_info[11].fileLength = 602U;
  c3_info[11].fileTime1 = 1209355988U;
  c3_info[11].fileTime2 = 0U;
  c3_info[12].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/elfun/cos.m";
  c3_info[12].name = "nargin";
  c3_info[12].dominantType = "";
  c3_info[12].resolved = "[B]nargin";
  ...
  c3_info[13].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/elfun/cos.m";
  c3_info[13].fileLength = 324U;
  c3_info[13].fileTime1 = 1203473152U;
  c3_info[13].fileTime2 = 0U;
  c3_info[14].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/elfun/cos.m";
  c3_info[14].name = "isa";
  c3_info[14].dominantType = "double";
  c3_info[14].resolved = "[B]isa";
  c3_info[14].fileLength = 0U;
  c3_info[14].fileTime1 = 0U;
  c3_info[14].fileTime2 = 0U;
  c3_info[15].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/mtimes.m";
  c3_info[15].name = "class";
  c3_info[15].dominantType = "double";
  c3_info[15].resolved = "[B]class";
  c3_info[15].fileLength = 0U;
  c3_info[15].fileTime1 = 0U;
  c3_info[15].fileTime2 = 0U;
  c3_info[16].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/mtimes.m";
  ...
  c3_info[17].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/rdivide.m";
  c3_info[17].name = "eml_div";
  c3_info[17].dominantType = "double";
  c3_info[17].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_div.m";
  c3_info[17].fileLength = 4254U;
  c3_info[17].fileTime1 = 1192491972U;
  ...
  c3_info[18].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/rdivide.m";
  c3_info[18].fileLength = 620U;
  c3_info[18].fileTime1 = 1213662890U;
  c3_info[18].fileTime2 = 0U;
  c3_info[19].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/rdivide.m";
  c3_info[19].name = "isempty";
  c3_info[19].dominantType = "double";
  c3_info[19].resolved = "[B]isempty";
  c3_info[19].fileLength = 0U;
  c3_info[19].fileTime1 = 0U;
  c3_info[19].fileTime2 = 0U;
  c3_info[20].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/rdivide.m";
  c3_info[20].name = "strcmp";
  c3_info[20].dominantType = "char";
  c3_info[20].resolved = "[B]strcmp";
  c3_info[20].fileLength = 0U;
  c3_info[20].fileTime1 = 0U;
  c3_info[20].fileTime2 = 0U;
  c3_info[21].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/rdivide.m";
  c3_info[21].name = "eq";
  ...
  c3_info[22].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/elfun/sin.m";
  c3_info[22].fileLength = 324U;
  c3_info[22].fileTime1 = 1203473242U;
  c3_info[22].fileTime2 = 0U;
  c3_info[23].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/rdivide.m";
  c3_info[23].name = "eml_warning";
  c3_info[23].dominantType = "char";
  c3_info[23].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_warning.m";
  c3_info[23].fileLength = 262U;
  c3_info[23].fileTime1 = 1213662888U;
...
/* SFunction Glue Code */
void sf_c3_aeroutilslib_get_check_sum(mxArray *plhs[])
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(130384338U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(2580427461U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(2038789456U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(2802447860U);
}

mxArray *sf_c3_aeroutilslib_get_autoinheritance_info(void)
{
...
{
  SFc3_aeroutilslibInstanceStruct *chartInstance;
  chartInstance = (SFc3_aeroutilslibInstanceStruct *) ((ChartInfoStruct *)
...
static void sf_opaque_initialize_c3_aeroutilslib(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc3_aeroutilslibInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c3_aeroutilslib((SFc3_aeroutilslibInstanceStruct*)
    chartInstanceVar);
  initialize_c3_aeroutilslib((SFc3_aeroutilslibInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c3_aeroutilslib(void *chartInstanceVar)
{
  enable_c3_aeroutilslib((SFc3_aeroutilslibInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c3_aeroutilslib(void *chartInstanceVar)
{
  disable_c3_aeroutilslib((SFc3_aeroutilslibInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c3_aeroutilslib(void *chartInstanceVar)
{
  sf_c3_aeroutilslib((SFc3_aeroutilslibInstanceStruct*) chartInstanceVar);
}

static mxArray* sf_opaque_get_sim_state_c3_aeroutilslib(void *chartInstanceVar)
{
  mxArray *st = (mxArray *) get_sim_state_c3_aeroutilslib
    ((SFc3_aeroutilslibInstanceStruct*) chartInstanceVar);
  return st;
}

static void sf_opaque_set_sim_state_c3_aeroutilslib(void *chartInstanceVar,
  const mxArray *st)
{
  set_sim_state_c3_aeroutilslib((SFc3_aeroutilslibInstanceStruct*)
    chartInstanceVar, sf_mex_dup(st));
}

static void sf_opaque_terminate_c3_aeroutilslib(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc3_aeroutilslibInstanceStruct*) chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
    }

    finalize_c3_aeroutilslib((SFc3_aeroutilslibInstanceStruct*) chartInstanceVar);
...
static void mdlProcessParameters_c3_aeroutilslib(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c3_aeroutilslib(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    int_T chartIsInlinable =
      (int_T)sf_is_chart_inlinable("aeroutilslib","gtm_design_dbg",3);
    ssSetStateflowIsInlinable(S,chartIsInlinable);
    ssSetRTWCG(S,sf_rtw_info_uint_prop("aeroutilslib","gtm_design_dbg",3,"RTWCG"));
    ssSetEnableFcnIsTrivial(S,1);
    ssSetDisableFcnIsTrivial(S,1);
    ssSetNotMultipleInlinable(S,sf_rtw_info_uint_prop("aeroutilslib",
      "gtm_design_dbg",3,"gatewayCannotBeInlinedMultipleTimes"));
    if (chartIsInlinable) {
      ssSetInputPortOptimOpts(S, 0, SS_REUSABLE_AND_LOCAL);
      ssSetInputPortOptimOpts(S, 1, SS_REUSABLE_AND_LOCAL);
      sf_mark_chart_expressionable_inputs(S,"aeroutilslib","gtm_design_dbg",3,2);
      sf_mark_chart_reusable_outputs(S,"aeroutilslib","gtm_design_dbg",3,1);
    }

    sf_set_rtw_dwork_info(S,"aeroutilslib","gtm_design_dbg",3);
    ssSetHasSubFunctions(S,!(chartIsInlinable));
    ssSetOptions(S,ssGetOptions(S)|SS_OPTION_WORKS_WITH_CODE_REUSE);
  }

  ssSetChecksum0(S,(2637149329U));
  ssSetChecksum1(S,(3487593273U));
  ssSetChecksum2(S,(2691838687U));
  ssSetChecksum3(S,(3716845473U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
}

static void mdlRTW_c3_aeroutilslib(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
    sf_write_symbol_mapping(S, "aeroutilslib", "gtm_design_dbg",3);
    ssWriteRTWStrParam(S, "StateflowChartType", "Embedded MATLAB");
  }
}

static void mdlStart_c3_aeroutilslib(SimStruct *S)
{
  SFc3_aeroutilslibInstanceStruct *chartInstance;
  chartInstance = (SFc3_aeroutilslibInstanceStruct *)malloc(sizeof
    (SFc3_aeroutilslibInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c3_aeroutilslib;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c3_aeroutilslib;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c3_aeroutilslib;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c3_aeroutilslib;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c3_aeroutilslib;
  chartInstance->chartInfo.getSimState = sf_opaque_get_sim_state_c3_aeroutilslib;
  chartInstance->chartInfo.setSimState = sf_opaque_set_sim_state_c3_aeroutilslib;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c3_aeroutilslib;
  chartInstance->chartInfo.mdlStart = mdlStart_c3_aeroutilslib;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c3_aeroutilslib;
...
void c3_aeroutilslib_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c3_aeroutilslib(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c3_aeroutilslib(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c3_aeroutilslib(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c3_aeroutilslib_method_dispatcher.\n"
