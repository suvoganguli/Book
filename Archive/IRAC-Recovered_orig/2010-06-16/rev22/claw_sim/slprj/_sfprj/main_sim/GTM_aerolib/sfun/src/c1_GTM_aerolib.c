...
static void c1_info_helper(c1_ResolvedFunctionInfo c1_info[59])
{
  ...
  c1_info[7].name = "eml_index_prod";
  c1_info[7].dominantType = "int32";
  c1_info[7].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_index_prod.m";
  c1_info[7].fileLength = 547U;
  c1_info[7].fileTime1 = 1210895846U;
  ...
  c1_info[10].fileLength = 280U;
  c1_info[10].fileTime1 = 1192491988U;
  ...
  c1_info[12].name = "zeros";
  c1_info[12].dominantType = "char";
  c1_info[12].resolved = "[B]zeros";
  ...
  c1_info[16].name = "isfinite";
  c1_info[16].dominantType = "double";
  c1_info[16].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/isfinite.m";
  c1_info[16].fileLength = 341U;
  c1_info[16].fileTime1 = 1192491934U;
  ...
  c1_info[20].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/elfun/round.m";
  c1_info[20].name = "eml_scalar_round";
  c1_info[20].dominantType = "double";
  c1_info[20].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/elfun/eml_scalar_round.m";
  c1_info[20].fileLength = 523U;
  c1_info[20].fileTime1 = 1203473208U;
  c1_info[20].fileTime2 = 0U;
  c1_info[21].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/reshape.m";
  c1_info[21].name = "eml_alloc";
  c1_info[21].dominantType = "int32";
  c1_info[21].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_alloc.m";
  c1_info[21].fileLength = 2627U;
  c1_info[21].fileTime1 = 1213662886U;
  c1_info[21].fileTime2 = 0U;
  c1_info[22].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/mtimes.m";
  c1_info[22].name = "strcmp";
  c1_info[22].dominantType = "char";
  c1_info[22].resolved = "[B]strcmp";
  c1_info[22].fileLength = 0U;
  c1_info[22].fileTime1 = 0U;
  c1_info[22].fileTime2 = 0U;
  c1_info[23].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/lang/assert.m";
  ...
  c1_info[24].context =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_assert_valid_size_arg.m";
  c1_info[24].name = "size";
  c1_info[24].dominantType = "double";
  c1_info[24].resolved = "[B]size";
  ...
  c1_info[26].context = "";
  c1_info[26].name = "reshape";
  c1_info[26].dominantType = "double";
  c1_info[26].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/reshape.m";
  c1_info[26].fileLength = 2221U;
  c1_info[26].fileTime1 = 1209356014U;
  c1_info[26].fileTime2 = 0U;
  c1_info[27].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/elfun/round.m";
  c1_info[27].name = "gt";
  c1_info[27].dominantType = "double";
  c1_info[27].resolved = "[B]gt";
  ...
  c1_info[30].context =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/isfinite.m";
  c1_info[30].name = "isinf";
  c1_info[30].dominantType = "double";
  c1_info[30].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/isinf.m";
  c1_info[30].fileLength = 472U;
  c1_info[30].fileTime1 = 1192491934U;
  c1_info[30].fileTime2 = 0U;
  c1_info[31].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/lang/assert.m";
  c1_info[31].name = "not";
  c1_info[31].dominantType = "logical";
  c1_info[31].resolved = "[B]not";
  ...
  c1_info[34].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/intmax.m";
  c1_info[34].fileLength = 1535U;
  c1_info[34].fileTime1 = 1192491928U;
  c1_info[34].fileTime2 = 0U;
  c1_info[35].context =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/elfun/eml_scalar_round.m";
  c1_info[35].name = "isreal";
  c1_info[35].dominantType = "double";
  c1_info[35].resolved = "[B]isreal";
  c1_info[35].fileLength = 0U;
  c1_info[35].fileTime1 = 0U;
  c1_info[35].fileTime2 = 0U;
  c1_info[36].context =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/elfun/eml_scalar_round.m/scalar_round";
  c1_info[36].name = "plus";
  c1_info[36].dominantType = "double";
  c1_info[36].resolved = "[B]plus";
  c1_info[36].fileLength = 0U;
  c1_info[36].fileTime1 = 0U;
  c1_info[36].fileTime2 = 0U;
  c1_info[37].context =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/blas/eml_xgemm.m";
  c1_info[37].name = "eml_blas_xgemm";
  c1_info[37].dominantType = "int32";
  c1_info[37].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/blas/internal/eml_blas_xgemm.m";
  c1_info[37].fileLength = 355U;
  c1_info[37].fileTime1 = 1192492054U;
  ...
  c1_info[38].fileTime1 = 1192491982U;
  ...
  c1_info[39].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/mtimes.m";
  c1_info[39].fileLength = 2336U;
  c1_info[39].fileTime1 = 1213662890U;
  ...
  c1_info[42].context = "";
  c1_info[42].name = "round";
  c1_info[42].dominantType = "double";
  c1_info[42].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/elfun/round.m";
  c1_info[42].fileLength = 331U;
  c1_info[42].fileTime1 = 1203473238U;
  c1_info[42].fileTime2 = 0U;
  c1_info[43].context =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/datatypes/cast.m";
  c1_info[43].name = "ge";
  c1_info[43].dominantType = "double";
  c1_info[43].resolved = "[B]ge";
  ...
  c1_info[45].context = "";
  c1_info[45].name = "transpose";
  c1_info[45].dominantType = "double";
  c1_info[45].resolved = "[B]transpose";
  ...
  c1_info[47].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_alloc.m";
  ...
  c1_info[52].context =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_assert_valid_size_arg.m/isintegral";
  c1_info[52].name = "false";
  c1_info[52].dominantType = "";
  c1_info[52].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/false.m";
  c1_info[52].fileLength = 238U;
  c1_info[52].fileTime1 = 1192491920U;
  ...
  c1_info[54].name = "ndims";
  c1_info[54].dominantType = "double";
  c1_info[54].resolved = "[B]ndims";
  ...
  c1_info[55].context =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/isfinite.m";
  c1_info[55].name = "and";
  c1_info[55].dominantType = "logical";
  c1_info[55].resolved = "[B]and";
  c1_info[55].fileLength = 0U;
  c1_info[55].fileTime1 = 0U;
  c1_info[55].fileTime2 = 0U;
  c1_info[56].context =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/datatypes/cast.m";
  c1_info[56].name = "int32";
  c1_info[56].dominantType = "double";
  c1_info[56].resolved = "[B]int32";
