...
static SFc2_main_sim_adaptInstanceStruct chartInstance;

/* Function Declarations */
static void initialize_c2_main_sim_adapt(void);
static void initialize_params_c2_main_sim_adapt(void);
static void enable_c2_main_sim_adapt(void);
static void disable_c2_main_sim_adapt(void);
static void update_debugger_state_c2_main_sim_adapt(void);
static const mxArray *get_sim_state_c2_main_sim_adapt(void);
static void set_sim_state_c2_main_sim_adapt(const mxArray *c2_st);
static void finalize_c2_main_sim_adapt(void);
static void sf_c2_main_sim_adapt(void);
static void c2_c2_main_sim_adapt(void);
...
static void initialize_c2_main_sim_adapt(void)
{
  ...
  chartInstance.c2_is_active_c2_main_sim_adapt = 0U;
}
...
static void c2_info_helper(c2_ResolvedFunctionInfo c2_info[90])
{
  c2_info[0].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/elfun/abs.m";
  c2_info[0].name = "eml_scalar_abs";
  c2_info[0].dominantType = "double";
  c2_info[0].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/elfun/eml_scalar_abs.m";
  c2_info[0].fileLength = 461U;
  c2_info[0].fileTime1 = 1203473160U;
  c2_info[0].fileTime2 = 0U;
  c2_info[1].context =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/colon.m/is_flint_colon";
  c2_info[1].name = "floor";
  c2_info[1].dominantType = "double";
  c2_info[1].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/elfun/floor.m";
  c2_info[1].fileLength = 332U;
  c2_info[1].fileTime1 = 1203473224U;
  ...
  c2_info[3].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/false.m";
  c2_info[3].name = "logical";
  c2_info[3].dominantType = "double";
  c2_info[3].resolved = "[B]logical";
  ...
  c2_info[4].name = "eml_index_minus";
  c2_info[4].dominantType = "int32";
  c2_info[4].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_index_minus.m";
  c2_info[4].fileLength = 277U;
  c2_info[4].fileTime1 = 1192491984U;
  c2_info[4].fileTime2 = 0U;
  c2_info[5].context = "";
  c2_info[5].name = "mtimes";
  c2_info[5].dominantType = "double";
  c2_info[5].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/mtimes.m";
  c2_info[5].fileLength = 2336U;
  c2_info[5].fileTime1 = 1213662890U;
  c2_info[5].fileTime2 = 0U;
  c2_info[6].context =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_assert_valid_size_arg.m";
  c2_info[6].name = "isnumeric";
  c2_info[6].dominantType = "double";
  c2_info[6].resolved = "[B]isnumeric";
  ...
  c2_info[7].name = "assert";
  c2_info[7].dominantType = "char";
  c2_info[7].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/lang/assert.m";
  c2_info[7].fileLength = 2684U;
  c2_info[7].fileTime1 = 1210895856U;
  c2_info[7].fileTime2 = 0U;
  c2_info[8].context =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_all_or_any.m";
  c2_info[8].name = "eml_set_singleton_dim";
  c2_info[8].dominantType = "double";
  c2_info[8].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_set_singleton_dim.m";
  c2_info[8].fileLength = 398U;
  c2_info[8].fileTime1 = 1209356038U;
  ...
  c2_info[10].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/realmin.m";
  c2_info[10].name = "uminus";
  c2_info[10].dominantType = "double";
  c2_info[10].resolved = "[B]uminus";
  c2_info[10].fileLength = 0U;
  c2_info[10].fileTime1 = 0U;
  c2_info[10].fileTime2 = 0U;
  c2_info[11].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/diag.m";
  c2_info[11].name = "eml_index_plus";
  c2_info[11].dominantType = "int32";
  c2_info[11].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_index_plus.m";
  c2_info[11].fileLength = 272U;
  c2_info[11].fileTime1 = 1192491986U;
  c2_info[11].fileTime2 = 0U;
  c2_info[12].context =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_all_or_any.m";
  c2_info[12].name = "eml_nonsingleton_dim";
  c2_info[12].dominantType = "logical";
  c2_info[12].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_nonsingleton_dim.m";
  c2_info[12].fileLength = 404U;
  c2_info[12].fileTime1 = 1192492000U;
  c2_info[12].fileTime2 = 0U;
  c2_info[13].context = "";
  c2_info[13].name = "sqrt";
  c2_info[13].dominantType = "double";
  c2_info[13].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/elfun/sqrt.m";
  c2_info[13].fileLength = 572U;
  c2_info[13].fileTime1 = 1203473246U;
  ...
  c2_info[17].resolved = "[B]isa";
  c2_info[17].fileLength = 0U;
  c2_info[17].fileTime1 = 0U;
  c2_info[17].fileTime2 = 0U;
  c2_info[18].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/power.m";
  c2_info[18].name = "eml_scalexp_size";
  c2_info[18].dominantType = "double";
  c2_info[18].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_scalexp_size.m";
  c2_info[18].fileLength = 1373U;
  c2_info[18].fileTime1 = 1208205260U;
  c2_info[18].fileTime2 = 0U;
  c2_info[19].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/rdivide.m";
  c2_info[19].name = "eml_warning";
  c2_info[19].dominantType = "char";
  c2_info[19].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_warning.m";
  c2_info[19].fileLength = 262U;
  c2_info[19].fileTime1 = 1213662888U;
  c2_info[19].fileTime2 = 0U;
  c2_info[20].context =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_assert_valid_size_arg.m";
  c2_info[20].name = "intmax";
  c2_info[20].dominantType = "char";
  c2_info[20].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/intmax.m";
  c2_info[20].fileLength = 1535U;
  c2_info[20].fileTime1 = 1192491928U;
  ...
  c2_info[21].fileTime1 = 1192491982U;
  c2_info[21].fileTime2 = 0U;
  c2_info[22].context = "";
  c2_info[22].name = "bitor";
  c2_info[22].dominantType = "uint32";
  c2_info[22].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/bitor.m";
  c2_info[22].fileLength = 1043U;
  c2_info[22].fileTime1 = 1209356078U;
  ...
  c2_info[25].name = "isinteger";
  c2_info[25].dominantType = "double";
  c2_info[25].resolved = "[B]isinteger";
  ...
  c2_info[33].resolved = "[B]gt";
  c2_info[33].fileLength = 0U;
  c2_info[33].fileTime1 = 0U;
  c2_info[33].fileTime2 = 0U;
  c2_info[34].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/mtimes.m";
  c2_info[34].name = "isscalar";
  c2_info[34].dominantType = "double";
  c2_info[34].resolved = "[B]isscalar";
  ...
  c2_info[35].fileLength = 315U;
  c2_info[35].fileTime1 = 1213662886U;
  c2_info[35].fileTime2 = 0U;
  c2_info[36].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/power.m";
  c2_info[36].name = "eml_scalar_floor";
  c2_info[36].dominantType = "double";
  c2_info[36].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/elfun/eml_scalar_floor.m";
  c2_info[36].fileLength = 260U;
  c2_info[36].fileTime1 = 1209355990U;
  c2_info[36].fileTime2 = 0U;
  c2_info[37].context =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/colon.m/is_flint_colon";
  c2_info[37].name = "eps";
  c2_info[37].dominantType = "double";
  c2_info[37].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/eps.m";
  c2_info[37].fileLength = 1342U;
  c2_info[37].fileTime1 = 1210895846U;
  c2_info[37].fileTime2 = 0U;
  c2_info[38].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/eps.m";
  c2_info[38].name = "realmin";
  c2_info[38].dominantType = "";
  c2_info[38].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/realmin.m";
  c2_info[38].fileLength = 475U;
  c2_info[38].fileTime1 = 1192491952U;
  c2_info[38].fileTime2 = 0U;
  c2_info[39].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/mtimes.m";
  c2_info[39].name = "nargin";
  c2_info[39].dominantType = "";
  c2_info[39].resolved = "[B]nargin";
  ...
  c2_info[40].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/nan.m";
  c2_info[40].fileLength = 474U;
  c2_info[40].fileTime1 = 1192491944U;
  c2_info[40].fileTime2 = 0U;
  c2_info[41].context =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_alloc.m/zerosum";
  c2_info[41].name = "plus";
  c2_info[41].dominantType = "double";
  c2_info[41].resolved = "[B]plus";
  c2_info[41].fileLength = 0U;
  c2_info[41].fileTime1 = 0U;
  c2_info[41].fileTime2 = 0U;
  c2_info[42].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/isequal.m";
  c2_info[42].name = "eml_isequal_core";
  c2_info[42].dominantType = "double";
  c2_info[42].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_isequal_core.m";
  c2_info[42].fileLength = 3543U;
  c2_info[42].fileTime1 = 1213662886U;
  c2_info[42].fileTime2 = 0U;
  c2_info[43].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/bitor.m";
  c2_info[43].name = "eml_isa_uint";
  c2_info[43].dominantType = "uint32";
  c2_info[43].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_isa_uint.m";
  c2_info[43].fileLength = 239U;
  c2_info[43].fileTime1 = 1192491992U;
  c2_info[43].fileTime2 = 0U;
  c2_info[44].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/intmax.m";
  c2_info[44].name = "int32";
  c2_info[44].dominantType = "double";
  c2_info[44].resolved = "[B]int32";
  ...
  c2_info[46].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/isnan.m";
  c2_info[46].fileLength = 472U;
  c2_info[46].fileTime1 = 1192491936U;
  ...
  c2_info[47].resolved = "[B]not";
  c2_info[47].fileLength = 0U;
  c2_info[47].fileTime1 = 0U;
  c2_info[47].fileTime2 = 0U;
  c2_info[48].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_alloc.m";
  c2_info[48].name = "eml_assert_valid_size_arg";
  c2_info[48].dominantType = "double";
  c2_info[48].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_assert_valid_size_arg.m";
  c2_info[48].fileLength = 2835U;
  c2_info[48].fileTime1 = 1210895844U;
  c2_info[48].fileTime2 = 0U;
  c2_info[49].context = "";
  c2_info[49].name = "times";
  c2_info[49].dominantType = "double";
  c2_info[49].resolved = "[B]times";
  c2_info[49].fileLength = 0U;
  c2_info[49].fileTime1 = 0U;
  c2_info[49].fileTime2 = 0U;
  c2_info[50].context = "";
  c2_info[50].name = "rdivide";
  c2_info[50].dominantType = "double";
  c2_info[50].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/rdivide.m";
  c2_info[50].fileLength = 620U;
  c2_info[50].fileTime1 = 1213662890U;
  c2_info[50].fileTime2 = 0U;
  c2_info[51].context = "";
  c2_info[51].name = "any";
  c2_info[51].dominantType = "double";
  c2_info[51].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/any.m";
  c2_info[51].fileLength = 400U;
  c2_info[51].fileTime1 = 1192492106U;
  c2_info[51].fileTime2 = 0U;
  c2_info[52].context = "";
  c2_info[52].name = "diag";
  c2_info[52].dominantType = "double";
  c2_info[52].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/diag.m";
  c2_info[52].fileLength = 2369U;
  c2_info[52].fileTime1 = 1210895844U;
  c2_info[52].fileTime2 = 0U;
  c2_info[53].context =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_isequal_core.m/binary_isequal";
  c2_info[53].name = "all";
  c2_info[53].dominantType = "logical";
  c2_info[53].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/all.m";
  c2_info[53].fileLength = 400U;
  c2_info[53].fileTime1 = 1192492104U;
  c2_info[53].fileTime2 = 0U;
  c2_info[54].context =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/colon.m/maxabs";
  c2_info[54].name = "abs";
  c2_info[54].dominantType = "double";
  c2_info[54].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/elfun/abs.m";
  c2_info[54].fileLength = 538U;
  c2_info[54].fileTime1 = 1203473128U;
  c2_info[54].fileTime2 = 0U;
  c2_info[55].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_alloc.m";
  c2_info[55].name = "isstruct";
  c2_info[55].dominantType = "double";
  c2_info[55].resolved = "[B]isstruct";
  c2_info[55].fileLength = 0U;
  c2_info[55].fileTime1 = 0U;
  c2_info[55].fileTime2 = 0U;
  c2_info[56].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/datafun/sum.m";
  c2_info[56].name = "isequal";
  c2_info[56].dominantType = "double";
  c2_info[56].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/isequal.m";
  c2_info[56].fileLength = 157U;
  c2_info[56].fileTime1 = 1210895846U;
  c2_info[56].fileTime2 = 0U;
  c2_info[57].context =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_assert_valid_size_arg.m/isintegral";
  c2_info[57].name = "false";
  c2_info[57].dominantType = "";
  c2_info[57].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/false.m";
  c2_info[57].fileLength = 238U;
  c2_info[57].fileTime1 = 1192491920U;
  c2_info[57].fileTime2 = 0U;
  c2_info[58].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/bitget.m";
  c2_info[58].name = "eml_int_nbits";
  c2_info[58].dominantType = "char";
  c2_info[58].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_int_nbits.m";
  c2_info[58].fileLength = 467U;
  c2_info[58].fileTime1 = 1192491988U;
  c2_info[58].fileTime2 = 0U;
  c2_info[59].context = "";
  c2_info[59].name = "colon";
  c2_info[59].dominantType = "double";
  c2_info[59].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/colon.m";
  c2_info[59].fileLength = 7324U;
  c2_info[59].fileTime1 = 1197325946U;
  ...
  c2_info[60].fileLength = 5131U;
  c2_info[60].fileTime1 = 1213662890U;
  c2_info[60].fileTime2 = 0U;
  c2_info[61].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/all.m";
  c2_info[61].name = "eml_all_or_any";
  c2_info[61].dominantType = "char";
  c2_info[61].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_all_or_any.m";
  c2_info[61].fileLength = 3423U;
  c2_info[61].fileTime1 = 1213662886U;
  c2_info[61].fileTime2 = 0U;
  c2_info[62].context =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_assert_valid_size_arg.m/numel_for_size";
  c2_info[62].name = "le";
  c2_info[62].dominantType = "double";
  c2_info[62].resolved = "[B]le";
  c2_info[62].fileLength = 0U;
  c2_info[62].fileTime1 = 0U;
  c2_info[62].fileTime2 = 0U;
  c2_info[63].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/intmax.m";
  c2_info[63].name = "ischar";
  c2_info[63].dominantType = "char";
  c2_info[63].resolved = "[B]ischar";
...
static void c2_b_info_helper(c2_ResolvedFunctionInfo c2_info[90])
{
  c2_info[64].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/power.m";
  c2_info[64].name = "eml_alloc";
  c2_info[64].dominantType = "double";
  c2_info[64].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_alloc.m";
  c2_info[64].fileLength = 2627U;
  c2_info[64].fileTime1 = 1213662886U;
  c2_info[64].fileTime2 = 0U;
  c2_info[65].context = "";
  c2_info[65].name = "size";
  c2_info[65].dominantType = "double";
  c2_info[65].resolved = "[B]size";
  c2_info[65].fileLength = 0U;
  c2_info[65].fileTime1 = 0U;
  c2_info[65].fileTime2 = 0U;
  c2_info[66].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/mtimes.m";
  c2_info[66].name = "ones";
  c2_info[66].dominantType = "char";
  c2_info[66].resolved = "[B]ones";
  c2_info[66].fileLength = 0U;
  c2_info[66].fileTime1 = 0U;
  c2_info[66].fileTime2 = 0U;
  c2_info[67].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/diag.m";
  c2_info[67].name = "eml_zeros";
  c2_info[67].dominantType = "int32";
  c2_info[67].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_zeros.m";
  c2_info[67].fileLength = 1083U;
  c2_info[67].fileTime1 = 1213662888U;
  c2_info[67].fileTime2 = 0U;
  c2_info[68].context =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/isfinite.m";
  c2_info[68].name = "isinf";
  c2_info[68].dominantType = "double";
  c2_info[68].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/isinf.m";
  c2_info[68].fileLength = 472U;
  c2_info[68].fileTime1 = 1192491934U;
  ...
  c2_info[69].fileTime1 = 1192491988U;
  c2_info[69].fileTime2 = 0U;
  c2_info[70].context = "";
  c2_info[70].name = "bitand";
  c2_info[70].dominantType = "uint32";
  c2_info[70].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/bitand.m";
  c2_info[70].fileLength = 1046U;
  c2_info[70].fileTime1 = 1209356078U;
  c2_info[70].fileTime2 = 0U;
  c2_info[71].context = "";
  c2_info[71].name = "ctranspose";
  c2_info[71].dominantType = "double";
  c2_info[71].resolved = "[B]ctranspose";
  ...
  c2_info[72].name = "realmax";
  c2_info[72].dominantType = "char";
  c2_info[72].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/realmax.m";
  c2_info[72].fileLength = 498U;
  c2_info[72].fileTime1 = 1192491950U;
  c2_info[72].fileTime2 = 0U;
  c2_info[73].context = "";
  c2_info[73].name = "bitget";
  c2_info[73].dominantType = "uint32";
  c2_info[73].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/bitget.m";
  c2_info[73].fileLength = 1216U;
  c2_info[73].fileTime1 = 1213662888U;
  c2_info[73].fileTime2 = 0U;
  c2_info[74].context =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/blas/internal/eml_blas_xgemm.m";
  c2_info[74].name = "eml_refblas_xgemm";
  c2_info[74].dominantType = "int32";
  c2_info[74].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/blas/refblas/eml_refblas_xgemm.m";
  c2_info[74].fileLength = 5746U;
  c2_info[74].fileTime1 = 1210895858U;
  c2_info[74].fileTime2 = 0U;
  c2_info[75].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/power.m";
  c2_info[75].name = "lt";
  c2_info[75].dominantType = "double";
  c2_info[75].resolved = "[B]lt";
  ...
  c2_info[77].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/datafun/sum.m";
  c2_info[77].fileLength = 2854U;
  c2_info[77].fileTime1 = 1213662886U;
  c2_info[77].fileTime2 = 0U;
  c2_info[78].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/eps.m";
  c2_info[78].name = "real";
  c2_info[78].dominantType = "double";
  c2_info[78].resolved = "[B]real";
  c2_info[78].fileLength = 0U;
  c2_info[78].fileTime1 = 0U;
  c2_info[78].fileTime2 = 0U;
  c2_info[79].context =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_alloc.m/zerosum";
  c2_info[79].name = "cast";
  c2_info[79].dominantType = "double";
  c2_info[79].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/datatypes/cast.m";
  c2_info[79].fileLength = 866U;
  c2_info[79].fileTime1 = 1192491844U;
  c2_info[79].fileTime2 = 0U;
  c2_info[80].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/mtimes.m";
  c2_info[80].name = "eml_xgemm";
  c2_info[80].dominantType = "int32";
  c2_info[80].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/blas/eml_xgemm.m";
  c2_info[80].fileLength = 3184U;
  c2_info[80].fileTime1 = 1209356052U;
  c2_info[80].fileTime2 = 0U;
  c2_info[81].context =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_assert_valid_size_arg.m/isintegral";
  c2_info[81].name = "isfinite";
  c2_info[81].dominantType = "double";
  c2_info[81].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/isfinite.m";
  c2_info[81].fileLength = 341U;
  c2_info[81].fileTime1 = 1192491934U;
  c2_info[81].fileTime2 = 0U;
  c2_info[82].context =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_int_nbits.m";
  c2_info[82].name = "uint8";
  c2_info[82].dominantType = "double";
  c2_info[82].resolved = "[B]uint8";
  c2_info[82].fileLength = 0U;
  c2_info[82].fileTime1 = 0U;
  c2_info[82].fileTime2 = 0U;
  c2_info[83].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/realmin.m";
  c2_info[83].name = "mpower";
  c2_info[83].dominantType = "double";
  c2_info[83].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/mpower.m";
  c2_info[83].fileLength = 3547U;
  c2_info[83].fileTime1 = 1213662888U;
  c2_info[83].fileTime2 = 0U;
  c2_info[84].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_alloc.m";
  c2_info[84].name = "zeros";
  c2_info[84].dominantType = "double";
  c2_info[84].resolved = "[B]zeros";
  c2_info[84].fileLength = 0U;
  c2_info[84].fileTime1 = 0U;
  c2_info[84].fileTime2 = 0U;
  c2_info[85].context = "";
  c2_info[85].name = "length";
  c2_info[85].dominantType = "double";
  c2_info[85].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/length.m";
  c2_info[85].fileLength = 303U;
  c2_info[85].fileTime1 = 1192491938U;
  c2_info[85].fileTime2 = 0U;
  c2_info[86].context =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_all_or_any.m";
  c2_info[86].name = "isempty";
  c2_info[86].dominantType = "logical";
  c2_info[86].resolved = "[B]isempty";
  c2_info[86].fileLength = 0U;
  c2_info[86].fileTime1 = 0U;
  c2_info[86].fileTime2 = 0U;
  c2_info[87].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/eps.m";
  c2_info[87].name = "eml_guarded_nan";
  c2_info[87].dominantType = "";
  c2_info[87].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_guarded_nan.m";
  c2_info[87].fileLength = 485U;
  c2_info[87].fileTime1 = 1192491980U;
  c2_info[87].fileTime2 = 0U;
  c2_info[88].context =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_assert_valid_size_arg.m/isintegral";
  c2_info[88].name = "true";
  c2_info[88].dominantType = "";
  c2_info[88].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/true.m";
  c2_info[88].fileLength = 237U;
  c2_info[88].fileTime1 = 1192491962U;
  c2_info[88].fileTime2 = 0U;
  c2_info[89].context =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/isfinite.m";
  c2_info[89].name = "and";
  c2_info[89].dominantType = "logical";
  c2_info[89].resolved = "[B]and";
...
/* SFunction Glue Code */
void sf_c2_main_sim_adapt_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c2_main_sim_adapt_get_autoinheritance_info(void)
{
...
static void sf_opaque_initialize_c2_main_sim_adapt(void *chartInstanceVar)
{
  chart_debug_initialization(chartInstance.S,0);
  initialize_params_c2_main_sim_adapt();
  initialize_c2_main_sim_adapt();
}

static void sf_opaque_enable_c2_main_sim_adapt(void *chartInstanceVar)
{
  enable_c2_main_sim_adapt();
}

static void sf_opaque_disable_c2_main_sim_adapt(void *chartInstanceVar)
{
  disable_c2_main_sim_adapt();
}

static void sf_opaque_gateway_c2_main_sim_adapt(void *chartInstanceVar)
{
  sf_c2_main_sim_adapt();
}

static mxArray* sf_opaque_get_sim_state_c2_main_sim_adapt(void *chartInstanceVar)
{
  mxArray *st = (mxArray *) get_sim_state_c2_main_sim_adapt();
  return st;
}

static void sf_opaque_set_sim_state_c2_main_sim_adapt(void *chartInstanceVar,
  const mxArray *st)
{
  set_sim_state_c2_main_sim_adapt(sf_mex_dup(st));
}

static void sf_opaque_terminate_c2_main_sim_adapt(void *chartInstanceVar)
{
  ...
  finalize_c2_main_sim_adapt();
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c2_main_sim_adapt(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c2_main_sim_adapt(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    int_T chartIsInlinable =
      (int_T)sf_is_chart_inlinable("main_sim_adapt","main_sim_adapt",2);
    ssSetStateflowIsInlinable(S,chartIsInlinable);
    ssSetRTWCG(S,sf_rtw_info_uint_prop("main_sim_adapt","main_sim_adapt",2,
                "RTWCG"));
    ssSetEnableFcnIsTrivial(S,1);
    ssSetDisableFcnIsTrivial(S,1);
    ssSetNotMultipleInlinable(S,sf_rtw_info_uint_prop("main_sim_adapt",
      "main_sim_adapt",2,"gatewayCannotBeInlinedMultipleTimes"));
    if (chartIsInlinable) {
      ...
      sf_mark_chart_expressionable_inputs(S,"main_sim_adapt","main_sim_adapt",2,
        7);
      sf_mark_chart_reusable_outputs(S,"main_sim_adapt","main_sim_adapt",2,4);
    }

    sf_set_rtw_dwork_info(S,"main_sim_adapt","main_sim_adapt",2);
...
static void mdlRTW_c2_main_sim_adapt(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
    sf_write_symbol_mapping(S, "main_sim_adapt", "main_sim_adapt",2);
    ssWriteRTWStrParam(S, "StateflowChartType", "Embedded MATLAB");
  }
}

static void mdlStart_c2_main_sim_adapt(SimStruct *S)
{
  chartInstance.chartInfo.chartInstance = NULL;
  chartInstance.chartInfo.isEMLChart = 1;
  chartInstance.chartInfo.chartInitialized = 0;
  chartInstance.chartInfo.sFunctionGateway = sf_opaque_gateway_c2_main_sim_adapt;
  chartInstance.chartInfo.initializeChart =
    sf_opaque_initialize_c2_main_sim_adapt;
  chartInstance.chartInfo.terminateChart = sf_opaque_terminate_c2_main_sim_adapt;
  chartInstance.chartInfo.enableChart = sf_opaque_enable_c2_main_sim_adapt;
  chartInstance.chartInfo.disableChart = sf_opaque_disable_c2_main_sim_adapt;
  chartInstance.chartInfo.getSimState =
    sf_opaque_get_sim_state_c2_main_sim_adapt;
  chartInstance.chartInfo.setSimState =
    sf_opaque_set_sim_state_c2_main_sim_adapt;
  chartInstance.chartInfo.zeroCrossings = NULL;
  chartInstance.chartInfo.outputs = NULL;
  chartInstance.chartInfo.derivatives = NULL;
  chartInstance.chartInfo.mdlRTW = mdlRTW_c2_main_sim_adapt;
  chartInstance.chartInfo.mdlStart = mdlStart_c2_main_sim_adapt;
  chartInstance.chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c2_main_sim_adapt;
...
void c2_main_sim_adapt_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c2_main_sim_adapt(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c2_main_sim_adapt(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c2_main_sim_adapt(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c2_main_sim_adapt_method_dispatcher.\n"
