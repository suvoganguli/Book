...
const mxArray *sf_c6_aeroutilslib_get_eml_resolved_functions_info(void)
{
  ...
  (*c6_b_info)[66].name = "and";
  (*c6_b_info)[66].dominantType = "logical";
  (*c6_b_info)[66].resolved = "[B]and";
...
static void c6_info_helper(c6_ResolvedFunctionInfo c6_info[67])
{
  c6_info[0].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/false.m";
  c6_info[0].name = "logical";
  c6_info[0].dominantType = "double";
  c6_info[0].resolved = "[B]logical";
  ...
  c6_info[3].name = "ndims";
  c6_info[3].dominantType = "double";
  c6_info[3].resolved = "[B]ndims";
  ...
  c6_info[12].resolved = "[B]ne";
  c6_info[12].fileLength = 0U;
  c6_info[12].fileTime1 = 0U;
  c6_info[12].fileTime2 = 0U;
  c6_info[13].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/realmin.m";
  c6_info[13].name = "mpower";
  c6_info[13].dominantType = "double";
  c6_info[13].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/mpower.m";
  c6_info[13].fileLength = 3547U;
  c6_info[13].fileTime1 = 1213662888U;
  c6_info[13].fileTime2 = 0U;
  c6_info[14].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/colon.m";
  c6_info[14].name = "ischar";
  c6_info[14].dominantType = "double";
  c6_info[14].resolved = "[B]ischar";
  ...
  c6_info[20].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/intmax.m";
  c6_info[20].name = "int32";
  c6_info[20].dominantType = "double";
  c6_info[20].resolved = "[B]int32";
  ...
  c6_info[21].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/datafun/sum.m";
  c6_info[21].fileLength = 2854U;
  c6_info[21].fileTime1 = 1213662886U;
  c6_info[21].fileTime2 = 0U;
  c6_info[22].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/mpower.m";
  c6_info[22].name = "assert";
  c6_info[22].dominantType = "char";
  c6_info[22].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/lang/assert.m";
  c6_info[22].fileLength = 2684U;
  c6_info[22].fileTime1 = 1210895856U;
  ...
  c6_info[24].name = "floor";
  c6_info[24].dominantType = "double";
  c6_info[24].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/elfun/floor.m";
  c6_info[24].fileLength = 332U;
  c6_info[24].fileTime1 = 1203473224U;
  c6_info[24].fileTime2 = 0U;
  c6_info[25].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/colon.m";
  c6_info[25].name = "isinteger";
  c6_info[25].dominantType = "double";
  c6_info[25].resolved = "[B]isinteger";
  ...
  c6_info[29].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/colon.m";
  c6_info[29].fileLength = 7324U;
  c6_info[29].fileTime1 = 1197325946U;
  c6_info[29].fileTime2 = 0U;
  c6_info[30].context =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_assert_valid_size_arg.m";
  c6_info[30].name = "isnumeric";
  c6_info[30].dominantType = "double";
  c6_info[30].resolved = "[B]isnumeric";
  ...
  c6_info[31].name = "class";
  c6_info[31].dominantType = "double";
  c6_info[31].resolved = "[B]class";
  ...
  c6_info[35].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/mpower.m";
  c6_info[35].name = "power";
  c6_info[35].dominantType = "double";
  c6_info[35].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/power.m";
  c6_info[35].fileLength = 5131U;
  c6_info[35].fileTime1 = 1213662890U;
  c6_info[35].fileTime2 = 0U;
  c6_info[36].context =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/colon.m/is_flint_colon";
  c6_info[36].name = "eps";
  c6_info[36].dominantType = "double";
  c6_info[36].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/eps.m";
  c6_info[36].fileLength = 1342U;
  c6_info[36].fileTime1 = 1210895846U;
  c6_info[36].fileTime2 = 0U;
  c6_info[37].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/eps.m";
  c6_info[37].name = "eml_alloc";
  c6_info[37].dominantType = "double";
  c6_info[37].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_alloc.m";
  c6_info[37].fileLength = 2627U;
  ...
  c6_info[38].name = "all";
  c6_info[38].dominantType = "logical";
  c6_info[38].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/all.m";
  c6_info[38].fileLength = 400U;
  c6_info[38].fileTime1 = 1192492104U;
  ...
  c6_info[40].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/intmax.m";
  c6_info[40].fileLength = 1535U;
  c6_info[40].fileTime1 = 1192491928U;
  ...
  c6_info[42].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/eps.m";
  c6_info[42].name = "eml_guarded_nan";
  c6_info[42].dominantType = "";
  c6_info[42].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_guarded_nan.m";
  c6_info[42].fileLength = 485U;
  c6_info[42].fileTime1 = 1192491980U;
  ...
  c6_info[44].context = "";
  c6_info[44].name = "length";
  c6_info[44].dominantType = "double";
  c6_info[44].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/length.m";
  c6_info[44].fileLength = 303U;
  c6_info[44].fileTime1 = 1192491938U;
  c6_info[44].fileTime2 = 0U;
  c6_info[45].context =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_all_or_any.m";
  c6_info[45].name = "eml_nonsingleton_dim";
  c6_info[45].dominantType = "logical";
  c6_info[45].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_nonsingleton_dim.m";
  c6_info[45].fileLength = 404U;
  c6_info[45].fileTime1 = 1192492000U;
  ...
  c6_info[51].name = "realmin";
  c6_info[51].dominantType = "";
  c6_info[51].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/realmin.m";
  c6_info[51].fileLength = 475U;
  c6_info[51].fileTime1 = 1192491952U;
  c6_info[51].fileTime2 = 0U;
  c6_info[52].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/elfun/abs.m";
  ...
  c6_info[53].context =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_assert_valid_size_arg.m";
  c6_info[53].name = "isvector";
  c6_info[53].dominantType = "double";
  c6_info[53].resolved = "[B]isvector";
  c6_info[53].fileLength = 0U;
  c6_info[53].fileTime1 = 0U;
  c6_info[53].fileTime2 = 0U;
  c6_info[54].context =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/colon.m/is_flint_colon";
  c6_info[54].name = "isfinite";
  c6_info[54].dominantType = "double";
  c6_info[54].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/isfinite.m";
  c6_info[54].fileLength = 341U;
  c6_info[54].fileTime1 = 1192491934U;
  c6_info[54].fileTime2 = 0U;
  c6_info[55].context =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/colon.m/maxabs";
  c6_info[55].name = "abs";
  c6_info[55].dominantType = "double";
  c6_info[55].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/elfun/abs.m";
  c6_info[55].fileLength = 538U;
  c6_info[55].fileTime1 = 1203473128U;
  ...
  c6_info[58].context =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_all_or_any.m";
  c6_info[58].name = "eml_set_singleton_dim";
  c6_info[58].dominantType = "double";
  c6_info[58].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_set_singleton_dim.m";
  c6_info[58].fileLength = 398U;
  c6_info[58].fileTime1 = 1209356038U;
  ...
  c6_info[60].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/nan.m";
  c6_info[60].fileLength = 474U;
  c6_info[60].fileTime1 = 1192491944U;
  ...
  c6_info[62].context =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_assert_valid_size_arg.m/isintegral";
  c6_info[62].name = "true";
  c6_info[62].dominantType = "";
  c6_info[62].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/true.m";
  c6_info[62].fileLength = 237U;
  c6_info[62].fileTime1 = 1192491962U;
  c6_info[62].fileTime2 = 0U;
  c6_info[63].context =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/isfinite.m";
  c6_info[63].name = "isnan";
  c6_info[63].dominantType = "double";
  c6_info[63].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/isnan.m";
  c6_info[63].fileLength = 472U;
  c6_info[63].fileTime1 = 1192491936U;
...
static void mdlSetWorkWidths_c6_aeroutilslib(SimStruct *S)
{
  ...
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    int_T chartIsInlinable =
      (int_T)sf_is_chart_inlinable("aeroutilslib","main_sim_adapt",6);
    ssSetStateflowIsInlinable(S,chartIsInlinable);
    ssSetRTWCG(S,sf_rtw_info_uint_prop("aeroutilslib","main_sim_adapt",6,"RTWCG"));
    ssSetEnableFcnIsTrivial(S,1);
    ssSetDisableFcnIsTrivial(S,1);
    ssSetNotMultipleInlinable(S,sf_rtw_info_uint_prop("aeroutilslib",
      "main_sim_adapt",6,"gatewayCannotBeInlinedMultipleTimes"));
    if (chartIsInlinable) {
      ssSetInputPortOptimOpts(S, 0, SS_REUSABLE_AND_LOCAL);
      sf_mark_chart_expressionable_inputs(S,"aeroutilslib","main_sim_adapt",6,1);
      sf_mark_chart_reusable_outputs(S,"aeroutilslib","main_sim_adapt",6,1);
    }

    sf_set_rtw_dwork_info(S,"aeroutilslib","main_sim_adapt",6);
...
{
  if (sim_mode_is_rtw_gen(S)) {
    sf_write_symbol_mapping(S, "aeroutilslib", "main_sim_adapt",6);
