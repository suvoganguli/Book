  ...
  if (nrhs>2 && mxIsChar(prhs[1])) {
    ...
    if (!strcmp(commandName,"library")) {
      ...
      if (!strcmp(machineName,"GTM_aerolib")) {
        if (nrhs==3) {
          ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(3992212506U);
          ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(222482141U);
          ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(2047203670U);
          ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(3031380782U);
        } else if (nrhs==4) {
