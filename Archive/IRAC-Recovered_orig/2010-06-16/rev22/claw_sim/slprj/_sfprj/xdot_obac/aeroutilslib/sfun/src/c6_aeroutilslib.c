...
static void c6_info_helper(c6_ResolvedFunctionInfo c6_info[67])
{
  c6_info[0].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/intmax.m";
  c6_info[0].name = "int32";
  c6_info[0].dominantType = "double";
  c6_info[0].resolved = "[B]int32";
  c6_info[0].fileLength = 0U;
  c6_info[0].fileTime1 = 0U;
  c6_info[0].fileTime2 = 0U;
  c6_info[1].context = "";
  c6_info[1].name = "minus";
  c6_info[1].dominantType = "double";
  c6_info[1].resolved = "[B]minus";
  ...
  c6_info[3].name = "isinteger";
  c6_info[3].dominantType = "double";
  c6_info[3].resolved = "[B]isinteger";
  ...
  c6_info[4].name = "isempty";
  c6_info[4].dominantType = "logical";
  c6_info[4].resolved = "[B]isempty";
  ...
  c6_info[5].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/datafun/sum.m";
  c6_info[5].fileLength = 2854U;
  c6_info[5].fileTime1 = 1213662886U;
  c6_info[5].fileTime2 = 0U;
  c6_info[6].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/length.m";
  c6_info[6].name = "nargin";
  c6_info[6].dominantType = "";
  c6_info[6].resolved = "[B]nargin";
  ...
  c6_info[7].name = "isscalar";
  c6_info[7].dominantType = "double";
  c6_info[7].resolved = "[B]isscalar";
  ...
  c6_info[8].resolved = "[B]gt";
  c6_info[8].fileLength = 0U;
  c6_info[8].fileTime1 = 0U;
  c6_info[8].fileTime2 = 0U;
  c6_info[9].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/mtimes.m";
  c6_info[9].name = "strcmp";
  c6_info[9].dominantType = "char";
  c6_info[9].resolved = "[B]strcmp";
  ...
  c6_info[12].fileLength = 909U;
  c6_info[12].fileTime1 = 1192491982U;
  c6_info[12].fileTime2 = 0U;
  c6_info[13].context =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_all_or_any.m";
  c6_info[13].name = "eml_set_singleton_dim";
  c6_info[13].dominantType = "double";
  c6_info[13].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_set_singleton_dim.m";
  c6_info[13].fileLength = 398U;
  c6_info[13].fileTime1 = 1209356038U;
  c6_info[13].fileTime2 = 0U;
  c6_info[14].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/isequal.m";
  c6_info[14].name = "eml_isequal_core";
  c6_info[14].dominantType = "double";
  c6_info[14].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_isequal_core.m";
  c6_info[14].fileLength = 3543U;
  c6_info[14].fileTime1 = 1213662886U;
  c6_info[14].fileTime2 = 0U;
  c6_info[15].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/colon.m";
  c6_info[15].name = "isa";
  c6_info[15].dominantType = "double";
  c6_info[15].resolved = "[B]isa";
  ...
  c6_info[16].name = "isinf";
  c6_info[16].dominantType = "double";
  c6_info[16].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/isinf.m";
  c6_info[16].fileLength = 472U;
  c6_info[16].fileTime1 = 1192491934U;
  c6_info[16].fileTime2 = 0U;
  c6_info[17].context =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_assert_valid_size_arg.m/isintegral";
  c6_info[17].name = "true";
  c6_info[17].dominantType = "";
  c6_info[17].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/true.m";
  c6_info[17].fileLength = 237U;
  c6_info[17].fileTime1 = 1192491962U;
  ...
  c6_info[19].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/eps.m";
  c6_info[19].name = "eml_alloc";
  c6_info[19].dominantType = "double";
  c6_info[19].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_alloc.m";
  c6_info[19].fileLength = 2627U;
  c6_info[19].fileTime1 = 1213662886U;
  c6_info[19].fileTime2 = 0U;
  c6_info[20].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/mpower.m";
  c6_info[20].name = "ndims";
  c6_info[20].dominantType = "double";
  c6_info[20].resolved = "[B]ndims";
  ...
  c6_info[22].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/power.m";
  ...
  c6_info[22].fileTime1 = 1213662886U;
  c6_info[22].fileTime2 = 0U;
  c6_info[23].context =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_assert_valid_size_arg.m";
  c6_info[23].name = "isvector";
  c6_info[23].dominantType = "double";
  c6_info[23].resolved = "[B]isvector";
  c6_info[23].fileLength = 0U;
  c6_info[23].fileTime1 = 0U;
  c6_info[23].fileTime2 = 0U;
  c6_info[24].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_alloc.m";
  c6_info[24].name = "eml_assert_valid_size_arg";
  c6_info[24].dominantType = "double";
  c6_info[24].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_assert_valid_size_arg.m";
  c6_info[24].fileLength = 2835U;
  c6_info[24].fileTime1 = 1210895844U;
  c6_info[24].fileTime2 = 0U;
  c6_info[25].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/eps.m";
  c6_info[25].name = "realmin";
  c6_info[25].dominantType = "";
  c6_info[25].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/realmin.m";
  c6_info[25].fileLength = 475U;
  c6_info[25].fileTime1 = 1192491952U;
  c6_info[25].fileTime2 = 0U;
  c6_info[26].context = "";
  c6_info[26].name = "uminus";
  c6_info[26].dominantType = "double";
  c6_info[26].resolved = "[B]uminus";
  ...
  c6_info[27].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/elfun/abs.m";
  c6_info[27].fileLength = 538U;
  c6_info[27].fileTime1 = 1203473128U;
  c6_info[27].fileTime2 = 0U;
  c6_info[28].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/elfun/abs.m";
  c6_info[28].name = "class";
  c6_info[28].dominantType = "double";
  c6_info[28].resolved = "[B]class";
  ...
  c6_info[29].name = "all";
  c6_info[29].dominantType = "logical";
  c6_info[29].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/all.m";
  c6_info[29].fileLength = 400U;
  c6_info[29].fileTime1 = 1192492104U;
  ...
  c6_info[31].name = "eml_guarded_nan";
  c6_info[31].dominantType = "";
  c6_info[31].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_guarded_nan.m";
  c6_info[31].fileLength = 485U;
  c6_info[31].fileTime1 = 1192491980U;
  c6_info[31].fileTime2 = 0U;
  c6_info[32].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_alloc.m";
  c6_info[32].name = "isstruct";
  c6_info[32].dominantType = "double";
  c6_info[32].resolved = "[B]isstruct";
  ...
  c6_info[34].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/mtimes.m";
  c6_info[34].fileLength = 2336U;
  c6_info[34].fileTime1 = 1213662890U;
  c6_info[34].fileTime2 = 0U;
  c6_info[35].context =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/isfinite.m";
  c6_info[35].name = "isnan";
  c6_info[35].dominantType = "double";
  c6_info[35].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/isnan.m";
  c6_info[35].fileLength = 472U;
  c6_info[35].fileTime1 = 1192491936U;
  c6_info[35].fileTime2 = 0U;
  c6_info[36].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/realmin.m";
  c6_info[36].name = "mpower";
  c6_info[36].dominantType = "double";
  c6_info[36].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/mpower.m";
  c6_info[36].fileLength = 3547U;
  c6_info[36].fileTime1 = 1213662888U;
  ...
  c6_info[39].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/nan.m";
  c6_info[39].fileLength = 474U;
  c6_info[39].fileTime1 = 1192491944U;
  c6_info[39].fileTime2 = 0U;
  c6_info[40].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/elfun/abs.m";
  c6_info[40].name = "islogical";
  c6_info[40].dominantType = "double";
  c6_info[40].resolved = "[B]islogical";
  ...
  c6_info[43].context =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_assert_valid_size_arg.m";
  c6_info[43].name = "isnumeric";
  c6_info[43].dominantType = "double";
  c6_info[43].resolved = "[B]isnumeric";
  c6_info[43].fileLength = 0U;
  c6_info[43].fileTime1 = 0U;
  c6_info[43].fileTime2 = 0U;
  c6_info[44].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/elfun/floor.m";
  ...
  c6_info[44].fileLength = 260U;
  c6_info[44].fileTime1 = 1209355990U;
  c6_info[44].fileTime2 = 0U;
  c6_info[45].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/datafun/sum.m";
  c6_info[45].name = "isequal";
  c6_info[45].dominantType = "double";
  c6_info[45].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/isequal.m";
  c6_info[45].fileLength = 157U;
  c6_info[45].fileTime1 = 1210895846U;
  c6_info[45].fileTime2 = 0U;
  c6_info[46].context = "";
  c6_info[46].name = "times";
  c6_info[46].dominantType = "double";
  c6_info[46].resolved = "[B]times";
  c6_info[46].fileLength = 0U;
  c6_info[46].fileTime1 = 0U;
  c6_info[46].fileTime2 = 0U;
  c6_info[47].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/colon.m";
  c6_info[47].name = "ge";
  c6_info[47].dominantType = "double";
  c6_info[47].resolved = "[B]ge";
  ...
  c6_info[50].context = "";
  c6_info[50].name = "length";
  c6_info[50].dominantType = "double";
  c6_info[50].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/length.m";
  c6_info[50].fileLength = 303U;
  c6_info[50].fileTime1 = 1192491938U;
  c6_info[50].fileTime2 = 0U;
  c6_info[51].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/colon.m";
  c6_info[51].name = "isreal";
  c6_info[51].dominantType = "double";
  c6_info[51].resolved = "[B]isreal";
  c6_info[51].fileLength = 0U;
  c6_info[51].fileTime1 = 0U;
  c6_info[51].fileTime2 = 0U;
  c6_info[52].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/length.m";
  c6_info[52].name = "eq";
  c6_info[52].dominantType = "double";
  c6_info[52].resolved = "[B]eq";
  ...
  c6_info[53].name = "isfinite";
  c6_info[53].dominantType = "double";
  c6_info[53].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/isfinite.m";
  c6_info[53].fileLength = 341U;
  c6_info[53].fileTime1 = 1192491934U;
  c6_info[53].fileTime2 = 0U;
  c6_info[54].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/elfun/abs.m";
  c6_info[54].name = "eml_scalar_abs";
  c6_info[54].dominantType = "double";
  c6_info[54].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/elfun/eml_scalar_abs.m";
  c6_info[54].fileLength = 461U;
  c6_info[54].fileTime1 = 1203473160U;
  c6_info[54].fileTime2 = 0U;
  c6_info[55].context =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/isfinite.m";
  c6_info[55].name = "not";
  c6_info[55].dominantType = "logical";
  c6_info[55].resolved = "[B]not";
  ...
  c6_info[56].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/eps.m";
  c6_info[56].fileLength = 1342U;
  c6_info[56].fileTime1 = 1210895846U;
  ...
  c6_info[58].context =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_assert_valid_size_arg.m/isintegral";
  c6_info[58].name = "false";
  c6_info[58].dominantType = "";
  c6_info[58].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/false.m";
  c6_info[58].fileLength = 238U;
  c6_info[58].fileTime1 = 1192491920U;
  c6_info[58].fileTime2 = 0U;
  c6_info[59].context =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_all_or_any.m";
  c6_info[59].name = "eml_nonsingleton_dim";
  c6_info[59].dominantType = "logical";
  c6_info[59].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_nonsingleton_dim.m";
  c6_info[59].fileLength = 404U;
  c6_info[59].fileTime1 = 1192492000U;
  ...
  c6_info[61].context =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_scalexp_size.m";
  c6_info[61].name = "eml_scalexp_compatible";
  c6_info[61].dominantType = "double";
  c6_info[61].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_scalexp_compatible.m";
  c6_info[61].fileLength = 502U;
  c6_info[61].fileTime1 = 1208205258U;
  c6_info[61].fileTime2 = 0U;
  c6_info[62].context =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/colon.m/is_flint_colon";
  c6_info[62].name = "floor";
  c6_info[62].dominantType = "double";
  c6_info[62].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/elfun/floor.m";
  c6_info[62].fileLength = 332U;
  c6_info[62].fileTime1 = 1203473224U;
  c6_info[62].fileTime2 = 0U;
  c6_info[63].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/length.m";
  c6_info[63].name = "size";
  c6_info[63].dominantType = "double";
  c6_info[63].resolved = "[B]size";
...
static void mdlSetWorkWidths_c6_aeroutilslib(SimStruct *S)
{
  ...
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    int_T chartIsInlinable =
      (int_T)sf_is_chart_inlinable("aeroutilslib","xdot_obac",6);
    ssSetStateflowIsInlinable(S,chartIsInlinable);
    ssSetRTWCG(S,sf_rtw_info_uint_prop("aeroutilslib","xdot_obac",6,"RTWCG"));
    ssSetEnableFcnIsTrivial(S,1);
    ssSetDisableFcnIsTrivial(S,1);
    ssSetNotMultipleInlinable(S,sf_rtw_info_uint_prop("aeroutilslib","xdot_obac",
      6,"gatewayCannotBeInlinedMultipleTimes"));
    if (chartIsInlinable) {
      ssSetInputPortOptimOpts(S, 0, SS_REUSABLE_AND_LOCAL);
      sf_mark_chart_expressionable_inputs(S,"aeroutilslib","xdot_obac",6,1);
      sf_mark_chart_reusable_outputs(S,"aeroutilslib","xdot_obac",6,1);
    }

    sf_set_rtw_dwork_info(S,"aeroutilslib","xdot_obac",6);
...
{
  if (sim_mode_is_rtw_gen(S)) {
    sf_write_symbol_mapping(S, "aeroutilslib", "xdot_obac",6);
