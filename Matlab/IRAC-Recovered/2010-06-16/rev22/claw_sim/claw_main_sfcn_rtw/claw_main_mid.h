...
/* instance data for model: claw_main */
void *claw_main_malloc(SimStruct *rts)
{
  ...
  /* block I/O */
  {
    void *b = malloc(sizeof(BlockIO_claw_main));
...

    {
      ...
      for (i = 0; i < 6; i++) {
        ((BlockIO_claw_main *) ssGetLocalBlockIO(rts))->AssignmenttoLateral_l[i]
          = 0.0;
      }
      ...
      for (i = 0; i < 6; i++) {
        ((BlockIO_claw_main *) ssGetLocalBlockIO(rts))->AssignmenttoLateral1_k[i]
          = 0.0;
      }

      for (i = 0; i < 6; i++) {
        ((BlockIO_claw_main *) ssGetLocalBlockIO(rts))->AssignmenttoCY[i] = 0.0;
      }
      ...
      for (i = 0; i < 6; i++) {
        ((BlockIO_claw_main *) ssGetLocalBlockIO(rts))->AssignmenttoLateral_o[i]
          = 0.0;
      }
      ...
      for (i = 0; i < 6; i++) {
        ((BlockIO_claw_main *) ssGetLocalBlockIO(rts))->AssignmenttoLateral1_e[i]
          = 0.0;
      }

      for (i = 0; i < 6; i++) {
        ((BlockIO_claw_main *) ssGetLocalBlockIO(rts))->AssignmenttoLateral_ll[i]
          = 0.0;
      }
      ...
      for (i = 0; i < 6; i++) {
        ((BlockIO_claw_main *) ssGetLocalBlockIO(rts))->AssignmenttoLateral1_m[i]
          = 0.0;
      }
      ...
      ((BlockIO_claw_main *) ssGetLocalBlockIO(rts))->LogicalOperator3[0] = 0.0;
      ((BlockIO_claw_main *) ssGetLocalBlockIO(rts))->LogicalOperator3[1] = 0.0;
      ((BlockIO_claw_main *) ssGetLocalBlockIO(rts))->LogicalOperator3[2] = 0.0;
      ...
      ((BlockIO_claw_main *) ssGetLocalBlockIO(rts))->DiscreteTimeIntegrator_o[0]
        = 0.0;
      ((BlockIO_claw_main *) ssGetLocalBlockIO(rts))->DiscreteTimeIntegrator_o[1]
        = 0.0;
      ((BlockIO_claw_main *) ssGetLocalBlockIO(rts))->DiscreteTimeIntegrator_o[2]
        = 0.0;
      ...
      ((BlockIO_claw_main *) ssGetLocalBlockIO(rts))->DiscreteTimeIntegrator_p[0]
        = 0.0;
      ((BlockIO_claw_main *) ssGetLocalBlockIO(rts))->DiscreteTimeIntegrator_p[1]
        = 0.0;
      ((BlockIO_claw_main *) ssGetLocalBlockIO(rts))->DiscreteTimeIntegrator_p[2]
        = 0.0;
      ((BlockIO_claw_main *) ssGetLocalBlockIO(rts))->DiscreteTimeIntegrator_p[3]
        = 0.0;
      ...
      ((BlockIO_claw_main *) ssGetLocalBlockIO(rts))->MultiportSwitch_k[0] = 0.0;
      ((BlockIO_claw_main *) ssGetLocalBlockIO(rts))->MultiportSwitch_k[1] = 0.0;
      ((BlockIO_claw_main *) ssGetLocalBlockIO(rts))->MultiportSwitch_k[2] = 0.0;
      ((BlockIO_claw_main *) ssGetLocalBlockIO(rts))->MultiportSwitch_k[3] = 0.0;
      ...
      ((BlockIO_claw_main *) ssGetLocalBlockIO(rts))->DiscreteTimeIntegrator_a[0]
        = 0.0;
      ((BlockIO_claw_main *) ssGetLocalBlockIO(rts))->DiscreteTimeIntegrator_a[1]
        = 0.0;
      ((BlockIO_claw_main *) ssGetLocalBlockIO(rts))->DiscreteTimeIntegrator_a[2]
        = 0.0;
