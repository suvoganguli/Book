#ifndef __c4_auxvars_lib_h__
#define __c4_auxvars_lib_h__
...
typedef struct {
  ...
  uint8_T c4_is_active_c4_auxvars_lib;
...
extern void c4_auxvars_lib_method_dispatcher(SimStruct *S, int_T method, void
  *data);
