  ...
  int chartFileNumber, int_T method, void *data)
{
  if (chartFileNumber==1) {
    c1_aeroutilslib_method_dispatcher(simstructPtr, method, data);
    return 1;
  }

  if (chartFileNumber==3) {
    c3_aeroutilslib_method_dispatcher(simstructPtr, method, data);
    return 1;
  }
  ...
  if (nrhs>2 && mxIsChar(prhs[1])) {
    ...
    if (!strcmp(commandName,"library")) {
      ...
      if (!strcmp(machineName,"aeroutilslib")) {
        if (nrhs==3) {
          ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(1975066022U);
          ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(3224351860U);
          ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(2301269767U);
          ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(1343541997U);
        } else if (nrhs==4) {
          ...
          switch (chartFileNumber) {
           case 1:
            {
              extern void sf_c1_aeroutilslib_get_check_sum(mxArray *plhs[]);
              sf_c1_aeroutilslib_get_check_sum(plhs);
              break;
            }

           case 3:
            {
              extern void sf_c3_aeroutilslib_get_check_sum(mxArray *plhs[]);
              sf_c3_aeroutilslib_get_check_sum(plhs);
              break;
            }
  ...
  int nrhs, const mxArray * prhs[] )
{
...

  {
    ...
    switch (chartFileNumber) {
     case 1:
      {
        extern mxArray *sf_c1_aeroutilslib_get_autoinheritance_info(void);
        plhs[0] = sf_c1_aeroutilslib_get_autoinheritance_info();
        break;
      }

     case 3:
      {
        extern mxArray *sf_c3_aeroutilslib_get_autoinheritance_info(void);
        plhs[0] = sf_c3_aeroutilslib_get_autoinheritance_info();
        break;
      }
  ...
  plhs[], int nrhs, const mxArray * prhs[] )
{
...

  {
    ...
    switch (chartFileNumber) {
     case 1:
      {
        extern const mxArray *sf_c1_aeroutilslib_get_eml_resolved_functions_info
          (void);
        mxArray *persistentMxArray = (mxArray *)
          sf_c1_aeroutilslib_get_eml_resolved_functions_info();
     ...
     case 3:
      {
        extern const mxArray *sf_c3_aeroutilslib_get_eml_resolved_functions_info
          (void);
        mxArray *persistentMxArray = (mxArray *)
          sf_c3_aeroutilslib_get_eml_resolved_functions_info();
        plhs[0] = mxDuplicateArray(persistentMxArray);
        mxDestroyArray(persistentMxArray);
        break;
      }
