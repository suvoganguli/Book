...
static void initialize_c1_aeroutilslib(SFc1_aeroutilslibInstanceStruct
  *chartInstance);
static void initialize_params_c1_aeroutilslib(SFc1_aeroutilslibInstanceStruct
  *chartInstance);
static void enable_c1_aeroutilslib(SFc1_aeroutilslibInstanceStruct
  *chartInstance);
static void disable_c1_aeroutilslib(SFc1_aeroutilslibInstanceStruct
  *chartInstance);
static void update_debugger_state_c1_aeroutilslib
  (SFc1_aeroutilslibInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c1_aeroutilslib
  (SFc1_aeroutilslibInstanceStruct *chartInstance);
static void set_sim_state_c1_aeroutilslib(SFc1_aeroutilslibInstanceStruct
  *chartInstance, const mxArray *c1_st);
static void finalize_c1_aeroutilslib(SFc1_aeroutilslibInstanceStruct
  *chartInstance);
static void sf_c1_aeroutilslib(SFc1_aeroutilslibInstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c1_machineNumber, uint32_T
  c1_chartNumber);
static real_T c1_mpower(SFc1_aeroutilslibInstanceStruct *chartInstance, real_T
  c1_a);
static void c1_eml_warning(SFc1_aeroutilslibInstanceStruct *chartInstance);
...
static void init_dsm_address_info(SFc1_aeroutilslibInstanceStruct *chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c1_is_active_c1_aeroutilslib = 0U;
}
...
static const mxArray *c1_sf_marshall(void *chartInstanceVoid, void *c1_u)
{
  ...
  const mxArray *c1_b_y = NULL;
  SFc1_aeroutilslibInstanceStruct *chartInstance;
  chartInstance = (SFc1_aeroutilslibInstanceStruct *)chartInstanceVoid;
  c1_y = NULL;
  c1_b_u = *((real_T *)c1_u);
  c1_b_y = NULL;
...
const mxArray *sf_c1_aeroutilslib_get_eml_resolved_functions_info(void)
{
...
static void c1_info_helper(c1_ResolvedFunctionInfo c1_info[52])
{
  c1_info[0].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/isfinite.m";
  c1_info[0].name = "isinf";
  c1_info[0].dominantType = "double";
  c1_info[0].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/isinf.m";
  c1_info[0].fileLength = 472U;
  c1_info[0].fileTime1 = 1192491934U;
  c1_info[0].fileTime2 = 0U;
  c1_info[1].context =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_alloc.m/zerosum";
  c1_info[1].name = "plus";
  c1_info[1].dominantType = "double";
  c1_info[1].resolved = "[B]plus";
  c1_info[1].fileLength = 0U;
  c1_info[1].fileTime1 = 0U;
  c1_info[1].fileTime2 = 0U;
  c1_info[2].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/datatypes/cast.m";
  c1_info[2].name = "ge";
  ...
  c1_info[3].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/rdivide.m";
  c1_info[3].name = "eml_div";
  c1_info[3].dominantType = "double";
  c1_info[3].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_div.m";
  c1_info[3].fileLength = 4254U;
  c1_info[3].fileTime1 = 1192491972U;
  c1_info[3].fileTime2 = 0U;
  c1_info[4].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/mtimes.m";
  c1_info[4].name = "size";
  c1_info[4].dominantType = "double";
  c1_info[4].resolved = "[B]size";
  ...
  c1_info[6].fileLength = 866U;
  c1_info[6].fileTime1 = 1192491844U;
  c1_info[6].fileTime2 = 0U;
  c1_info[7].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/mtimes.m";
  c1_info[7].name = "isinteger";
  c1_info[7].dominantType = "double";
  c1_info[7].resolved = "[B]isinteger";
  ...
  c1_info[9].fileLength = 502U;
  c1_info[9].fileTime1 = 1208205258U;
  c1_info[9].fileTime2 = 0U;
  c1_info[10].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/power.m";
  c1_info[10].name = "eml_scalexp_size";
  c1_info[10].dominantType = "double";
  c1_info[10].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_scalexp_size.m";
  c1_info[10].fileLength = 1373U;
  c1_info[10].fileTime1 = 1208205260U;
  ...
  c1_info[12].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/isnan.m";
  c1_info[12].fileLength = 472U;
  c1_info[12].fileTime1 = 1192491936U;
  c1_info[12].fileTime2 = 0U;
  c1_info[13].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/mtimes.m";
  c1_info[13].name = "isa";
  c1_info[13].dominantType = "double";
  c1_info[13].resolved = "[B]isa";
  c1_info[13].fileLength = 0U;
  c1_info[13].fileTime1 = 0U;
  c1_info[13].fileTime2 = 0U;
  c1_info[14].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/mpower.m";
  c1_info[14].name = "power";
  c1_info[14].dominantType = "double";
  c1_info[14].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/power.m";
  c1_info[14].fileLength = 5131U;
  c1_info[14].fileTime1 = 1213662890U;
  c1_info[14].fileTime2 = 0U;
  c1_info[15].context = "";
  c1_info[15].name = "mrdivide";
  c1_info[15].dominantType = "double";
  c1_info[15].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/mrdivide.m";
  c1_info[15].fileLength = 755U;
  c1_info[15].fileTime1 = 1209356082U;
  c1_info[15].fileTime2 = 0U;
  c1_info[16].context =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_assert_valid_size_arg.m/numel_for_size";
  c1_info[16].name = "double";
  c1_info[16].dominantType = "double";
  c1_info[16].resolved = "[B]double";
  ...
  c1_info[18].name = "isvector";
  c1_info[18].dominantType = "double";
  c1_info[18].resolved = "[B]isvector";
  ...
  c1_info[19].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/isfinite.m";
  c1_info[19].fileLength = 341U;
  c1_info[19].fileTime1 = 1192491934U;
  c1_info[19].fileTime2 = 0U;
  c1_info[20].context =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_assert_valid_size_arg.m";
  c1_info[20].name = "isnumeric";
  c1_info[20].dominantType = "double";
  c1_info[20].resolved = "[B]isnumeric";
  c1_info[20].fileLength = 0U;
  c1_info[20].fileTime1 = 0U;
  c1_info[20].fileTime2 = 0U;
  c1_info[21].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/mpower.m";
  ...
  c1_info[22].name = "isempty";
  c1_info[22].dominantType = "double";
  c1_info[22].resolved = "[B]isempty";
  c1_info[22].fileLength = 0U;
  c1_info[22].fileTime1 = 0U;
  c1_info[22].fileTime2 = 0U;
  c1_info[23].context =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_assert_valid_size_arg.m/isintegral";
  c1_info[23].name = "true";
  c1_info[23].dominantType = "";
  c1_info[23].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/true.m";
  c1_info[23].fileLength = 237U;
  c1_info[23].fileTime1 = 1192491962U;
  ...
  c1_info[32].resolved = "[B]le";
  c1_info[32].fileLength = 0U;
  c1_info[32].fileTime1 = 0U;
  c1_info[32].fileTime2 = 0U;
  c1_info[33].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/mpower.m";
  c1_info[33].name = "assert";
  c1_info[33].dominantType = "char";
  c1_info[33].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/lang/assert.m";
  c1_info[33].fileLength = 2684U;
  c1_info[33].fileTime1 = 1210895856U;
  ...
  c1_info[34].fileLength = 262U;
  c1_info[34].fileTime1 = 1213662888U;
  c1_info[34].fileTime2 = 0U;
  c1_info[35].context = "";
  c1_info[35].name = "mpower";
  c1_info[35].dominantType = "double";
  c1_info[35].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/mpower.m";
  c1_info[35].fileLength = 3547U;
  c1_info[35].fileTime1 = 1213662888U;
  c1_info[35].fileTime2 = 0U;
  c1_info[36].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/intmax.m";
  c1_info[36].name = "ischar";
  c1_info[36].dominantType = "char";
  c1_info[36].resolved = "[B]ischar";
  c1_info[36].fileLength = 0U;
  c1_info[36].fileTime1 = 0U;
  c1_info[36].fileTime2 = 0U;
  c1_info[37].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_alloc.m";
  c1_info[37].name = "zeros";
  c1_info[37].dominantType = "double";
  c1_info[37].resolved = "[B]zeros";
  ...
  c1_info[38].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/intmax.m";
  c1_info[38].fileLength = 1535U;
  c1_info[38].fileTime1 = 1192491928U;
  c1_info[38].fileTime2 = 0U;
  c1_info[39].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/mtimes.m";
  c1_info[39].name = "not";
  c1_info[39].dominantType = "logical";
  c1_info[39].resolved = "[B]not";
  c1_info[39].fileLength = 0U;
  c1_info[39].fileTime1 = 0U;
  c1_info[39].fileTime2 = 0U;
  c1_info[40].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_alloc.m";
  c1_info[40].name = "isstruct";
  c1_info[40].dominantType = "double";
  c1_info[40].resolved = "[B]isstruct";
  ...
  c1_info[46].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/mrdivide.m";
  c1_info[46].name = "rdivide";
  c1_info[46].dominantType = "double";
  c1_info[46].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/rdivide.m";
  c1_info[46].fileLength = 620U;
  c1_info[46].fileTime1 = 1213662890U;
  c1_info[46].fileTime2 = 0U;
  c1_info[47].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/intmax.m";
  c1_info[47].name = "int32";
  c1_info[47].dominantType = "double";
  c1_info[47].resolved = "[B]int32";
  c1_info[47].fileLength = 0U;
  c1_info[47].fileTime1 = 0U;
  c1_info[47].fileTime2 = 0U;
  c1_info[48].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/lang/assert.m";
  c1_info[48].name = "islogical";
  c1_info[48].dominantType = "logical";
  ...
  c1_info[49].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/mtimes.m";
  c1_info[49].fileLength = 2336U;
  c1_info[49].fileTime1 = 1213662890U;
  c1_info[49].fileTime2 = 0U;
  c1_info[50].context =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/isfinite.m";
  c1_info[50].name = "and";
  c1_info[50].dominantType = "logical";
  c1_info[50].resolved = "[B]and";
  c1_info[50].fileLength = 0U;
  c1_info[50].fileTime1 = 0U;
  c1_info[50].fileTime2 = 0U;
  c1_info[51].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_alloc.m";
  c1_info[51].name = "eml_assert_valid_size_arg";
  c1_info[51].dominantType = "double";
  c1_info[51].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_assert_valid_size_arg.m";
  c1_info[51].fileLength = 2835U;
  c1_info[51].fileTime1 = 1210895844U;
...
/* SFunction Glue Code */
void sf_c1_aeroutilslib_get_check_sum(mxArray *plhs[])
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(3903114045U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(454820288U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(1497557878U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(1490456095U);
}

mxArray *sf_c1_aeroutilslib_get_autoinheritance_info(void)
{
...
{
  SFc1_aeroutilslibInstanceStruct *chartInstance;
  chartInstance = (SFc1_aeroutilslibInstanceStruct *) ((ChartInfoStruct *)
...
static void sf_opaque_initialize_c1_aeroutilslib(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc1_aeroutilslibInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c1_aeroutilslib((SFc1_aeroutilslibInstanceStruct*)
    chartInstanceVar);
  initialize_c1_aeroutilslib((SFc1_aeroutilslibInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c1_aeroutilslib(void *chartInstanceVar)
{
  enable_c1_aeroutilslib((SFc1_aeroutilslibInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c1_aeroutilslib(void *chartInstanceVar)
{
  disable_c1_aeroutilslib((SFc1_aeroutilslibInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c1_aeroutilslib(void *chartInstanceVar)
{
  sf_c1_aeroutilslib((SFc1_aeroutilslibInstanceStruct*) chartInstanceVar);
}

static mxArray* sf_opaque_get_sim_state_c1_aeroutilslib(void *chartInstanceVar)
{
  mxArray *st = (mxArray *) get_sim_state_c1_aeroutilslib
    ((SFc1_aeroutilslibInstanceStruct*) chartInstanceVar);
  return st;
}

static void sf_opaque_set_sim_state_c1_aeroutilslib(void *chartInstanceVar,
  const mxArray *st)
{
  set_sim_state_c1_aeroutilslib((SFc1_aeroutilslibInstanceStruct*)
    chartInstanceVar, sf_mex_dup(st));
}

static void sf_opaque_terminate_c1_aeroutilslib(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc1_aeroutilslibInstanceStruct*) chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
    }

    finalize_c1_aeroutilslib((SFc1_aeroutilslibInstanceStruct*) chartInstanceVar);
...
static void mdlProcessParameters_c1_aeroutilslib(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c1_aeroutilslib(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    int_T chartIsInlinable =
      (int_T)sf_is_chart_inlinable("aeroutilslib","gtm_design_dbg",1);
    ssSetStateflowIsInlinable(S,chartIsInlinable);
    ssSetRTWCG(S,sf_rtw_info_uint_prop("aeroutilslib","gtm_design_dbg",1,"RTWCG"));
    ...
    if (chartIsInlinable) {
      ...
      sf_mark_chart_expressionable_inputs(S,"aeroutilslib","gtm_design_dbg",1,6);
      sf_mark_chart_reusable_outputs(S,"aeroutilslib","gtm_design_dbg",1,2);
    }

    sf_set_rtw_dwork_info(S,"aeroutilslib","gtm_design_dbg",1);
    ssSetHasSubFunctions(S,!(chartIsInlinable));
    ssSetOptions(S,ssGetOptions(S)|SS_OPTION_WORKS_WITH_CODE_REUSE);
  }

  ssSetChecksum0(S,(2175429503U));
  ssSetChecksum1(S,(445952158U));
  ssSetChecksum2(S,(2824078345U));
  ssSetChecksum3(S,(3595425035U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
}

static void mdlRTW_c1_aeroutilslib(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
    sf_write_symbol_mapping(S, "aeroutilslib", "gtm_design_dbg",1);
    ssWriteRTWStrParam(S, "StateflowChartType", "Embedded MATLAB");
  }
}

static void mdlStart_c1_aeroutilslib(SimStruct *S)
{
  SFc1_aeroutilslibInstanceStruct *chartInstance;
  chartInstance = (SFc1_aeroutilslibInstanceStruct *)malloc(sizeof
    (SFc1_aeroutilslibInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c1_aeroutilslib;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c1_aeroutilslib;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c1_aeroutilslib;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c1_aeroutilslib;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c1_aeroutilslib;
  chartInstance->chartInfo.getSimState = sf_opaque_get_sim_state_c1_aeroutilslib;
  chartInstance->chartInfo.setSimState = sf_opaque_set_sim_state_c1_aeroutilslib;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c1_aeroutilslib;
  chartInstance->chartInfo.mdlStart = mdlStart_c1_aeroutilslib;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c1_aeroutilslib;
...
void c1_aeroutilslib_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c1_aeroutilslib(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c1_aeroutilslib(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c1_aeroutilslib(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c1_aeroutilslib_method_dispatcher.\n"
