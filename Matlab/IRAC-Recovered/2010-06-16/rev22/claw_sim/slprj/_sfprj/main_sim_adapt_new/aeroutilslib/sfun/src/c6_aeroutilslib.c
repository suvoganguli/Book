...
const mxArray *sf_c6_aeroutilslib_get_eml_resolved_functions_info(void)
{
  ...
  (*c6_b_info)[64].fileTime1 = 1203469560U;
  (*c6_b_info)[64].fileTime2 = 0U;
  (*c6_b_info)[65].context =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/mtimes.m";
  (*c6_b_info)[65].name = "strcmp";
  (*c6_b_info)[65].dominantType = "char";
  (*c6_b_info)[65].resolved = "[B]strcmp";
  ...
  (*c6_b_info)[66].name = "ne";
  (*c6_b_info)[66].dominantType = "double";
  (*c6_b_info)[66].resolved = "[B]ne";
...
static void c6_info_helper(c6_ResolvedFunctionInfo c6_info[67])
{
  c6_info[0].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/power.m";
  c6_info[0].name = "eml_error";
  c6_info[0].dominantType = "char";
  c6_info[0].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_error.m";
  c6_info[0].fileLength = 315U;
  c6_info[0].fileTime1 = 1213662886U;
  ...
  c6_info[2].context = "";
  c6_info[2].name = "colon";
  c6_info[2].dominantType = "double";
  c6_info[2].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/colon.m";
  c6_info[2].fileLength = 7324U;
  c6_info[2].fileTime1 = 1197322346U;
  ...
  c6_info[4].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/mpower.m";
  c6_info[4].name = "assert";
  c6_info[4].dominantType = "char";
  c6_info[4].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/lang/assert.m";
  c6_info[4].fileLength = 2684U;
  c6_info[4].fileTime1 = 1210895856U;
  c6_info[4].fileTime2 = 0U;
  c6_info[5].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/eps.m";
  c6_info[5].name = "eml_guarded_nan";
  c6_info[5].dominantType = "";
  c6_info[5].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_guarded_nan.m";
  c6_info[5].fileLength = 485U;
  c6_info[5].fileTime1 = 1192491980U;
  c6_info[5].fileTime2 = 0U;
  c6_info[6].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/all.m";
  c6_info[6].name = "eml_all_or_any";
  c6_info[6].dominantType = "char";
  c6_info[6].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_all_or_any.m";
  c6_info[6].fileLength = 3423U;
  c6_info[6].fileTime1 = 1213662886U;
  c6_info[6].fileTime2 = 0U;
  c6_info[7].context =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/colon.m/is_flint_colon";
  c6_info[7].name = "isfinite";
  c6_info[7].dominantType = "double";
  c6_info[7].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/isfinite.m";
  c6_info[7].fileLength = 341U;
  c6_info[7].fileTime1 = 1192491934U;
  ...
  c6_info[9].name = "realmax";
  c6_info[9].dominantType = "char";
  c6_info[9].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/realmax.m";
  c6_info[9].fileLength = 498U;
  c6_info[9].fileTime1 = 1192491950U;
  c6_info[9].fileTime2 = 0U;
  c6_info[10].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/colon.m";
  c6_info[10].name = "ge";
  c6_info[10].dominantType = "double";
  c6_info[10].resolved = "[B]ge";
  ...
  c6_info[11].resolved = "[B]gt";
  c6_info[11].fileLength = 0U;
  c6_info[11].fileTime1 = 0U;
  c6_info[11].fileTime2 = 0U;
  c6_info[12].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/length.m";
  c6_info[12].name = "nargin";
  c6_info[12].dominantType = "";
  c6_info[12].resolved = "[B]nargin";
  ...
  c6_info[14].name = "islogical";
  c6_info[14].dominantType = "double";
  c6_info[14].resolved = "[B]islogical";
  c6_info[14].fileLength = 0U;
  c6_info[14].fileTime1 = 0U;
  c6_info[14].fileTime2 = 0U;
  c6_info[15].context =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/isfinite.m";
  c6_info[15].name = "isinf";
  c6_info[15].dominantType = "double";
  c6_info[15].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/isinf.m";
  c6_info[15].fileLength = 472U;
  c6_info[15].fileTime1 = 1192491934U;
  c6_info[15].fileTime2 = 0U;
  c6_info[16].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/colon.m";
  c6_info[16].name = "isa";
  c6_info[16].dominantType = "double";
  c6_info[16].resolved = "[B]isa";
  ...
  c6_info[17].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/intmax.m";
  c6_info[17].fileLength = 1535U;
  c6_info[17].fileTime1 = 1192491928U;
  c6_info[17].fileTime2 = 0U;
  c6_info[18].context =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_assert_valid_size_arg.m";
  c6_info[18].name = "isvector";
  c6_info[18].dominantType = "double";
  c6_info[18].resolved = "[B]isvector";
  c6_info[18].fileLength = 0U;
  c6_info[18].fileTime1 = 0U;
  c6_info[18].fileTime2 = 0U;
  c6_info[19].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/elfun/abs.m";
  c6_info[19].name = "class";
  c6_info[19].dominantType = "double";
  c6_info[19].resolved = "[B]class";
  ...
  c6_info[20].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/true.m";
  c6_info[20].fileLength = 237U;
  c6_info[20].fileTime1 = 1192491962U;
  c6_info[20].fileTime2 = 0U;
  c6_info[21].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/colon.m";
  c6_info[21].name = "isinteger";
  c6_info[21].dominantType = "double";
  c6_info[21].resolved = "[B]isinteger";
  ...
  c6_info[29].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/nan.m";
  c6_info[29].fileLength = 474U;
  c6_info[29].fileTime1 = 1192491944U;
  c6_info[29].fileTime2 = 0U;
  c6_info[30].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/length.m";
  c6_info[30].name = "size";
  c6_info[30].dominantType = "double";
  c6_info[30].resolved = "[B]size";
  c6_info[30].fileLength = 0U;
  c6_info[30].fileTime1 = 0U;
  c6_info[30].fileTime2 = 0U;
  c6_info[31].context =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_assert_valid_size_arg.m/numel_for_size";
  c6_info[31].name = "double";
  c6_info[31].dominantType = "double";
  c6_info[31].resolved = "[B]double";
  ...
  c6_info[33].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/elfun/floor.m";
  c6_info[33].fileLength = 332U;
  c6_info[33].fileTime1 = 1203469624U;
  c6_info[33].fileTime2 = 0U;
  c6_info[34].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/eps.m";
  c6_info[34].name = "realmin";
  c6_info[34].dominantType = "";
  c6_info[34].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/realmin.m";
  c6_info[34].fileLength = 475U;
  c6_info[34].fileTime1 = 1192491952U;
  ...
  c6_info[35].fileTime1 = 1203469528U;
  c6_info[35].fileTime2 = 0U;
  c6_info[36].context =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_assert_valid_size_arg.m";
  c6_info[36].name = "isnumeric";
  c6_info[36].dominantType = "double";
  c6_info[36].resolved = "[B]isnumeric";
  ...
  c6_info[37].name = "all";
  c6_info[37].dominantType = "logical";
  c6_info[37].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/all.m";
  c6_info[37].fileLength = 400U;
  c6_info[37].fileTime1 = 1192492104U;
  c6_info[37].fileTime2 = 0U;
  c6_info[38].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/colon.m";
  c6_info[38].name = "isscalar";
  c6_info[38].dominantType = "double";
  c6_info[38].resolved = "[B]isscalar";
  c6_info[38].fileLength = 0U;
  c6_info[38].fileTime1 = 0U;
  c6_info[38].fileTime2 = 0U;
  c6_info[39].context = "";
  c6_info[39].name = "uminus";
  c6_info[39].dominantType = "double";
  c6_info[39].resolved = "[B]uminus";
  ...
  c6_info[43].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/elfun/abs.m";
  c6_info[43].name = "zeros";
  c6_info[43].dominantType = "double";
  c6_info[43].resolved = "[B]zeros";
  c6_info[43].fileLength = 0U;
  c6_info[43].fileTime1 = 0U;
  c6_info[43].fileTime2 = 0U;
  c6_info[44].context =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_all_or_any.m";
  c6_info[44].name = "isempty";
  c6_info[44].dominantType = "logical";
  c6_info[44].resolved = "[B]isempty";
  c6_info[44].fileLength = 0U;
  c6_info[44].fileTime1 = 0U;
  c6_info[44].fileTime2 = 0U;
  c6_info[45].context =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/isfinite.m";
  c6_info[45].name = "isnan";
  c6_info[45].dominantType = "double";
  c6_info[45].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/isnan.m";
  c6_info[45].fileLength = 472U;
  c6_info[45].fileTime1 = 1192491936U;
  ...
  c6_info[47].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/isequal.m";
  c6_info[47].name = "eml_isequal_core";
  c6_info[47].dominantType = "double";
  c6_info[47].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_isequal_core.m";
  c6_info[47].fileLength = 3543U;
  c6_info[47].fileTime1 = 1213662886U;
  c6_info[47].fileTime2 = 0U;
  c6_info[48].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/mpower.m";
  c6_info[48].name = "power";
  c6_info[48].dominantType = "double";
  c6_info[48].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/power.m";
  c6_info[48].fileLength = 5131U;
  c6_info[48].fileTime1 = 1213662890U;
  c6_info[48].fileTime2 = 0U;
  c6_info[49].context =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/isfinite.m";
  c6_info[49].name = "not";
  c6_info[49].dominantType = "logical";
  c6_info[49].resolved = "[B]not";
  c6_info[49].fileLength = 0U;
  c6_info[49].fileTime1 = 0U;
  c6_info[49].fileTime2 = 0U;
  c6_info[50].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/mpower.m";
  c6_info[50].name = "ndims";
  c6_info[50].dominantType = "double";
  c6_info[50].resolved = "[B]ndims";
  ...
  c6_info[51].fileLength = 909U;
  c6_info[51].fileTime1 = 1192491982U;
  ...
  c6_info[53].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_alloc.m";
  c6_info[53].name = "eml_assert_valid_size_arg";
  c6_info[53].dominantType = "double";
  c6_info[53].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_assert_valid_size_arg.m";
  c6_info[53].fileLength = 2835U;
  c6_info[53].fileTime1 = 1210895844U;
  ...
  c6_info[55].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/datafun/sum.m";
  c6_info[55].fileLength = 2854U;
  ...
  c6_info[56].resolved = "[B]lt";
  c6_info[56].fileLength = 0U;
  c6_info[56].fileTime1 = 0U;
  c6_info[56].fileTime2 = 0U;
  c6_info[57].context =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_assert_valid_size_arg.m/numel_for_size";
  c6_info[57].name = "mtimes";
  c6_info[57].dominantType = "double";
  c6_info[57].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/mtimes.m";
  c6_info[57].fileLength = 2336U;
  c6_info[57].fileTime1 = 1213662890U;
  c6_info[57].fileTime2 = 0U;
  c6_info[58].context =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_all_or_any.m";
  c6_info[58].name = "eml_nonsingleton_dim";
  c6_info[58].dominantType = "logical";
  c6_info[58].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_nonsingleton_dim.m";
  c6_info[58].fileLength = 404U;
  c6_info[58].fileTime1 = 1192492000U;
  c6_info[58].fileTime2 = 0U;
  c6_info[59].context =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/colon.m/is_flint_colon";
  c6_info[59].name = "eps";
  c6_info[59].dominantType = "double";
  c6_info[59].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/eps.m";
  c6_info[59].fileLength = 1342U;
  ...
  c6_info[61].name = "ischar";
  c6_info[61].dominantType = "double";
  c6_info[61].resolved = "[B]ischar";
  c6_info[61].fileLength = 0U;
  c6_info[61].fileTime1 = 0U;
  c6_info[61].fileTime2 = 0U;
  c6_info[62].context =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_assert_valid_size_arg.m/isintegral";
  c6_info[62].name = "false";
  c6_info[62].dominantType = "";
  c6_info[62].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/false.m";
  c6_info[62].fileLength = 238U;
  c6_info[62].fileTime1 = 1192491920U;
...
static void mdlSetWorkWidths_c6_aeroutilslib(SimStruct *S)
{
  ...
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    int_T chartIsInlinable =
      (int_T)sf_is_chart_inlinable("aeroutilslib","main_sim_adapt_new",6);
    ssSetStateflowIsInlinable(S,chartIsInlinable);
    ssSetRTWCG(S,sf_rtw_info_uint_prop("aeroutilslib","main_sim_adapt_new",6,
                "RTWCG"));
    ssSetEnableFcnIsTrivial(S,1);
    ssSetDisableFcnIsTrivial(S,1);
    ssSetNotMultipleInlinable(S,sf_rtw_info_uint_prop("aeroutilslib",
      "main_sim_adapt_new",6,"gatewayCannotBeInlinedMultipleTimes"));
    if (chartIsInlinable) {
      ssSetInputPortOptimOpts(S, 0, SS_REUSABLE_AND_LOCAL);
      sf_mark_chart_expressionable_inputs(S,"aeroutilslib","main_sim_adapt_new",
        6,1);
      sf_mark_chart_reusable_outputs(S,"aeroutilslib","main_sim_adapt_new",6,1);
    }

    sf_set_rtw_dwork_info(S,"aeroutilslib","main_sim_adapt_new",6);
...
{
  if (sim_mode_is_rtw_gen(S)) {
    sf_write_symbol_mapping(S, "aeroutilslib", "main_sim_adapt_new",6);
