...
static void c1_info_helper(c1_ResolvedFunctionInfo c1_info[59])
{
  c1_info[0].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_alloc.m";
  c1_info[0].name = "isstruct";
  c1_info[0].dominantType = "double";
  c1_info[0].resolved = "[B]isstruct";
  ...
  c1_info[2].fileLength = 272U;
  c1_info[2].fileTime1 = 1192491986U;
  ...
  c1_info[4].name = "isnumeric";
  c1_info[4].dominantType = "double";
  c1_info[4].resolved = "[B]isnumeric";
  ...
  c1_info[9].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/mtimes.m";
  ...
  c1_info[13].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/blas/refblas/eml_refblas_xgemm.m";
  c1_info[13].fileLength = 5746U;
  c1_info[13].fileTime1 = 1210895858U;
  ...
  c1_info[16].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/mtimes.m";
  c1_info[16].fileLength = 2336U;
  c1_info[16].fileTime1 = 1213662890U;
  c1_info[16].fileTime2 = 0U;
  c1_info[17].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/mtimes.m";
  c1_info[17].name = "ndims";
  c1_info[17].dominantType = "double";
  c1_info[17].resolved = "[B]ndims";
  c1_info[17].fileLength = 0U;
  c1_info[17].fileTime1 = 0U;
  c1_info[17].fileTime2 = 0U;
  c1_info[18].context =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_assert_valid_size_arg.m/isintegral";
  c1_info[18].name = "true";
  c1_info[18].dominantType = "";
  c1_info[18].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/true.m";
  c1_info[18].fileLength = 237U;
  c1_info[18].fileTime1 = 1192491962U;
  c1_info[18].fileTime2 = 0U;
  c1_info[19].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/elfun/round.m";
  c1_info[19].name = "eml_scalar_round";
  c1_info[19].dominantType = "double";
  c1_info[19].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/elfun/eml_scalar_round.m";
  c1_info[19].fileLength = 523U;
  c1_info[19].fileTime1 = 1203473208U;
  c1_info[19].fileTime2 = 0U;
  c1_info[20].context = "";
  c1_info[20].name = "round";
  c1_info[20].dominantType = "double";
  c1_info[20].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/elfun/round.m";
  c1_info[20].fileLength = 331U;
  c1_info[20].fileTime1 = 1203473238U;
  ...
  c1_info[26].context =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/reshape.m/varargin_to_size";
  c1_info[26].name = "eml_assert_valid_size_arg";
  c1_info[26].dominantType = "double";
  c1_info[26].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_assert_valid_size_arg.m";
  c1_info[26].fileLength = 2835U;
  c1_info[26].fileTime1 = 1210895844U;
  c1_info[26].fileTime2 = 0U;
  c1_info[27].context = "";
  c1_info[27].name = "reshape";
  c1_info[27].dominantType = "double";
  c1_info[27].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/reshape.m";
  c1_info[27].fileLength = 2221U;
  c1_info[27].fileTime1 = 1209356014U;
  ...
  c1_info[32].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/reshape.m";
  ...
  c1_info[33].context = "";
  c1_info[33].name = "ctranspose";
  c1_info[33].dominantType = "double";
  c1_info[33].resolved = "[B]ctranspose";
  ...
  c1_info[35].context =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/elfun/eml_scalar_round.m";
  c1_info[35].name = "isfloat";
  c1_info[35].dominantType = "double";
  c1_info[35].resolved = "[B]isfloat";
  ...
  c1_info[37].name = "eml_zeros";
  c1_info[37].dominantType = "double";
  c1_info[37].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_zeros.m";
  c1_info[37].fileLength = 1083U;
  c1_info[37].fileTime1 = 1213662888U;
  ...
  c1_info[41].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/false.m";
  c1_info[41].name = "logical";
  c1_info[41].dominantType = "double";
  c1_info[41].resolved = "[B]logical";
  c1_info[41].fileLength = 0U;
  c1_info[41].fileTime1 = 0U;
  c1_info[41].fileTime2 = 0U;
  c1_info[42].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/lang/assert.m";
  ...
  c1_info[44].context =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_assert_valid_size_arg.m/isintegral";
  c1_info[44].name = "isinteger";
  c1_info[44].dominantType = "double";
  c1_info[44].resolved = "[B]isinteger";
  c1_info[44].fileLength = 0U;
  c1_info[44].fileTime1 = 0U;
  c1_info[44].fileTime2 = 0U;
  c1_info[45].context =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/isfinite.m";
  c1_info[45].name = "isnan";
  c1_info[45].dominantType = "double";
  c1_info[45].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/isnan.m";
  c1_info[45].fileLength = 472U;
  c1_info[45].fileTime1 = 1192491936U;
  c1_info[45].fileTime2 = 0U;
  c1_info[46].context =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_assert_valid_size_arg.m/isintegral";
  c1_info[46].name = "false";
  c1_info[46].dominantType = "";
  c1_info[46].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/false.m";
  c1_info[46].fileLength = 238U;
  c1_info[46].fileTime1 = 1192491920U;
  c1_info[46].fileTime2 = 0U;
  c1_info[47].context =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/reshape.m/varargin_to_size";
  c1_info[47].name = "eml_index_prod";
  c1_info[47].dominantType = "int32";
  c1_info[47].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_index_prod.m";
  c1_info[47].fileLength = 547U;
  c1_info[47].fileTime1 = 1210895846U;
  ...
  c1_info[49].context =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/elfun/eml_scalar_round.m/scalar_round";
  c1_info[49].name = "minus";
  c1_info[49].dominantType = "double";
  c1_info[49].resolved = "[B]minus";
  ...
  c1_info[51].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/elfun/round.m";
  c1_info[51].name = "gt";
  c1_info[51].dominantType = "double";
  c1_info[51].resolved = "[B]gt";
  ...
  c1_info[53].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/lang/assert.m";
  c1_info[53].name = "isscalar";
  c1_info[53].dominantType = "logical";
  c1_info[53].resolved = "[B]isscalar";
  ...
  c1_info[54].name = "eml_xgemm";
  c1_info[54].dominantType = "int32";
  c1_info[54].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/blas/eml_xgemm.m";
  c1_info[54].fileLength = 3184U;
  c1_info[54].fileTime1 = 1209356052U;
  c1_info[54].fileTime2 = 0U;
  c1_info[55].context =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_assert_valid_size_arg.m/isintegral";
  c1_info[55].name = "ne";
  c1_info[55].dominantType = "double";
  c1_info[55].resolved = "[B]ne";
  ...
  c1_info[56].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/intmax.m";
  c1_info[56].fileLength = 1535U;
  c1_info[56].fileTime1 = 1192491928U;
  c1_info[56].fileTime2 = 0U;
  c1_info[57].context = "";
  c1_info[57].name = "transpose";
  c1_info[57].dominantType = "double";
  c1_info[57].resolved = "[B]transpose";
...
static void mdlSetWorkWidths_c1_GTM_aerolib(SimStruct *S)
{
  ...
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    int_T chartIsInlinable =
      (int_T)sf_is_chart_inlinable("GTM_aerolib","main_sim_noadapt",1);
    ssSetStateflowIsInlinable(S,chartIsInlinable);
    ssSetRTWCG(S,sf_rtw_info_uint_prop("GTM_aerolib","main_sim_noadapt",1,
                "RTWCG"));
    ...
    if (chartIsInlinable) {
      ...
      sf_mark_chart_expressionable_inputs(S,"GTM_aerolib","main_sim_noadapt",1,2);
      sf_mark_chart_reusable_outputs(S,"GTM_aerolib","main_sim_noadapt",1,1);
    }

    sf_set_rtw_dwork_info(S,"GTM_aerolib","main_sim_noadapt",1);
...
{
  if (sim_mode_is_rtw_gen(S)) {
    sf_write_symbol_mapping(S, "GTM_aerolib", "main_sim_noadapt",1);
