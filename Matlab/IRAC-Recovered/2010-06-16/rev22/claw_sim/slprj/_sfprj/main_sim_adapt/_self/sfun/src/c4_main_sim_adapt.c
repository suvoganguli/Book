...
#include "main_sim_adapt_sfun.h"
#include "c4_main_sim_adapt.h"
#include "mwmathutil.h"
#define CHARTINSTANCE_CHARTNUMBER      (chartInstance.chartNumber)
#define CHARTINSTANCE_INSTANCENUMBER   (chartInstance.instanceNumber)
#include "main_sim_adapt_sfun_debug_macros.h"
...
static SFc4_main_sim_adaptInstanceStruct chartInstance;

/* Function Declarations */
static void initialize_c4_main_sim_adapt(void);
static void initialize_params_c4_main_sim_adapt(void);
static void enable_c4_main_sim_adapt(void);
static void disable_c4_main_sim_adapt(void);
static void update_debugger_state_c4_main_sim_adapt(void);
static const mxArray *get_sim_state_c4_main_sim_adapt(void);
static void set_sim_state_c4_main_sim_adapt(const mxArray *c4_st);
static void finalize_c4_main_sim_adapt(void);
static void sf_c4_main_sim_adapt(void);
static void c4_c4_main_sim_adapt(void);
...
static void initialize_c4_main_sim_adapt(void)
{
  ...
  chartInstance.c4_is_active_c4_main_sim_adapt = 0U;
}
...
static void sf_c4_main_sim_adapt(void)
{
  ...
  c4_c4_main_sim_adapt();
  _sfEvent_ = c4_previousEvent;
  sf_debug_check_for_state_inconsistency(_main_sim_adaptMachineNumber_,
...
const mxArray *sf_c4_main_sim_adapt_get_eml_resolved_functions_info(void)
{
...
static void c4_info_helper(c4_ResolvedFunctionInfo c4_info[88])
{
  ...
  c4_info[0].name = "nargin";
  c4_info[0].dominantType = "";
  c4_info[0].resolved = "[B]nargin";
  ...
  c4_info[1].name = "eml_refblas_xdot";
  c4_info[1].dominantType = "int32";
  c4_info[1].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/blas/refblas/eml_refblas_xdot.m";
  c4_info[1].fileLength = 343U;
  ...
  c4_info[2].name = "all";
  c4_info[2].dominantType = "logical";
  c4_info[2].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/all.m";
  c4_info[2].fileLength = 400U;
  c4_info[2].fileTime1 = 1192492104U;
  c4_info[2].fileTime2 = 0U;
  c4_info[3].context =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/blas/refblas/eml_refblas_xdot.m";
  c4_info[3].name = "eml_refblas_xdotx";
  c4_info[3].dominantType = "int32";
  c4_info[3].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/blas/refblas/eml_refblas_xdotx.m";
  c4_info[3].fileLength = 1786U;
  c4_info[3].fileTime1 = 1210895856U;
  ...
  c4_info[5].resolved = "[B]plus";
  c4_info[5].fileLength = 0U;
  c4_info[5].fileTime1 = 0U;
  c4_info[5].fileTime2 = 0U;
  c4_info[6].context = "";
  c4_info[6].name = "atan2";
  c4_info[6].dominantType = "double";
  c4_info[6].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/elfun/atan2.m";
  c4_info[6].fileLength = 674U;
  c4_info[6].fileTime1 = 1203473148U;
  ...
  c4_info[9].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/mtimes.m";
  c4_info[9].name = "eml_xgemm";
  c4_info[9].dominantType = "int32";
  c4_info[9].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/blas/eml_xgemm.m";
  c4_info[9].fileLength = 3184U;
  c4_info[9].fileTime1 = 1209356052U;
  ...
  c4_info[11].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/mtimes.m";
  c4_info[11].name = "eml_xdotu";
  c4_info[11].dominantType = "int32";
  c4_info[11].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/blas/eml_xdotu.m";
  c4_info[11].fileLength = 1453U;
  c4_info[11].fileTime1 = 1209356052U;
  ...
  c4_info[12].fileLength = 909U;
  c4_info[12].fileTime1 = 1192491982U;
  c4_info[12].fileTime2 = 0U;
  c4_info[13].context =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/blas/eml_xgemm.m";
  c4_info[13].name = "eml_blas_xgemm";
  c4_info[13].dominantType = "int32";
  c4_info[13].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/blas/internal/eml_blas_xgemm.m";
  c4_info[13].fileLength = 355U;
  c4_info[13].fileTime1 = 1192492054U;
  c4_info[13].fileTime2 = 0U;
  c4_info[14].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/rdivide.m";
  c4_info[14].name = "eml_div";
  c4_info[14].dominantType = "double";
  c4_info[14].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_div.m";
  c4_info[14].fileLength = 4254U;
  c4_info[14].fileTime1 = 1192491972U;
  c4_info[14].fileTime2 = 0U;
  c4_info[15].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/datafun/max.m";
  c4_info[15].name = "nargout";
  c4_info[15].dominantType = "";
  c4_info[15].resolved = "[B]nargout";
  c4_info[15].fileLength = 0U;
  c4_info[15].fileTime1 = 0U;
  c4_info[15].fileTime2 = 0U;
  c4_info[16].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/all.m";
  c4_info[16].name = "eml_all_or_any";
  c4_info[16].dominantType = "char";
  c4_info[16].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_all_or_any.m";
  c4_info[16].fileLength = 3423U;
  c4_info[16].fileTime1 = 1213662886U;
  ...
  c4_info[18].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/rdivide.m";
  c4_info[18].name = "eml_warning";
  c4_info[18].dominantType = "char";
  c4_info[18].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_warning.m";
  c4_info[18].fileLength = 262U;
  c4_info[18].fileTime1 = 1213662888U;
  c4_info[18].fileTime2 = 0U;
  c4_info[19].context = "";
  c4_info[19].name = "ctranspose";
  c4_info[19].dominantType = "double";
  c4_info[19].resolved = "[B]ctranspose";
  c4_info[19].fileLength = 0U;
  c4_info[19].fileTime1 = 0U;
  c4_info[19].fileTime2 = 0U;
  c4_info[20].context =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/blas/refblas/eml_refblas_xdotx.m";
  c4_info[20].name = "eml_index_times";
  c4_info[20].dominantType = "int32";
  c4_info[20].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_index_times.m";
  c4_info[20].fileLength = 280U;
  c4_info[20].fileTime1 = 1192491988U;
  c4_info[20].fileTime2 = 0U;
  c4_info[21].context = "";
  c4_info[21].name = "uminus";
  c4_info[21].dominantType = "double";
  c4_info[21].resolved = "[B]uminus";
  c4_info[21].fileLength = 0U;
  c4_info[21].fileTime1 = 0U;
  c4_info[21].fileTime2 = 0U;
  c4_info[22].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/mtimes.m";
  c4_info[22].name = "size";
  c4_info[22].dominantType = "double";
  c4_info[22].resolved = "[B]size";
  ...
  c4_info[23].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/elfun/abs.m";
  c4_info[23].fileLength = 538U;
  c4_info[23].fileTime1 = 1203473128U;
  c4_info[23].fileTime2 = 0U;
  c4_info[24].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/power.m";
  c4_info[24].name = "lt";
  ...
  c4_info[25].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/mtimes.m";
  c4_info[25].name = "strcmp";
  c4_info[25].dominantType = "char";
  c4_info[25].resolved = "[B]strcmp";
  c4_info[25].fileLength = 0U;
  c4_info[25].fileTime1 = 0U;
  c4_info[25].fileTime2 = 0U;
  c4_info[26].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/power.m";
  c4_info[26].name = "eml_error";
  c4_info[26].dominantType = "char";
  c4_info[26].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_error.m";
  c4_info[26].fileLength = 315U;
  c4_info[26].fileTime1 = 1213662886U;
  c4_info[26].fileTime2 = 0U;
  c4_info[27].context =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/blas/refblas/eml_refblas_xdotx.m";
  c4_info[27].name = "isequal";
  c4_info[27].dominantType = "char";
  c4_info[27].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/isequal.m";
  c4_info[27].fileLength = 157U;
  c4_info[27].fileTime1 = 1210895846U;
  c4_info[27].fileTime2 = 0U;
  c4_info[28].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/mtimes.m";
  c4_info[28].name = "eq";
  c4_info[28].dominantType = "double";
  c4_info[28].resolved = "[B]eq";
  ...
  c4_info[29].name = "isscalar";
  c4_info[29].dominantType = "double";
  c4_info[29].resolved = "[B]isscalar";
  ...
  c4_info[30].name = "eml_scalexp_size";
  c4_info[30].dominantType = "double";
  c4_info[30].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_scalexp_size.m";
  c4_info[30].fileLength = 1373U;
  c4_info[30].fileTime1 = 1208205260U;
  c4_info[30].fileTime2 = 0U;
  c4_info[31].context =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/blas/eml_xdot.m";
  c4_info[31].name = "eml_blas_xdot";
  c4_info[31].dominantType = "int32";
  c4_info[31].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/blas/internal/eml_blas_xdot.m";
  c4_info[31].fileLength = 238U;
  c4_info[31].fileTime1 = 1192492052U;
  c4_info[31].fileTime2 = 0U;
  c4_info[32].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/power.m";
  c4_info[32].name = "eml_scalar_floor";
  c4_info[32].dominantType = "double";
  c4_info[32].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/elfun/eml_scalar_floor.m";
  c4_info[32].fileLength = 260U;
  c4_info[32].fileTime1 = 1209355990U;
  c4_info[32].fileTime2 = 0U;
  c4_info[33].context =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/isfinite.m";
  c4_info[33].name = "isnan";
  c4_info[33].dominantType = "double";
  c4_info[33].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/isnan.m";
  c4_info[33].fileLength = 472U;
  c4_info[33].fileTime1 = 1192491936U;
  c4_info[33].fileTime2 = 0U;
  c4_info[34].context =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_assert_valid_size_arg.m/isintegral";
  c4_info[34].name = "ne";
  c4_info[34].dominantType = "double";
  c4_info[34].resolved = "[B]ne";
  ...
  c4_info[36].context =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/isfinite.m";
  c4_info[36].name = "and";
  c4_info[36].dominantType = "logical";
  c4_info[36].resolved = "[B]and";
  c4_info[36].fileLength = 0U;
  c4_info[36].fileTime1 = 0U;
  c4_info[36].fileTime2 = 0U;
  c4_info[37].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/mpower.m";
  c4_info[37].name = "ndims";
  c4_info[37].dominantType = "double";
  c4_info[37].resolved = "[B]ndims";
  c4_info[37].fileLength = 0U;
  c4_info[37].fileTime1 = 0U;
  c4_info[37].fileTime2 = 0U;
  c4_info[38].context =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_scalexp_size.m";
  c4_info[38].name = "eml_scalexp_compatible";
  c4_info[38].dominantType = "double";
  c4_info[38].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_scalexp_compatible.m";
  c4_info[38].fileLength = 502U;
  c4_info[38].fileTime1 = 1208205258U;
  ...
  c4_info[40].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/mpower.m";
  c4_info[40].name = "assert";
  c4_info[40].dominantType = "char";
  c4_info[40].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/lang/assert.m";
  c4_info[40].fileLength = 2684U;
  c4_info[40].fileTime1 = 1210895856U;
  c4_info[40].fileTime2 = 0U;
  c4_info[41].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/intmax.m";
  c4_info[41].name = "ischar";
  c4_info[41].dominantType = "char";
  c4_info[41].resolved = "[B]ischar";
  c4_info[41].fileLength = 0U;
  c4_info[41].fileTime1 = 0U;
  c4_info[41].fileTime2 = 0U;
  c4_info[42].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/intmax.m";
  c4_info[42].name = "int32";
  c4_info[42].dominantType = "double";
  c4_info[42].resolved = "[B]int32";
  c4_info[42].fileLength = 0U;
  c4_info[42].fileTime1 = 0U;
  c4_info[42].fileTime2 = 0U;
  c4_info[43].context =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/blas/internal/eml_blas_xgemm.m";
  c4_info[43].name = "eml_refblas_xgemm";
  c4_info[43].dominantType = "int32";
  c4_info[43].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/blas/refblas/eml_refblas_xgemm.m";
  c4_info[43].fileLength = 5746U;
  c4_info[43].fileTime1 = 1210895858U;
  c4_info[43].fileTime2 = 0U;
  c4_info[44].context =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_assert_valid_size_arg.m";
  c4_info[44].name = "isnumeric";
  c4_info[44].dominantType = "double";
  c4_info[44].resolved = "[B]isnumeric";
  ...
  c4_info[45].name = "real";
  c4_info[45].dominantType = "double";
  c4_info[45].resolved = "[B]real";
  ...
  c4_info[46].name = "ones";
  c4_info[46].dominantType = "char";
  c4_info[46].resolved = "[B]ones";
  c4_info[46].fileLength = 0U;
  c4_info[46].fileTime1 = 0U;
  c4_info[46].fileTime2 = 0U;
  c4_info[47].context =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_assert_valid_size_arg.m/isintegral";
  c4_info[47].name = "isfinite";
  c4_info[47].dominantType = "double";
  c4_info[47].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/isfinite.m";
  c4_info[47].fileLength = 341U;
  c4_info[47].fileTime1 = 1192491934U;
  c4_info[47].fileTime2 = 0U;
  c4_info[48].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/mpower.m";
  c4_info[48].name = "power";
  c4_info[48].dominantType = "double";
  c4_info[48].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/power.m";
  c4_info[48].fileLength = 5131U;
  c4_info[48].fileTime1 = 1213662890U;
  c4_info[48].fileTime2 = 0U;
  c4_info[49].context =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_all_or_any.m";
  c4_info[49].name = "eml_nonsingleton_dim";
  c4_info[49].dominantType = "logical";
  c4_info[49].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_nonsingleton_dim.m";
  c4_info[49].fileLength = 404U;
  c4_info[49].fileTime1 = 1192492000U;
  c4_info[49].fileTime2 = 0U;
  c4_info[50].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/power.m";
  c4_info[50].name = "eml_alloc";
  c4_info[50].dominantType = "double";
  c4_info[50].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_alloc.m";
  c4_info[50].fileLength = 2627U;
  c4_info[50].fileTime1 = 1213662886U;
  c4_info[50].fileTime2 = 0U;
  c4_info[51].context =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/isfinite.m";
  c4_info[51].name = "isinf";
  c4_info[51].dominantType = "double";
  c4_info[51].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/isinf.m";
  c4_info[51].fileLength = 472U;
  c4_info[51].fileTime1 = 1192491934U;
  c4_info[51].fileTime2 = 0U;
  c4_info[52].context =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_assert_valid_size_arg.m";
  c4_info[52].name = "isvector";
  c4_info[52].dominantType = "double";
  c4_info[52].resolved = "[B]isvector";
  c4_info[52].fileLength = 0U;
  c4_info[52].fileTime1 = 0U;
  c4_info[52].fileTime2 = 0U;
  c4_info[53].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/mtimes.m";
  c4_info[53].name = "isempty";
  c4_info[53].dominantType = "double";
  c4_info[53].resolved = "[B]isempty";
  c4_info[53].fileLength = 0U;
  c4_info[53].fileTime1 = 0U;
  c4_info[53].fileTime2 = 0U;
  c4_info[54].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_alloc.m";
  c4_info[54].name = "isstruct";
  c4_info[54].dominantType = "double";
  c4_info[54].resolved = "[B]isstruct";
  c4_info[54].fileLength = 0U;
  c4_info[54].fileTime1 = 0U;
  c4_info[54].fileTime2 = 0U;
  c4_info[55].context = "";
  c4_info[55].name = "mldivide";
  c4_info[55].dominantType = "double";
  c4_info[55].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/mldivide.m";
  c4_info[55].fileLength = 937U;
  c4_info[55].fileTime1 = 1210895856U;
  c4_info[55].fileTime2 = 0U;
  c4_info[56].context = "";
  c4_info[56].name = "min";
  c4_info[56].dominantType = "double";
  c4_info[56].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/datafun/min.m";
  c4_info[56].fileLength = 308U;
  c4_info[56].fileTime1 = 1192491834U;
  c4_info[56].fileTime2 = 0U;
  c4_info[57].context = "";
  c4_info[57].name = "mtimes";
  c4_info[57].dominantType = "double";
  c4_info[57].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/mtimes.m";
  c4_info[57].fileLength = 2336U;
  c4_info[57].fileTime1 = 1213662890U;
  c4_info[57].fileTime2 = 0U;
  c4_info[58].context = "";
  c4_info[58].name = "not";
  c4_info[58].dominantType = "double";
  c4_info[58].resolved = "[B]not";
  c4_info[58].fileLength = 0U;
  c4_info[58].fileTime1 = 0U;
  c4_info[58].fileTime2 = 0U;
  c4_info[59].context =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/blas/eml_xcabs1.m";
  c4_info[59].name = "imag";
  c4_info[59].dominantType = "double";
  c4_info[59].resolved = "[B]imag";
  c4_info[59].fileLength = 0U;
  c4_info[59].fileTime1 = 0U;
  c4_info[59].fileTime2 = 0U;
  c4_info[60].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/mldivide.m";
  c4_info[60].name = "eml_lusolve";
  c4_info[60].dominantType = "double";
  c4_info[60].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_lusolve.m";
  c4_info[60].fileLength = 4058U;
  c4_info[60].fileTime1 = 1210895846U;
  c4_info[60].fileTime2 = 0U;
  c4_info[61].context =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/blas/refblas/eml_refblas_xdotx.m";
  c4_info[61].name = "eml_zeros";
  c4_info[61].dominantType = "double";
  c4_info[61].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_zeros.m";
  c4_info[61].fileLength = 1083U;
  c4_info[61].fileTime1 = 1213662888U;
  ...
  c4_info[62].fileLength = 277U;
  c4_info[62].fileTime1 = 1192491984U;
  c4_info[62].fileTime2 = 0U;
  c4_info[63].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/isequal.m";
  c4_info[63].name = "eml_isequal_core";
  c4_info[63].dominantType = "char";
  c4_info[63].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_isequal_core.m";
  c4_info[63].fileLength = 3543U;
  c4_info[63].fileTime1 = 1213662886U;
...
{
  c4_info[64].context = "";
  c4_info[64].name = "sqrt";
  c4_info[64].dominantType = "double";
  c4_info[64].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/elfun/sqrt.m";
  c4_info[64].fileLength = 572U;
  c4_info[64].fileTime1 = 1203473246U;
  c4_info[64].fileTime2 = 0U;
  c4_info[65].context =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/blas/refblas/eml_refblas_xdotx.m";
  c4_info[65].name = "eml_index_plus";
  c4_info[65].dominantType = "";
  c4_info[65].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_index_plus.m";
  c4_info[65].fileLength = 272U;
  c4_info[65].fileTime1 = 1192491986U;
  c4_info[65].fileTime2 = 0U;
  c4_info[66].context =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_assert_valid_size_arg.m/numel_for_size";
  c4_info[66].name = "double";
  c4_info[66].dominantType = "double";
  c4_info[66].resolved = "[B]double";
  c4_info[66].fileLength = 0U;
  c4_info[66].fileTime1 = 0U;
  c4_info[66].fileTime2 = 0U;
  c4_info[67].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/elfun/atan2.m";
  c4_info[67].name = "eml_scalar_atan2";
  c4_info[67].dominantType = "double";
  c4_info[67].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/elfun/eml_scalar_atan2.m";
  c4_info[67].fileLength = 964U;
  c4_info[67].fileTime1 = 1209355986U;
  c4_info[67].fileTime2 = 0U;
  c4_info[68].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/datafun/max.m";
  c4_info[68].name = "eml_min_or_max";
  c4_info[68].dominantType = "char";
  c4_info[68].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_min_or_max.m";
  c4_info[68].fileLength = 7562U;
  c4_info[68].fileTime1 = 1213662886U;
  c4_info[68].fileTime2 = 0U;
  c4_info[69].context =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_assert_valid_size_arg.m";
  c4_info[69].name = "intmax";
  c4_info[69].dominantType = "char";
  c4_info[69].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/intmax.m";
  c4_info[69].fileLength = 1535U;
  c4_info[69].fileTime1 = 1192491928U;
  c4_info[69].fileTime2 = 0U;
  c4_info[70].context = "";
  c4_info[70].name = "minus";
  c4_info[70].dominantType = "double";
  c4_info[70].resolved = "[B]minus";
  ...
  c4_info[71].name = "eml_xcabs1";
  c4_info[71].dominantType = "double";
  c4_info[71].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/blas/eml_xcabs1.m";
  c4_info[71].fileLength = 419U;
  c4_info[71].fileTime1 = 1209356048U;
  c4_info[71].fileTime2 = 0U;
  c4_info[72].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/lang/assert.m";
  c4_info[72].name = "islogical";
  c4_info[72].dominantType = "logical";
  c4_info[72].resolved = "[B]islogical";
  ...
  c4_info[73].resolved = "[B]ge";
  c4_info[73].fileLength = 0U;
  c4_info[73].fileTime1 = 0U;
  c4_info[73].fileTime2 = 0U;
  c4_info[74].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/elfun/sqrt.m";
  c4_info[74].name = "eml_scalar_sqrt";
  c4_info[74].dominantType = "double";
  c4_info[74].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/elfun/eml_scalar_sqrt.m";
  c4_info[74].fileLength = 664U;
  c4_info[74].fileTime1 = 1209355994U;
  c4_info[74].fileTime2 = 0U;
  c4_info[75].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/mtimes.m";
  c4_info[75].name = "class";
  c4_info[75].dominantType = "double";
  c4_info[75].resolved = "[B]class";
  c4_info[75].fileLength = 0U;
  c4_info[75].fileTime1 = 0U;
  c4_info[75].fileTime2 = 0U;
  c4_info[76].context = "";
  c4_info[76].name = "zeros";
  c4_info[76].dominantType = "double";
  c4_info[76].resolved = "[B]zeros";
  ...
  c4_info[77].name = "isinteger";
  c4_info[77].dominantType = "double";
  c4_info[77].resolved = "[B]isinteger";
  ...
  c4_info[78].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/datafun/max.m";
  c4_info[78].fileLength = 308U;
  c4_info[78].fileTime1 = 1192491830U;
  c4_info[78].fileTime2 = 0U;
  c4_info[79].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_alloc.m";
  c4_info[79].name = "eml_assert_valid_size_arg";
  c4_info[79].dominantType = "double";
  c4_info[79].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_assert_valid_size_arg.m";
  c4_info[79].fileLength = 2835U;
  c4_info[79].fileTime1 = 1210895844U;
  c4_info[79].fileTime2 = 0U;
  c4_info[80].context = "";
  c4_info[80].name = "mpower";
  c4_info[80].dominantType = "double";
  c4_info[80].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/mpower.m";
  c4_info[80].fileLength = 3547U;
  c4_info[80].fileTime1 = 1213662888U;
  c4_info[80].fileTime2 = 0U;
  c4_info[81].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/mtimes.m";
  c4_info[81].name = "isa";
  c4_info[81].dominantType = "double";
  c4_info[81].resolved = "[B]isa";
  c4_info[81].fileLength = 0U;
  c4_info[81].fileTime1 = 0U;
  c4_info[81].fileTime2 = 0U;
  c4_info[82].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/mrdivide.m";
  c4_info[82].name = "rdivide";
  c4_info[82].dominantType = "double";
  c4_info[82].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/rdivide.m";
  c4_info[82].fileLength = 620U;
  c4_info[82].fileTime1 = 1213662890U;
  c4_info[82].fileTime2 = 0U;
  c4_info[83].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/elfun/abs.m";
  c4_info[83].name = "eml_scalar_abs";
  c4_info[83].dominantType = "double";
  c4_info[83].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/elfun/eml_scalar_abs.m";
  c4_info[83].fileLength = 461U;
  c4_info[83].fileTime1 = 1203473160U;
  ...
  c4_info[85].context =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_assert_valid_size_arg.m/isintegral";
  c4_info[85].name = "true";
  c4_info[85].dominantType = "";
  c4_info[85].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/true.m";
  c4_info[85].fileLength = 237U;
  c4_info[85].fileTime1 = 1192491962U;
  c4_info[85].fileTime2 = 0U;
  c4_info[86].context = "";
  c4_info[86].name = "mrdivide";
  c4_info[86].dominantType = "double";
  c4_info[86].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/mrdivide.m";
  c4_info[86].fileLength = 755U;
  c4_info[86].fileTime1 = 1209356082U;
  c4_info[86].fileTime2 = 0U;
  c4_info[87].context =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_alloc.m/zerosum";
  c4_info[87].name = "cast";
  c4_info[87].dominantType = "double";
  c4_info[87].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/datatypes/cast.m";
  c4_info[87].fileLength = 866U;
  c4_info[87].fileTime1 = 1192491844U;
...
/* SFunction Glue Code */
void sf_c4_main_sim_adapt_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c4_main_sim_adapt_get_autoinheritance_info(void)
{
  ...
  fullDebuggerInitialization)
{
  if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
    ...
    if (!sim_mode_is_rtw_gen(S)) {
      {
        ...
        if (chartAlreadyPresent==0) {
          ...
          init_script_number_translation(_main_sim_adaptMachineNumber_,
            chartInstance.chartNumber);
          sf_debug_set_chart_disable_implicit_casting
            (_main_sim_adaptMachineNumber_,chartInstance.chartNumber,1);
          sf_debug_set_chart_event_thresholds(_main_sim_adaptMachineNumber_,
            chartInstance.chartNumber,
            0,
            0,
            0);
    ...
    sf_debug_reset_current_state_configuration(_main_sim_adaptMachineNumber_,
      chartInstance.chartNumber,chartInstance.instanceNumber);
  }
}

static void sf_opaque_initialize_c4_main_sim_adapt(void *chartInstanceVar)
{
  chart_debug_initialization(chartInstance.S,0);
  initialize_params_c4_main_sim_adapt();
  initialize_c4_main_sim_adapt();
}

static void sf_opaque_enable_c4_main_sim_adapt(void *chartInstanceVar)
{
  enable_c4_main_sim_adapt();
}

static void sf_opaque_disable_c4_main_sim_adapt(void *chartInstanceVar)
{
  disable_c4_main_sim_adapt();
}

static void sf_opaque_gateway_c4_main_sim_adapt(void *chartInstanceVar)
{
  sf_c4_main_sim_adapt();
}

static mxArray* sf_opaque_get_sim_state_c4_main_sim_adapt(void *chartInstanceVar)
{
  mxArray *st = (mxArray *) get_sim_state_c4_main_sim_adapt();
  return st;
}

static void sf_opaque_set_sim_state_c4_main_sim_adapt(void *chartInstanceVar,
  const mxArray *st)
{
  set_sim_state_c4_main_sim_adapt(sf_mex_dup(st));
}

static void sf_opaque_terminate_c4_main_sim_adapt(void *chartInstanceVar)
{
  ...
  finalize_c4_main_sim_adapt();
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c4_main_sim_adapt(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c4_main_sim_adapt(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    int_T chartIsInlinable =
      (int_T)sf_is_chart_inlinable("main_sim_adapt","main_sim_adapt",4);
    ssSetStateflowIsInlinable(S,chartIsInlinable);
    ssSetRTWCG(S,sf_rtw_info_uint_prop("main_sim_adapt","main_sim_adapt",4,
                "RTWCG"));
    ssSetEnableFcnIsTrivial(S,1);
    ssSetDisableFcnIsTrivial(S,1);
    ssSetNotMultipleInlinable(S,sf_rtw_info_uint_prop("main_sim_adapt",
      "main_sim_adapt",4,"gatewayCannotBeInlinedMultipleTimes"));
    if (chartIsInlinable) {
      ...
      sf_mark_chart_expressionable_inputs(S,"main_sim_adapt","main_sim_adapt",4,
        11);
      sf_mark_chart_reusable_outputs(S,"main_sim_adapt","main_sim_adapt",4,5);
    }

    sf_set_rtw_dwork_info(S,"main_sim_adapt","main_sim_adapt",4);
...
static void mdlRTW_c4_main_sim_adapt(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
    sf_write_symbol_mapping(S, "main_sim_adapt", "main_sim_adapt",4);
    ssWriteRTWStrParam(S, "StateflowChartType", "Embedded MATLAB");
  }
}

static void mdlStart_c4_main_sim_adapt(SimStruct *S)
{
  chartInstance.chartInfo.chartInstance = NULL;
  chartInstance.chartInfo.isEMLChart = 1;
  chartInstance.chartInfo.chartInitialized = 0;
  chartInstance.chartInfo.sFunctionGateway = sf_opaque_gateway_c4_main_sim_adapt;
  chartInstance.chartInfo.initializeChart =
    sf_opaque_initialize_c4_main_sim_adapt;
  chartInstance.chartInfo.terminateChart = sf_opaque_terminate_c4_main_sim_adapt;
  chartInstance.chartInfo.enableChart = sf_opaque_enable_c4_main_sim_adapt;
  chartInstance.chartInfo.disableChart = sf_opaque_disable_c4_main_sim_adapt;
  chartInstance.chartInfo.getSimState =
    sf_opaque_get_sim_state_c4_main_sim_adapt;
  chartInstance.chartInfo.setSimState =
    sf_opaque_set_sim_state_c4_main_sim_adapt;
  chartInstance.chartInfo.zeroCrossings = NULL;
  chartInstance.chartInfo.outputs = NULL;
  chartInstance.chartInfo.derivatives = NULL;
  chartInstance.chartInfo.mdlRTW = mdlRTW_c4_main_sim_adapt;
  chartInstance.chartInfo.mdlStart = mdlStart_c4_main_sim_adapt;
  chartInstance.chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c4_main_sim_adapt;
...
void c4_main_sim_adapt_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c4_main_sim_adapt(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c4_main_sim_adapt(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c4_main_sim_adapt(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c4_main_sim_adapt_method_dispatcher.\n"
