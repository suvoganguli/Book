...
static void c6_info_helper(c6_ResolvedFunctionInfo c6_info[67])
{
  c6_info[0].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/elfun/abs.m";
  c6_info[0].name = "eml_scalar_abs";
  c6_info[0].dominantType = "double";
  c6_info[0].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/elfun/eml_scalar_abs.m";
  c6_info[0].fileLength = 461U;
  c6_info[0].fileTime1 = 1203473160U;
  c6_info[0].fileTime2 = 0U;
  c6_info[1].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/elfun/abs.m";
  c6_info[1].name = "class";
  c6_info[1].dominantType = "double";
  c6_info[1].resolved = "[B]class";
  ...
  c6_info[2].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/mtimes.m";
  c6_info[2].fileLength = 2336U;
  c6_info[2].fileTime1 = 1213662890U;
  c6_info[2].fileTime2 = 0U;
  c6_info[3].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_alloc.m";
  c6_info[3].name = "eml_assert_valid_size_arg";
  c6_info[3].dominantType = "double";
  c6_info[3].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_assert_valid_size_arg.m";
  c6_info[3].fileLength = 2835U;
  c6_info[3].fileTime1 = 1210895844U;
  c6_info[3].fileTime2 = 0U;
  c6_info[4].context =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_assert_valid_size_arg.m";
  c6_info[4].name = "isnumeric";
  c6_info[4].dominantType = "double";
  c6_info[4].resolved = "[B]isnumeric";
  ...
  c6_info[8].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/datafun/sum.m";
  c6_info[8].fileLength = 2854U;
  ...
  c6_info[11].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/eps.m";
  c6_info[11].name = "realmin";
  c6_info[11].dominantType = "";
  c6_info[11].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/realmin.m";
  c6_info[11].fileLength = 475U;
  c6_info[11].fileTime1 = 1192491952U;
  ...
  c6_info[13].name = "plus";
  c6_info[13].dominantType = "double";
  c6_info[13].resolved = "[B]plus";
  c6_info[13].fileLength = 0U;
  c6_info[13].fileTime1 = 0U;
  c6_info[13].fileTime2 = 0U;
  c6_info[14].context =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_alloc.m/zerosum";
  c6_info[14].name = "cast";
  c6_info[14].dominantType = "double";
  c6_info[14].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/datatypes/cast.m";
  c6_info[14].fileLength = 866U;
  c6_info[14].fileTime1 = 1192491844U;
  c6_info[14].fileTime2 = 0U;
  c6_info[15].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/eps.m";
  c6_info[15].name = "eml_guarded_nan";
  c6_info[15].dominantType = "";
  c6_info[15].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_guarded_nan.m";
  c6_info[15].fileLength = 485U;
  c6_info[15].fileTime1 = 1192491980U;
  c6_info[15].fileTime2 = 0U;
  c6_info[16].context = "";
  c6_info[16].name = "colon";
  c6_info[16].dominantType = "double";
  c6_info[16].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/colon.m";
  c6_info[16].fileLength = 7324U;
  c6_info[16].fileTime1 = 1197325946U;
  c6_info[16].fileTime2 = 0U;
  c6_info[17].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/colon.m";
  c6_info[17].name = "isreal";
  c6_info[17].dominantType = "double";
  c6_info[17].resolved = "[B]isreal";
  ...
  c6_info[24].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/mpower.m";
  c6_info[24].name = "power";
  c6_info[24].dominantType = "double";
  c6_info[24].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/power.m";
  c6_info[24].fileLength = 5131U;
  c6_info[24].fileTime1 = 1213662890U;
  c6_info[24].fileTime2 = 0U;
  c6_info[25].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/mpower.m";
  c6_info[25].name = "ndims";
  c6_info[25].dominantType = "double";
  c6_info[25].resolved = "[B]ndims";
  c6_info[25].fileLength = 0U;
  c6_info[25].fileTime1 = 0U;
  c6_info[25].fileTime2 = 0U;
  c6_info[26].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/elfun/abs.m";
  c6_info[26].name = "zeros";
  c6_info[26].dominantType = "double";
  c6_info[26].resolved = "[B]zeros";
  ...
  c6_info[27].name = "isfinite";
  c6_info[27].dominantType = "double";
  c6_info[27].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/isfinite.m";
  c6_info[27].fileLength = 341U;
  c6_info[27].fileTime1 = 1192491934U;
  c6_info[27].fileTime2 = 0U;
  c6_info[28].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/length.m";
  c6_info[28].name = "eq";
  c6_info[28].dominantType = "double";
  c6_info[28].resolved = "[B]eq";
  ...
  c6_info[34].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/elfun/abs.m";
  c6_info[34].fileLength = 538U;
  c6_info[34].fileTime1 = 1203473128U;
  c6_info[34].fileTime2 = 0U;
  c6_info[35].context =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_assert_valid_size_arg.m/numel_for_size";
  c6_info[35].name = "double";
  c6_info[35].dominantType = "double";
  c6_info[35].resolved = "[B]double";
  ...
  c6_info[36].resolved = "[B]ge";
  c6_info[36].fileLength = 0U;
  c6_info[36].fileTime1 = 0U;
  c6_info[36].fileTime2 = 0U;
  c6_info[37].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/length.m";
  c6_info[37].name = "nargin";
  c6_info[37].dominantType = "";
  c6_info[37].resolved = "[B]nargin";
  ...
  c6_info[38].fileLength = 909U;
  c6_info[38].fileTime1 = 1192491982U;
  c6_info[38].fileTime2 = 0U;
  c6_info[39].context =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_all_or_any.m";
  c6_info[39].name = "isempty";
  c6_info[39].dominantType = "logical";
  c6_info[39].resolved = "[B]isempty";
  c6_info[39].fileLength = 0U;
  c6_info[39].fileTime1 = 0U;
  c6_info[39].fileTime2 = 0U;
  c6_info[40].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/eps.m";
  c6_info[40].name = "eml_alloc";
  c6_info[40].dominantType = "double";
  c6_info[40].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_alloc.m";
  c6_info[40].fileLength = 2627U;
  c6_info[40].fileTime1 = 1213662886U;
  c6_info[40].fileTime2 = 0U;
  c6_info[41].context =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_assert_valid_size_arg.m";
  c6_info[41].name = "intmax";
  c6_info[41].dominantType = "char";
  c6_info[41].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/intmax.m";
  c6_info[41].fileLength = 1535U;
  c6_info[41].fileTime1 = 1192491928U;
  ...
  c6_info[43].context = "";
  c6_info[43].name = "length";
  c6_info[43].dominantType = "double";
  c6_info[43].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/length.m";
  c6_info[43].fileLength = 303U;
  c6_info[43].fileTime1 = 1192491938U;
  c6_info[43].fileTime2 = 0U;
  c6_info[44].context =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_all_or_any.m";
  c6_info[44].name = "eml_set_singleton_dim";
  c6_info[44].dominantType = "double";
  c6_info[44].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_set_singleton_dim.m";
  c6_info[44].fileLength = 398U;
  c6_info[44].fileTime1 = 1209356038U;
  c6_info[44].fileTime2 = 0U;
  c6_info[45].context =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/colon.m/is_flint_colon";
  c6_info[45].name = "floor";
  c6_info[45].dominantType = "double";
  c6_info[45].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/elfun/floor.m";
  c6_info[45].fileLength = 332U;
  c6_info[45].fileTime1 = 1203473224U;
  c6_info[45].fileTime2 = 0U;
  c6_info[46].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/datafun/sum.m";
  c6_info[46].name = "isequal";
  c6_info[46].dominantType = "double";
  c6_info[46].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/isequal.m";
  c6_info[46].fileLength = 157U;
  c6_info[46].fileTime1 = 1210895846U;
  c6_info[46].fileTime2 = 0U;
  c6_info[47].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/false.m";
  c6_info[47].name = "logical";
  c6_info[47].dominantType = "double";
  c6_info[47].resolved = "[B]logical";
  c6_info[47].fileLength = 0U;
  c6_info[47].fileTime1 = 0U;
  c6_info[47].fileTime2 = 0U;
  c6_info[48].context =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/isfinite.m";
  c6_info[48].name = "isinf";
  c6_info[48].dominantType = "double";
  c6_info[48].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/isinf.m";
  c6_info[48].fileLength = 472U;
  c6_info[48].fileTime1 = 1192491934U;
  c6_info[48].fileTime2 = 0U;
  c6_info[49].context =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/isfinite.m";
  c6_info[49].name = "and";
  c6_info[49].dominantType = "logical";
  c6_info[49].resolved = "[B]and";
  ...
  c6_info[50].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/nan.m";
  c6_info[50].fileLength = 474U;
  c6_info[50].fileTime1 = 1192491944U;
  c6_info[50].fileTime2 = 0U;
  c6_info[51].context =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/colon.m/is_flint_colon";
  c6_info[51].name = "eps";
  c6_info[51].dominantType = "double";
  c6_info[51].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/eps.m";
  c6_info[51].fileLength = 1342U;
  c6_info[51].fileTime1 = 1210895846U;
  c6_info[51].fileTime2 = 0U;
  c6_info[52].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/isequal.m";
  c6_info[52].name = "eml_isequal_core";
  c6_info[52].dominantType = "double";
  c6_info[52].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_isequal_core.m";
  c6_info[52].fileLength = 3543U;
  c6_info[52].fileTime1 = 1213662886U;
  c6_info[52].fileTime2 = 0U;
  c6_info[53].context =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/colon.m/checkrange";
  c6_info[53].name = "realmax";
  c6_info[53].dominantType = "char";
  c6_info[53].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/realmax.m";
  c6_info[53].fileLength = 498U;
  c6_info[53].fileTime1 = 1192491950U;
  c6_info[53].fileTime2 = 0U;
  c6_info[54].context =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_assert_valid_size_arg.m";
  c6_info[54].name = "isvector";
  c6_info[54].dominantType = "double";
  c6_info[54].resolved = "[B]isvector";
  ...
  c6_info[56].name = "isscalar";
  c6_info[56].dominantType = "double";
  c6_info[56].resolved = "[B]isscalar";
  c6_info[56].fileLength = 0U;
  c6_info[56].fileTime1 = 0U;
  c6_info[56].fileTime2 = 0U;
  c6_info[57].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/eps.m";
  c6_info[57].name = "real";
  c6_info[57].dominantType = "double";
  c6_info[57].resolved = "[B]real";
  ...
  c6_info[58].resolved = "[B]ne";
  c6_info[58].fileLength = 0U;
  c6_info[58].fileTime1 = 0U;
  c6_info[58].fileTime2 = 0U;
  c6_info[59].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/length.m";
  c6_info[59].name = "size";
  c6_info[59].dominantType = "double";
  c6_info[59].resolved = "[B]size";
  ...
  c6_info[62].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/intmax.m";
  c6_info[62].name = "int32";
  c6_info[62].dominantType = "double";
  c6_info[62].resolved = "[B]int32";
  c6_info[62].fileLength = 0U;
  c6_info[62].fileTime1 = 0U;
  c6_info[62].fileTime2 = 0U;
  c6_info[63].context =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_assert_valid_size_arg.m/isintegral";
  c6_info[63].name = "true";
  c6_info[63].dominantType = "";
  c6_info[63].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/true.m";
  c6_info[63].fileLength = 237U;
  c6_info[63].fileTime1 = 1192491962U;
...
static void mdlSetWorkWidths_c6_aeroutilslib(SimStruct *S)
{
  ...
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    int_T chartIsInlinable =
      (int_T)sf_is_chart_inlinable("aeroutilslib","claw_main",6);
    ssSetStateflowIsInlinable(S,chartIsInlinable);
    ssSetRTWCG(S,sf_rtw_info_uint_prop("aeroutilslib","claw_main",6,"RTWCG"));
    ssSetEnableFcnIsTrivial(S,1);
    ssSetDisableFcnIsTrivial(S,1);
    ssSetNotMultipleInlinable(S,sf_rtw_info_uint_prop("aeroutilslib","claw_main",
      6,"gatewayCannotBeInlinedMultipleTimes"));
    if (chartIsInlinable) {
      ssSetInputPortOptimOpts(S, 0, SS_REUSABLE_AND_LOCAL);
      sf_mark_chart_expressionable_inputs(S,"aeroutilslib","claw_main",6,1);
      sf_mark_chart_reusable_outputs(S,"aeroutilslib","claw_main",6,1);
    }

    sf_set_rtw_dwork_info(S,"aeroutilslib","claw_main",6);
...
{
  if (sim_mode_is_rtw_gen(S)) {
    sf_write_symbol_mapping(S, "aeroutilslib", "claw_main",6);
