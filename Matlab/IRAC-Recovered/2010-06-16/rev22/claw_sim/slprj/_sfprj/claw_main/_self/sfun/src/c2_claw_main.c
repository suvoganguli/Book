...
static SFc2_claw_mainInstanceStruct chartInstance;

/* Function Declarations */
static void initialize_c2_claw_main(void);
static void initialize_params_c2_claw_main(void);
static void enable_c2_claw_main(void);
static void disable_c2_claw_main(void);
static void update_debugger_state_c2_claw_main(void);
static const mxArray *get_sim_state_c2_claw_main(void);
static void set_sim_state_c2_claw_main(const mxArray *c2_st);
static void finalize_c2_claw_main(void);
static void sf_c2_claw_main(void);
static void c2_c2_claw_main(void);
...
static void initialize_c2_claw_main(void)
{
  ...
  chartInstance.c2_is_active_c2_claw_main = 0U;
}
...
const mxArray *sf_c2_claw_main_get_eml_resolved_functions_info(void)
{
...
static void c2_info_helper(c2_ResolvedFunctionInfo c2_info[90])
{
  ...
  c2_info[0].name = "isinteger";
  c2_info[0].dominantType = "double";
  c2_info[0].resolved = "[B]isinteger";
  ...
  c2_info[5].name = "strcmp";
  c2_info[5].dominantType = "char";
  c2_info[5].resolved = "[B]strcmp";
  ...
  c2_info[6].name = "isvector";
  c2_info[6].dominantType = "double";
  c2_info[6].resolved = "[B]isvector";
  c2_info[6].fileLength = 0U;
  c2_info[6].fileTime1 = 0U;
  c2_info[6].fileTime2 = 0U;
  c2_info[7].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/isfinite.m";
  c2_info[7].name = "isnan";
  c2_info[7].dominantType = "double";
  c2_info[7].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/isnan.m";
  c2_info[7].fileLength = 472U;
  c2_info[7].fileTime1 = 1192491936U;
  c2_info[7].fileTime2 = 0U;
  c2_info[8].context =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_assert_valid_size_arg.m";
  c2_info[8].name = "intmax";
  c2_info[8].dominantType = "char";
  c2_info[8].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/intmax.m";
  c2_info[8].fileLength = 1535U;
  c2_info[8].fileTime1 = 1192491928U;
  c2_info[8].fileTime2 = 0U;
  c2_info[9].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/diag.m";
  c2_info[9].name = "eml_zeros";
  c2_info[9].dominantType = "int32";
  c2_info[9].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_zeros.m";
  c2_info[9].fileLength = 1083U;
  c2_info[9].fileTime1 = 1213662888U;
  c2_info[9].fileTime2 = 0U;
  c2_info[10].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/datafun/sum.m";
  c2_info[10].name = "isequal";
  c2_info[10].dominantType = "double";
  c2_info[10].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/isequal.m";
  c2_info[10].fileLength = 157U;
  c2_info[10].fileTime1 = 1210895846U;
  ...
  c2_info[13].fileTime1 = 1192491984U;
  c2_info[13].fileTime2 = 0U;
  c2_info[14].context = "";
  c2_info[14].name = "any";
  c2_info[14].dominantType = "double";
  c2_info[14].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/any.m";
  c2_info[14].fileLength = 400U;
  c2_info[14].fileTime1 = 1192492106U;
  ...
  c2_info[17].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/isequal.m";
  c2_info[17].name = "eml_isequal_core";
  c2_info[17].dominantType = "double";
  c2_info[17].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_isequal_core.m";
  c2_info[17].fileLength = 3543U;
  c2_info[17].fileTime1 = 1213662886U;
  c2_info[17].fileTime2 = 0U;
  c2_info[18].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/realmin.m";
  c2_info[18].name = "mpower";
  c2_info[18].dominantType = "double";
  c2_info[18].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/mpower.m";
  c2_info[18].fileLength = 3547U;
  c2_info[18].fileTime1 = 1213662888U;
  c2_info[18].fileTime2 = 0U;
  c2_info[19].context = "";
  c2_info[19].name = "power";
  c2_info[19].dominantType = "double";
  c2_info[19].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/power.m";
  c2_info[19].fileLength = 5131U;
  c2_info[19].fileTime1 = 1213662890U;
  c2_info[19].fileTime2 = 0U;
  c2_info[20].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/mtimes.m";
  c2_info[20].name = "assert";
  c2_info[20].dominantType = "char";
  c2_info[20].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/lang/assert.m";
  c2_info[20].fileLength = 2684U;
  c2_info[20].fileTime1 = 1210895856U;
  c2_info[20].fileTime2 = 0U;
  c2_info[21].context = "";
  c2_info[21].name = "length";
  c2_info[21].dominantType = "double";
  c2_info[21].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/length.m";
  c2_info[21].fileLength = 303U;
  c2_info[21].fileTime1 = 1192491938U;
  c2_info[21].fileTime2 = 0U;
  c2_info[22].context = "";
  c2_info[22].name = "bitand";
  c2_info[22].dominantType = "uint32";
  c2_info[22].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/bitand.m";
  c2_info[22].fileLength = 1046U;
  ...
  c2_info[24].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/rdivide.m";
  c2_info[24].name = "eml_div";
  c2_info[24].dominantType = "double";
  c2_info[24].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_div.m";
  c2_info[24].fileLength = 4254U;
  c2_info[24].fileTime1 = 1192491972U;
  c2_info[24].fileTime2 = 0U;
  c2_info[25].context = "";
  c2_info[25].name = "mtimes";
  c2_info[25].dominantType = "double";
  c2_info[25].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/mtimes.m";
  c2_info[25].fileLength = 2336U;
  c2_info[25].fileTime1 = 1213662890U;
  c2_info[25].fileTime2 = 0U;
  c2_info[26].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/bitor.m";
  c2_info[26].name = "eml_isa_uint";
  c2_info[26].dominantType = "uint32";
  c2_info[26].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_isa_uint.m";
  c2_info[26].fileLength = 239U;
  c2_info[26].fileTime1 = 1192491992U;
  c2_info[26].fileTime2 = 0U;
  c2_info[27].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/eps.m";
  c2_info[27].name = "realmin";
  c2_info[27].dominantType = "";
  c2_info[27].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/realmin.m";
  c2_info[27].fileLength = 475U;
  c2_info[27].fileTime1 = 1192491952U;
  ...
  c2_info[29].fileLength = 866U;
  c2_info[29].fileTime1 = 1192491844U;
  ...
  c2_info[31].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/nan.m";
  c2_info[31].fileLength = 474U;
  c2_info[31].fileTime1 = 1192491944U;
  ...
  c2_info[35].fileLength = 909U;
  c2_info[35].fileTime1 = 1192491982U;
  c2_info[35].fileTime2 = 0U;
  c2_info[36].context =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_isequal_core.m/binary_isequal";
  c2_info[36].name = "all";
  c2_info[36].dominantType = "logical";
  c2_info[36].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/all.m";
  c2_info[36].fileLength = 400U;
  c2_info[36].fileTime1 = 1192492104U;
  ...
  c2_info[39].context = "";
  c2_info[39].name = "bitget";
  c2_info[39].dominantType = "uint32";
  c2_info[39].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/bitget.m";
  c2_info[39].fileLength = 1216U;
  c2_info[39].fileTime1 = 1213662888U;
  c2_info[39].fileTime2 = 0U;
  c2_info[40].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/eps.m";
  c2_info[40].name = "real";
  c2_info[40].dominantType = "double";
  c2_info[40].resolved = "[B]real";
  c2_info[40].fileLength = 0U;
  c2_info[40].fileTime1 = 0U;
  c2_info[40].fileTime2 = 0U;
  c2_info[41].context = "";
  c2_info[41].name = "rdivide";
  c2_info[41].dominantType = "double";
  c2_info[41].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/rdivide.m";
  c2_info[41].fileLength = 620U;
  c2_info[41].fileTime1 = 1213662890U;
  c2_info[41].fileTime2 = 0U;
  c2_info[42].context =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/blas/internal/eml_blas_xgemm.m";
  c2_info[42].name = "eml_refblas_xgemm";
  c2_info[42].dominantType = "int32";
  c2_info[42].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/blas/refblas/eml_refblas_xgemm.m";
  c2_info[42].fileLength = 5746U;
  c2_info[42].fileTime1 = 1210895858U;
  c2_info[42].fileTime2 = 0U;
  c2_info[43].context =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/blas/eml_xgemm.m";
  c2_info[43].name = "eml_blas_xgemm";
  c2_info[43].dominantType = "int32";
  c2_info[43].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/blas/internal/eml_blas_xgemm.m";
  c2_info[43].fileLength = 355U;
  c2_info[43].fileTime1 = 1192492054U;
  c2_info[43].fileTime2 = 0U;
  c2_info[44].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/power.m";
  c2_info[44].name = "lt";
  ...
  c2_info[45].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_alloc.m";
  ...
  c2_info[61].name = "realmax";
  c2_info[61].dominantType = "char";
  c2_info[61].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/realmax.m";
  c2_info[61].fileLength = 498U;
  c2_info[61].fileTime1 = 1192491950U;
  c2_info[61].fileTime2 = 0U;
  c2_info[62].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/mtimes.m";
  c2_info[62].name = "ones";
  c2_info[62].dominantType = "char";
  c2_info[62].resolved = "[B]ones";
  c2_info[62].fileLength = 0U;
  c2_info[62].fileTime1 = 0U;
  c2_info[62].fileTime2 = 0U;
  c2_info[63].context =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_assert_valid_size_arg.m/isintegral";
  c2_info[63].name = "true";
  c2_info[63].dominantType = "";
  c2_info[63].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/true.m";
  c2_info[63].fileLength = 237U;
  c2_info[63].fileTime1 = 1192491962U;
  c2_info[63].fileTime2 = 0U;
}

static void c2_b_info_helper(c2_ResolvedFunctionInfo c2_info[90])
{
  c2_info[64].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/diag.m";
  c2_info[64].name = "eml_index_plus";
  c2_info[64].dominantType = "int32";
  c2_info[64].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_index_plus.m";
  c2_info[64].fileLength = 272U;
  c2_info[64].fileTime1 = 1192491986U;
  c2_info[64].fileTime2 = 0U;
  c2_info[65].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/false.m";
  c2_info[65].name = "logical";
  c2_info[65].dominantType = "double";
  c2_info[65].resolved = "[B]logical";
  ...
  c2_info[67].fileLength = 280U;
  c2_info[67].fileTime1 = 1192491988U;
  c2_info[67].fileTime2 = 0U;
  c2_info[68].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/bitget.m";
  c2_info[68].name = "eml_int_nbits";
  c2_info[68].dominantType = "char";
  c2_info[68].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_int_nbits.m";
  c2_info[68].fileLength = 467U;
  c2_info[68].fileTime1 = 1192491988U;
  c2_info[68].fileTime2 = 0U;
  c2_info[69].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/elfun/sqrt.m";
  c2_info[69].name = "eml_scalar_sqrt";
  c2_info[69].dominantType = "double";
  c2_info[69].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/elfun/eml_scalar_sqrt.m";
  c2_info[69].fileLength = 664U;
  c2_info[69].fileTime1 = 1209355994U;
  c2_info[69].fileTime2 = 0U;
  c2_info[70].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_alloc.m";
  c2_info[70].name = "isstruct";
  c2_info[70].dominantType = "double";
  c2_info[70].resolved = "[B]isstruct";
  ...
  c2_info[71].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/datafun/sum.m";
  c2_info[71].fileLength = 2854U;
  c2_info[71].fileTime1 = 1213662886U;
  c2_info[71].fileTime2 = 0U;
  c2_info[72].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/power.m";
  c2_info[72].name = "eml_scalar_floor";
  c2_info[72].dominantType = "double";
  c2_info[72].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/elfun/eml_scalar_floor.m";
  c2_info[72].fileLength = 260U;
  c2_info[72].fileTime1 = 1209355990U;
  c2_info[72].fileTime2 = 0U;
  c2_info[73].context = "";
  c2_info[73].name = "bitor";
  c2_info[73].dominantType = "uint32";
  c2_info[73].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/bitor.m";
  c2_info[73].fileLength = 1043U;
  c2_info[73].fileTime1 = 1209356078U;
  ...
  c2_info[75].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_alloc.m";
  c2_info[75].name = "eml_assert_valid_size_arg";
  c2_info[75].dominantType = "double";
  c2_info[75].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_assert_valid_size_arg.m";
  c2_info[75].fileLength = 2835U;
  c2_info[75].fileTime1 = 1210895844U;
  c2_info[75].fileTime2 = 0U;
  c2_info[76].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/power.m";
  c2_info[76].name = "eml_error";
  c2_info[76].dominantType = "char";
  c2_info[76].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_error.m";
  c2_info[76].fileLength = 315U;
  c2_info[76].fileTime1 = 1213662886U;
  c2_info[76].fileTime2 = 0U;
  c2_info[77].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/intmax.m";
  c2_info[77].name = "ischar";
  c2_info[77].dominantType = "char";
  c2_info[77].resolved = "[B]ischar";
  ...
  c2_info[79].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/realmin.m";
  c2_info[79].name = "uminus";
  c2_info[79].dominantType = "double";
  c2_info[79].resolved = "[B]uminus";
  ...
  c2_info[80].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/eps.m";
  c2_info[80].fileLength = 1342U;
  c2_info[80].fileTime1 = 1210895846U;
  c2_info[80].fileTime2 = 0U;
  c2_info[81].context =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/colon.m/is_flint_colon";
  c2_info[81].name = "floor";
  c2_info[81].dominantType = "double";
  c2_info[81].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/elfun/floor.m";
  c2_info[81].fileLength = 332U;
  c2_info[81].fileTime1 = 1203473224U;
  c2_info[81].fileTime2 = 0U;
  c2_info[82].context = "";
  c2_info[82].name = "diag";
  c2_info[82].dominantType = "double";
  c2_info[82].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/diag.m";
  c2_info[82].fileLength = 2369U;
  c2_info[82].fileTime1 = 1210895844U;
  c2_info[82].fileTime2 = 0U;
  c2_info[83].context =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/isfinite.m";
  c2_info[83].name = "isinf";
  c2_info[83].dominantType = "double";
  c2_info[83].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/isinf.m";
  c2_info[83].fileLength = 472U;
  c2_info[83].fileTime1 = 1192491934U;
  c2_info[83].fileTime2 = 0U;
  c2_info[84].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/mtimes.m";
  c2_info[84].name = "isscalar";
  c2_info[84].dominantType = "double";
  c2_info[84].resolved = "[B]isscalar";
  c2_info[84].fileLength = 0U;
  c2_info[84].fileTime1 = 0U;
  c2_info[84].fileTime2 = 0U;
  c2_info[85].context = "";
  c2_info[85].name = "minus";
  c2_info[85].dominantType = "double";
  c2_info[85].resolved = "[B]minus";
  c2_info[85].fileLength = 0U;
  c2_info[85].fileTime1 = 0U;
  c2_info[85].fileTime2 = 0U;
  c2_info[86].context = "";
  c2_info[86].name = "sqrt";
  c2_info[86].dominantType = "double";
  c2_info[86].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/elfun/sqrt.m";
  c2_info[86].fileLength = 572U;
  c2_info[86].fileTime1 = 1203473246U;
  c2_info[86].fileTime2 = 0U;
  c2_info[87].context = "";
  c2_info[87].name = "uint32";
  c2_info[87].dominantType = "double";
  c2_info[87].resolved = "[B]uint32";
  c2_info[87].fileLength = 0U;
  c2_info[87].fileTime1 = 0U;
  c2_info[87].fileTime2 = 0U;
  c2_info[88].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/power.m";
  c2_info[88].name = "eml_scalexp_size";
  c2_info[88].dominantType = "double";
  c2_info[88].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_scalexp_size.m";
  c2_info[88].fileLength = 1373U;
  c2_info[88].fileTime1 = 1208205260U;
...
/* SFunction Glue Code */
void sf_c2_claw_main_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c2_claw_main_get_autoinheritance_info(void)
{
...
static void sf_opaque_initialize_c2_claw_main(void *chartInstanceVar)
{
  chart_debug_initialization(chartInstance.S,0);
  initialize_params_c2_claw_main();
  initialize_c2_claw_main();
}

static void sf_opaque_enable_c2_claw_main(void *chartInstanceVar)
{
  enable_c2_claw_main();
}

static void sf_opaque_disable_c2_claw_main(void *chartInstanceVar)
{
  disable_c2_claw_main();
}

static void sf_opaque_gateway_c2_claw_main(void *chartInstanceVar)
{
  sf_c2_claw_main();
}

static mxArray* sf_opaque_get_sim_state_c2_claw_main(void *chartInstanceVar)
{
  mxArray *st = (mxArray *) get_sim_state_c2_claw_main();
  return st;
}

static void sf_opaque_set_sim_state_c2_claw_main(void *chartInstanceVar, const
  mxArray *st)
{
  set_sim_state_c2_claw_main(sf_mex_dup(st));
}

static void sf_opaque_terminate_c2_claw_main(void *chartInstanceVar)
{
  ...
  finalize_c2_claw_main();
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c2_claw_main(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c2_claw_main(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    int_T chartIsInlinable =
      (int_T)sf_is_chart_inlinable("claw_main","claw_main",2);
    ssSetStateflowIsInlinable(S,chartIsInlinable);
    ssSetRTWCG(S,sf_rtw_info_uint_prop("claw_main","claw_main",2,"RTWCG"));
    ssSetEnableFcnIsTrivial(S,1);
    ssSetDisableFcnIsTrivial(S,1);
    ssSetNotMultipleInlinable(S,sf_rtw_info_uint_prop("claw_main","claw_main",2,
    ...
    if (chartIsInlinable) {
      ...
      sf_mark_chart_expressionable_inputs(S,"claw_main","claw_main",2,7);
      sf_mark_chart_reusable_outputs(S,"claw_main","claw_main",2,4);
    }

    sf_set_rtw_dwork_info(S,"claw_main","claw_main",2);
...
static void mdlRTW_c2_claw_main(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
    sf_write_symbol_mapping(S, "claw_main", "claw_main",2);
    ssWriteRTWStrParam(S, "StateflowChartType", "Embedded MATLAB");
  }
}

static void mdlStart_c2_claw_main(SimStruct *S)
{
  chartInstance.chartInfo.chartInstance = NULL;
  chartInstance.chartInfo.isEMLChart = 1;
  chartInstance.chartInfo.chartInitialized = 0;
  chartInstance.chartInfo.sFunctionGateway = sf_opaque_gateway_c2_claw_main;
  chartInstance.chartInfo.initializeChart = sf_opaque_initialize_c2_claw_main;
  chartInstance.chartInfo.terminateChart = sf_opaque_terminate_c2_claw_main;
  chartInstance.chartInfo.enableChart = sf_opaque_enable_c2_claw_main;
  chartInstance.chartInfo.disableChart = sf_opaque_disable_c2_claw_main;
  chartInstance.chartInfo.getSimState = sf_opaque_get_sim_state_c2_claw_main;
  chartInstance.chartInfo.setSimState = sf_opaque_set_sim_state_c2_claw_main;
  chartInstance.chartInfo.zeroCrossings = NULL;
  chartInstance.chartInfo.outputs = NULL;
  chartInstance.chartInfo.derivatives = NULL;
  chartInstance.chartInfo.mdlRTW = mdlRTW_c2_claw_main;
  chartInstance.chartInfo.mdlStart = mdlStart_c2_claw_main;
  chartInstance.chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c2_claw_main;
...
void c2_claw_main_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c2_claw_main(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c2_claw_main(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c2_claw_main(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c2_claw_main_method_dispatcher.\n"
