  ...
  if (nrhs>2 && mxIsChar(prhs[1])) {
    ...
    if (!strcmp(commandName,"library")) {
      ...
      if (!strcmp(machineName,"models")) {
        if (nrhs==3) {
          ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(1629433736U);
          ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(1498562166U);
          ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(3436866767U);
          ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(3605337392U);
        } else if (nrhs==4) {
