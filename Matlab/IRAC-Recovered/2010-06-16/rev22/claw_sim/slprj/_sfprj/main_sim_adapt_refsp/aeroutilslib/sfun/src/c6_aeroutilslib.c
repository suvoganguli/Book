...
static void c6_info_helper(c6_ResolvedFunctionInfo c6_info[67])
{
  c6_info[0].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/eps.m";
  c6_info[0].name = "real";
  c6_info[0].dominantType = "double";
  c6_info[0].resolved = "[B]real";
  c6_info[0].fileLength = 0U;
  c6_info[0].fileTime1 = 0U;
  c6_info[0].fileTime2 = 0U;
  c6_info[1].context = "";
  c6_info[1].name = "uminus";
  c6_info[1].dominantType = "double";
  c6_info[1].resolved = "[B]uminus";
  c6_info[1].fileLength = 0U;
  c6_info[1].fileTime1 = 0U;
  c6_info[1].fileTime2 = 0U;
  c6_info[2].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/mpower.m";
  c6_info[2].name = "power";
  c6_info[2].dominantType = "double";
  c6_info[2].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/power.m";
  c6_info[2].fileLength = 5131U;
  c6_info[2].fileTime1 = 1213662890U;
  c6_info[2].fileTime2 = 0U;
  c6_info[3].context =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/colon.m/checkrange";
  c6_info[3].name = "realmax";
  c6_info[3].dominantType = "char";
  c6_info[3].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/realmax.m";
  c6_info[3].fileLength = 498U;
  c6_info[3].fileTime1 = 1192491950U;
  c6_info[3].fileTime2 = 0U;
  c6_info[4].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/colon.m";
  c6_info[4].name = "ischar";
  c6_info[4].dominantType = "double";
  c6_info[4].resolved = "[B]ischar";
  ...
  c6_info[5].fileLength = 909U;
  c6_info[5].fileTime1 = 1192491982U;
  c6_info[5].fileTime2 = 0U;
  c6_info[6].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/power.m";
  c6_info[6].name = "eml_scalexp_size";
  c6_info[6].dominantType = "double";
  c6_info[6].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_scalexp_size.m";
  c6_info[6].fileLength = 1373U;
  c6_info[6].fileTime1 = 1208205260U;
  c6_info[6].fileTime2 = 0U;
  c6_info[7].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/eps.m";
  c6_info[7].name = "realmin";
  c6_info[7].dominantType = "";
  c6_info[7].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/realmin.m";
  c6_info[7].fileLength = 475U;
  c6_info[7].fileTime1 = 1192491952U;
  c6_info[7].fileTime2 = 0U;
  c6_info[8].context =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_scalexp_size.m";
  c6_info[8].name = "eml_scalexp_compatible";
  c6_info[8].dominantType = "double";
  c6_info[8].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_scalexp_compatible.m";
  c6_info[8].fileLength = 502U;
  c6_info[8].fileTime1 = 1208205258U;
  ...
  c6_info[9].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/elfun/floor.m";
  c6_info[9].fileLength = 332U;
  c6_info[9].fileTime1 = 1203473224U;
  c6_info[9].fileTime2 = 0U;
  c6_info[10].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/elfun/abs.m";
  c6_info[10].name = "class";
  c6_info[10].dominantType = "double";
  c6_info[10].resolved = "[B]class";
  ...
  c6_info[11].fileLength = 461U;
  c6_info[11].fileTime1 = 1203473160U;
  c6_info[11].fileTime2 = 0U;
  c6_info[12].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/intmax.m";
  c6_info[12].name = "int32";
  c6_info[12].dominantType = "double";
  c6_info[12].resolved = "[B]int32";
  c6_info[12].fileLength = 0U;
  c6_info[12].fileTime1 = 0U;
  c6_info[12].fileTime2 = 0U;
  c6_info[13].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/false.m";
  c6_info[13].name = "logical";
  c6_info[13].dominantType = "double";
  c6_info[13].resolved = "[B]logical";
  c6_info[13].fileLength = 0U;
  c6_info[13].fileTime1 = 0U;
  c6_info[13].fileTime2 = 0U;
  c6_info[14].context = "";
  c6_info[14].name = "times";
  c6_info[14].dominantType = "double";
  c6_info[14].resolved = "[B]times";
  ...
  c6_info[15].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/elfun/abs.m";
  c6_info[15].fileLength = 538U;
  c6_info[15].fileTime1 = 1203473128U;
  ...
  c6_info[17].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/elfun/abs.m";
  c6_info[17].name = "zeros";
  c6_info[17].dominantType = "double";
  c6_info[17].resolved = "[B]zeros";
  ...
  c6_info[19].name = "isscalar";
  c6_info[19].dominantType = "double";
  c6_info[19].resolved = "[B]isscalar";
  ...
  c6_info[20].name = "plus";
  c6_info[20].dominantType = "double";
  c6_info[20].resolved = "[B]plus";
  ...
  c6_info[27].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/nan.m";
  c6_info[27].fileLength = 474U;
  c6_info[27].fileTime1 = 1192491944U;
  c6_info[27].fileTime2 = 0U;
  c6_info[28].context = "";
  c6_info[28].name = "length";
  c6_info[28].dominantType = "double";
  c6_info[28].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/length.m";
  c6_info[28].fileLength = 303U;
  c6_info[28].fileTime1 = 1192491938U;
  c6_info[28].fileTime2 = 0U;
  c6_info[29].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/elfun/abs.m";
  c6_info[29].name = "islogical";
  c6_info[29].dominantType = "double";
  c6_info[29].resolved = "[B]islogical";
  ...
  c6_info[30].name = "isinteger";
  c6_info[30].dominantType = "double";
  c6_info[30].resolved = "[B]isinteger";
  ...
  c6_info[31].name = "assert";
  c6_info[31].dominantType = "char";
  c6_info[31].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/lang/assert.m";
  c6_info[31].fileLength = 2684U;
  c6_info[31].fileTime1 = 1210895856U;
  ...
  c6_info[32].resolved = "[B]ne";
  c6_info[32].fileLength = 0U;
  c6_info[32].fileTime1 = 0U;
  c6_info[32].fileTime2 = 0U;
  c6_info[33].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/length.m";
  c6_info[33].name = "nargin";
  c6_info[33].dominantType = "";
  c6_info[33].resolved = "[B]nargin";
  c6_info[33].fileLength = 0U;
  c6_info[33].fileTime1 = 0U;
  c6_info[33].fileTime2 = 0U;
  c6_info[34].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_alloc.m";
  c6_info[34].name = "isstruct";
  c6_info[34].dominantType = "double";
  c6_info[34].resolved = "[B]isstruct";
  c6_info[34].fileLength = 0U;
  c6_info[34].fileTime1 = 0U;
  c6_info[34].fileTime2 = 0U;
  c6_info[35].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/datafun/sum.m";
  c6_info[35].name = "isequal";
  c6_info[35].dominantType = "double";
  c6_info[35].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/isequal.m";
  c6_info[35].fileLength = 157U;
  c6_info[35].fileTime1 = 1210895846U;
  c6_info[35].fileTime2 = 0U;
  c6_info[36].context =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_assert_valid_size_arg.m/isintegral";
  c6_info[36].name = "true";
  c6_info[36].dominantType = "";
  c6_info[36].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/true.m";
  c6_info[36].fileLength = 237U;
  c6_info[36].fileTime1 = 1192491962U;
  c6_info[36].fileTime2 = 0U;
  c6_info[37].context =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_all_or_any.m";
  c6_info[37].name = "eml_set_singleton_dim";
  c6_info[37].dominantType = "double";
  c6_info[37].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_set_singleton_dim.m";
  c6_info[37].fileLength = 398U;
  c6_info[37].fileTime1 = 1209356038U;
  c6_info[37].fileTime2 = 0U;
  c6_info[38].context =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_assert_valid_size_arg.m";
  c6_info[38].name = "isvector";
  c6_info[38].dominantType = "double";
  c6_info[38].resolved = "[B]isvector";
  ...
  c6_info[40].name = "isnan";
  c6_info[40].dominantType = "double";
  c6_info[40].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/isnan.m";
  c6_info[40].fileLength = 472U;
  c6_info[40].fileTime1 = 1192491936U;
  c6_info[40].fileTime2 = 0U;
  c6_info[41].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/all.m";
  c6_info[41].name = "eml_all_or_any";
  c6_info[41].dominantType = "char";
  c6_info[41].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_all_or_any.m";
  c6_info[41].fileLength = 3423U;
  c6_info[41].fileTime1 = 1213662886U;
  c6_info[41].fileTime2 = 0U;
  c6_info[42].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/colon.m";
  c6_info[42].name = "isa";
  c6_info[42].dominantType = "double";
  c6_info[42].resolved = "[B]isa";
  c6_info[42].fileLength = 0U;
  c6_info[42].fileTime1 = 0U;
  c6_info[42].fileTime2 = 0U;
  c6_info[43].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_alloc.m";
  c6_info[43].name = "eml_assert_valid_size_arg";
  c6_info[43].dominantType = "double";
  c6_info[43].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_assert_valid_size_arg.m";
  c6_info[43].fileLength = 2835U;
  c6_info[43].fileTime1 = 1210895844U;
  c6_info[43].fileTime2 = 0U;
  c6_info[44].context =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/colon.m/is_flint_colon";
  c6_info[44].name = "isfinite";
  c6_info[44].dominantType = "double";
  c6_info[44].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/isfinite.m";
  c6_info[44].fileLength = 341U;
  c6_info[44].fileTime1 = 1192491934U;
  ...
  c6_info[46].context =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_assert_valid_size_arg.m";
  c6_info[46].name = "isnumeric";
  c6_info[46].dominantType = "double";
  c6_info[46].resolved = "[B]isnumeric";
  c6_info[46].fileLength = 0U;
  c6_info[46].fileTime1 = 0U;
  c6_info[46].fileTime2 = 0U;
  c6_info[47].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/eps.m";
  c6_info[47].name = "eml_guarded_nan";
  c6_info[47].dominantType = "";
  c6_info[47].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_guarded_nan.m";
  c6_info[47].fileLength = 485U;
  c6_info[47].fileTime1 = 1192491980U;
  c6_info[47].fileTime2 = 0U;
  c6_info[48].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/colon.m";
  c6_info[48].name = "ge";
  c6_info[48].dominantType = "double";
  c6_info[48].resolved = "[B]ge";
  c6_info[48].fileLength = 0U;
  c6_info[48].fileTime1 = 0U;
  c6_info[48].fileTime2 = 0U;
  c6_info[49].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/colon.m";
  c6_info[49].name = "lt";
  c6_info[49].dominantType = "double";
  c6_info[49].resolved = "[B]lt";
  ...
  c6_info[51].context =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_all_or_any.m";
  c6_info[51].name = "eml_nonsingleton_dim";
  c6_info[51].dominantType = "logical";
  c6_info[51].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_nonsingleton_dim.m";
  c6_info[51].fileLength = 404U;
  c6_info[51].fileTime1 = 1192492000U;
  c6_info[51].fileTime2 = 0U;
  c6_info[52].context = "";
  c6_info[52].name = "colon";
  c6_info[52].dominantType = "double";
  c6_info[52].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/colon.m";
  c6_info[52].fileLength = 7324U;
  c6_info[52].fileTime1 = 1197325946U;
  c6_info[52].fileTime2 = 0U;
  c6_info[53].context = "";
  c6_info[53].name = "sum";
  c6_info[53].dominantType = "double";
  c6_info[53].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/datafun/sum.m";
  c6_info[53].fileLength = 2854U;
  c6_info[53].fileTime1 = 1213662886U;
  c6_info[53].fileTime2 = 0U;
  c6_info[54].context =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/isfinite.m";
  c6_info[54].name = "not";
  c6_info[54].dominantType = "logical";
  c6_info[54].resolved = "[B]not";
  ...
  c6_info[60].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/mtimes.m";
  c6_info[60].name = "strcmp";
  c6_info[60].dominantType = "char";
  c6_info[60].resolved = "[B]strcmp";
  c6_info[60].fileLength = 0U;
  c6_info[60].fileTime1 = 0U;
  c6_info[60].fileTime2 = 0U;
  c6_info[61].context =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_assert_valid_size_arg.m/numel_for_size";
  c6_info[61].name = "double";
  c6_info[61].dominantType = "double";
  c6_info[61].resolved = "[B]double";
  c6_info[61].fileLength = 0U;
  c6_info[61].fileTime1 = 0U;
  c6_info[61].fileTime2 = 0U;
  c6_info[62].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/elfun/floor.m";
  c6_info[62].name = "eml_scalar_floor";
  c6_info[62].dominantType = "double";
  c6_info[62].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/elfun/eml_scalar_floor.m";
  c6_info[62].fileLength = 260U;
  c6_info[62].fileTime1 = 1209355990U;
  c6_info[62].fileTime2 = 0U;
  c6_info[63].context =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_assert_valid_size_arg.m";
  c6_info[63].name = "intmax";
  c6_info[63].dominantType = "char";
  c6_info[63].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/intmax.m";
  c6_info[63].fileLength = 1535U;
  c6_info[63].fileTime1 = 1192491928U;
...
static void mdlSetWorkWidths_c6_aeroutilslib(SimStruct *S)
{
  ...
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    int_T chartIsInlinable =
      (int_T)sf_is_chart_inlinable("aeroutilslib","main_sim_adapt_refsp",6);
    ssSetStateflowIsInlinable(S,chartIsInlinable);
    ssSetRTWCG(S,sf_rtw_info_uint_prop("aeroutilslib","main_sim_adapt_refsp",6,
                "RTWCG"));
    ssSetEnableFcnIsTrivial(S,1);
    ssSetDisableFcnIsTrivial(S,1);
    ssSetNotMultipleInlinable(S,sf_rtw_info_uint_prop("aeroutilslib",
      "main_sim_adapt_refsp",6,"gatewayCannotBeInlinedMultipleTimes"));
    if (chartIsInlinable) {
      ssSetInputPortOptimOpts(S, 0, SS_REUSABLE_AND_LOCAL);
      sf_mark_chart_expressionable_inputs(S,"aeroutilslib",
        "main_sim_adapt_refsp",6,1);
      sf_mark_chart_reusable_outputs(S,"aeroutilslib","main_sim_adapt_refsp",6,1);
    }

    sf_set_rtw_dwork_info(S,"aeroutilslib","main_sim_adapt_refsp",6);
...
{
  if (sim_mode_is_rtw_gen(S)) {
    sf_write_symbol_mapping(S, "aeroutilslib", "main_sim_adapt_refsp",6);
