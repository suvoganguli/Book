  ...
  chartFileNumber, int_T method, void *data)
{
  ...
  if (chartFileNumber==5) {
    c5_models_method_dispatcher(simstructPtr, method, data);
    return 1;
  }
  ...
  if (nrhs>2 && mxIsChar(prhs[1])) {
    ...
    if (!strcmp(commandName,"library")) {
      ...
      if (!strcmp(machineName,"models")) {
        if (nrhs==3) {
          ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(1795124792U);
          ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(432589807U);
          ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(2488973294U);
          ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(2140602382U);
        } else if (nrhs==4) {
           ...
           case 5:
            {
              ...
              sf_c5_models_get_check_sum(plhs);
              break;
            }
  ...
  nrhs, const mxArray * prhs[] )
{
...

  {
    ...
    switch (chartFileNumber) {
     ...
     case 5:
      {
        extern mxArray *sf_c5_models_get_autoinheritance_info(void);
        plhs[0] = sf_c5_models_get_autoinheritance_info();
        break;
      }
  ...
  plhs[], int nrhs, const mxArray * prhs[] )
{
...

  {
    ...
    switch (chartFileNumber) {
     ...
     case 5:
      {
        extern const mxArray *sf_c5_models_get_eml_resolved_functions_info(void);
        mxArray *persistentMxArray = (mxArray *)
          sf_c5_models_get_eml_resolved_functions_info();
        plhs[0] = mxDuplicateArray(persistentMxArray);
        mxDestroyArray(persistentMxArray);
        break;
      }
...
{
  _modelsMachineNumber_ = sf_debug_initialize_machine("models","sfun",1,3,0,0,0);
