...
static void c6_info_helper(c6_ResolvedFunctionInfo c6_info[67])
{
  ...
  c6_info[0].resolved = "[B]ge";
  c6_info[0].fileLength = 0U;
  c6_info[0].fileTime1 = 0U;
  c6_info[0].fileTime2 = 0U;
  c6_info[1].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/colon.m";
  c6_info[1].name = "isreal";
  c6_info[1].dominantType = "double";
  c6_info[1].resolved = "[B]isreal";
  ...
  c6_info[2].name = "all";
  c6_info[2].dominantType = "logical";
  c6_info[2].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/all.m";
  c6_info[2].fileLength = 400U;
  c6_info[2].fileTime1 = 1192492104U;
  c6_info[2].fileTime2 = 0U;
  c6_info[3].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/isequal.m";
  c6_info[3].name = "eml_isequal_core";
  c6_info[3].dominantType = "double";
  c6_info[3].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_isequal_core.m";
  c6_info[3].fileLength = 3543U;
  c6_info[3].fileTime1 = 1213662886U;
  ...
  c6_info[5].context = "";
  c6_info[5].name = "uminus";
  c6_info[5].dominantType = "double";
  c6_info[5].resolved = "[B]uminus";
  ...
  c6_info[7].name = "eml_assert_valid_size_arg";
  c6_info[7].dominantType = "double";
  c6_info[7].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_assert_valid_size_arg.m";
  c6_info[7].fileLength = 2835U;
  c6_info[7].fileTime1 = 1210895844U;
  ...
  c6_info[10].name = "size";
  c6_info[10].dominantType = "double";
  c6_info[10].resolved = "[B]size";
  ...
  c6_info[20].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/colon.m";
  c6_info[20].name = "isscalar";
  c6_info[20].dominantType = "double";
  c6_info[20].resolved = "[B]isscalar";
  c6_info[20].fileLength = 0U;
  c6_info[20].fileTime1 = 0U;
  c6_info[20].fileTime2 = 0U;
  c6_info[21].context = "";
  c6_info[21].name = "minus";
  c6_info[21].dominantType = "double";
  c6_info[21].resolved = "[B]minus";
  c6_info[21].fileLength = 0U;
  c6_info[21].fileTime1 = 0U;
  c6_info[21].fileTime2 = 0U;
  c6_info[22].context =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_all_or_any.m";
  c6_info[22].name = "eml_set_singleton_dim";
  c6_info[22].dominantType = "double";
  c6_info[22].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_set_singleton_dim.m";
  c6_info[22].fileLength = 398U;
  c6_info[22].fileTime1 = 1209356038U;
  c6_info[22].fileTime2 = 0U;
  c6_info[23].context =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/isfinite.m";
  c6_info[23].name = "isinf";
  c6_info[23].dominantType = "double";
  c6_info[23].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/isinf.m";
  c6_info[23].fileLength = 472U;
  c6_info[23].fileTime1 = 1192491934U;
  c6_info[23].fileTime2 = 0U;
  c6_info[24].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/elfun/abs.m";
  c6_info[24].name = "class";
  c6_info[24].dominantType = "double";
  c6_info[24].resolved = "[B]class";
  c6_info[24].fileLength = 0U;
  c6_info[24].fileTime1 = 0U;
  c6_info[24].fileTime2 = 0U;
  c6_info[25].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/realmin.m";
  c6_info[25].name = "mpower";
  c6_info[25].dominantType = "double";
  c6_info[25].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/mpower.m";
  c6_info[25].fileLength = 3547U;
  c6_info[25].fileTime1 = 1213662888U;
  ...
  c6_info[26].resolved = "[B]le";
  c6_info[26].fileLength = 0U;
  c6_info[26].fileTime1 = 0U;
  c6_info[26].fileTime2 = 0U;
  c6_info[27].context = "";
  c6_info[27].name = "colon";
  c6_info[27].dominantType = "double";
  c6_info[27].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/colon.m";
  c6_info[27].fileLength = 7324U;
  c6_info[27].fileTime1 = 1197325946U;
  c6_info[27].fileTime2 = 0U;
  c6_info[28].context =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_assert_valid_size_arg.m";
  c6_info[28].name = "isvector";
  c6_info[28].dominantType = "double";
  c6_info[28].resolved = "[B]isvector";
  c6_info[28].fileLength = 0U;
  c6_info[28].fileTime1 = 0U;
  c6_info[28].fileTime2 = 0U;
  c6_info[29].context =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_assert_valid_size_arg.m/numel_for_size";
  c6_info[29].name = "double";
  c6_info[29].dominantType = "double";
  c6_info[29].resolved = "[B]double";
  ...
  c6_info[30].name = "ischar";
  c6_info[30].dominantType = "double";
  c6_info[30].resolved = "[B]ischar";
  ...
  c6_info[32].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/all.m";
  c6_info[32].name = "eml_all_or_any";
  c6_info[32].dominantType = "char";
  c6_info[32].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_all_or_any.m";
  c6_info[32].fileLength = 3423U;
  c6_info[32].fileTime1 = 1213662886U;
  c6_info[32].fileTime2 = 0U;
  c6_info[33].context =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_assert_valid_size_arg.m/isintegral";
  c6_info[33].name = "false";
  c6_info[33].dominantType = "";
  c6_info[33].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/false.m";
  c6_info[33].fileLength = 238U;
  c6_info[33].fileTime1 = 1192491920U;
  c6_info[33].fileTime2 = 0U;
  c6_info[34].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/eps.m";
  c6_info[34].name = "eml_guarded_nan";
  c6_info[34].dominantType = "";
  c6_info[34].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_guarded_nan.m";
  c6_info[34].fileLength = 485U;
  c6_info[34].fileTime1 = 1192491980U;
  c6_info[34].fileTime2 = 0U;
  c6_info[35].context =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/colon.m/maxabs";
  c6_info[35].name = "abs";
  c6_info[35].dominantType = "double";
  c6_info[35].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/elfun/abs.m";
  c6_info[35].fileLength = 538U;
  c6_info[35].fileTime1 = 1203473128U;
  c6_info[35].fileTime2 = 0U;
  c6_info[36].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/eps.m";
  c6_info[36].name = "real";
  c6_info[36].dominantType = "double";
  c6_info[36].resolved = "[B]real";
  c6_info[36].fileLength = 0U;
  c6_info[36].fileTime1 = 0U;
  c6_info[36].fileTime2 = 0U;
  c6_info[37].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_alloc.m";
  ...
  c6_info[38].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/mpower.m";
  c6_info[38].name = "power";
  c6_info[38].dominantType = "double";
  c6_info[38].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/power.m";
  c6_info[38].fileLength = 5131U;
  c6_info[38].fileTime1 = 1213662890U;
  c6_info[38].fileTime2 = 0U;
  c6_info[39].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/false.m";
  c6_info[39].name = "logical";
  c6_info[39].dominantType = "double";
  c6_info[39].resolved = "[B]logical";
  c6_info[39].fileLength = 0U;
  c6_info[39].fileTime1 = 0U;
  c6_info[39].fileTime2 = 0U;
  c6_info[40].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/elfun/abs.m";
  c6_info[40].name = "zeros";
  c6_info[40].dominantType = "double";
  c6_info[40].resolved = "[B]zeros";
  ...
  c6_info[41].name = "isfinite";
  c6_info[41].dominantType = "double";
  c6_info[41].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/isfinite.m";
  c6_info[41].fileLength = 341U;
  c6_info[41].fileTime1 = 1192491934U;
  c6_info[41].fileTime2 = 0U;
  c6_info[42].context =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/isfinite.m";
  c6_info[42].name = "isnan";
  c6_info[42].dominantType = "double";
  c6_info[42].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/isnan.m";
  c6_info[42].fileLength = 472U;
  c6_info[42].fileTime1 = 1192491936U;
  c6_info[42].fileTime2 = 0U;
  c6_info[43].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/mtimes.m";
  c6_info[43].name = "strcmp";
  c6_info[43].dominantType = "char";
  c6_info[43].resolved = "[B]strcmp";
  ...
  c6_info[44].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/mtimes.m";
  c6_info[44].fileLength = 2336U;
  c6_info[44].fileTime1 = 1213662890U;
  ...
  c6_info[46].name = "eml_scalar_abs";
  c6_info[46].dominantType = "double";
  c6_info[46].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/elfun/eml_scalar_abs.m";
  c6_info[46].fileLength = 461U;
  c6_info[46].fileTime1 = 1203473160U;
  ...
  c6_info[48].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/elfun/floor.m";
  ...
  c6_info[48].fileLength = 260U;
  c6_info[48].fileTime1 = 1209355990U;
  c6_info[48].fileTime2 = 0U;
  c6_info[49].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/intmax.m";
  c6_info[49].name = "int32";
  c6_info[49].dominantType = "double";
  c6_info[49].resolved = "[B]int32";
  c6_info[49].fileLength = 0U;
  c6_info[49].fileTime1 = 0U;
  c6_info[49].fileTime2 = 0U;
  c6_info[50].context =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/colon.m/is_flint_colon";
  c6_info[50].name = "floor";
  c6_info[50].dominantType = "double";
  c6_info[50].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/elfun/floor.m";
  c6_info[50].fileLength = 332U;
  c6_info[50].fileTime1 = 1203473224U;
  c6_info[50].fileTime2 = 0U;
  c6_info[51].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/length.m";
  c6_info[51].name = "gt";
  c6_info[51].dominantType = "double";
  c6_info[51].resolved = "[B]gt";
  ...
  c6_info[52].name = "eml_scalexp_compatible";
  c6_info[52].dominantType = "double";
  c6_info[52].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_scalexp_compatible.m";
  c6_info[52].fileLength = 502U;
  c6_info[52].fileTime1 = 1208205258U;
  c6_info[52].fileTime2 = 0U;
  c6_info[53].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/colon.m";
  c6_info[53].name = "isa";
  c6_info[53].dominantType = "double";
  c6_info[53].resolved = "[B]isa";
  ...
  c6_info[54].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/eps.m";
  c6_info[54].fileLength = 1342U;
  c6_info[54].fileTime1 = 1210895846U;
  c6_info[54].fileTime2 = 0U;
  c6_info[55].context =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_assert_valid_size_arg.m";
  c6_info[55].name = "eml_index_class";
  c6_info[55].dominantType = "";
  c6_info[55].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_index_class.m";
  c6_info[55].fileLength = 909U;
  c6_info[55].fileTime1 = 1192491982U;
  c6_info[55].fileTime2 = 0U;
  c6_info[56].context =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/isfinite.m";
  c6_info[56].name = "not";
  c6_info[56].dominantType = "logical";
  c6_info[56].resolved = "[B]not";
  c6_info[56].fileLength = 0U;
  c6_info[56].fileTime1 = 0U;
  c6_info[56].fileTime2 = 0U;
  c6_info[57].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/power.m";
  c6_info[57].name = "eml_scalexp_size";
  c6_info[57].dominantType = "double";
  c6_info[57].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_scalexp_size.m";
  c6_info[57].fileLength = 1373U;
  c6_info[57].fileTime1 = 1208205260U;
  c6_info[57].fileTime2 = 0U;
  c6_info[58].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/colon.m";
  c6_info[58].name = "isinteger";
  c6_info[58].dominantType = "double";
  c6_info[58].resolved = "[B]isinteger";
  c6_info[58].fileLength = 0U;
  c6_info[58].fileTime1 = 0U;
  c6_info[58].fileTime2 = 0U;
  c6_info[59].context =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_assert_valid_size_arg.m";
  c6_info[59].name = "intmax";
  c6_info[59].dominantType = "char";
  c6_info[59].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/intmax.m";
  c6_info[59].fileLength = 1535U;
  c6_info[59].fileTime1 = 1192491928U;
  c6_info[59].fileTime2 = 0U;
  c6_info[60].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/elfun/abs.m";
  c6_info[60].name = "islogical";
  c6_info[60].dominantType = "double";
  c6_info[60].resolved = "[B]islogical";
  ...
  c6_info[61].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/nan.m";
  c6_info[61].fileLength = 474U;
  c6_info[61].fileTime1 = 1192491944U;
  c6_info[61].fileTime2 = 0U;
  c6_info[62].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/eps.m";
  c6_info[62].name = "eml_alloc";
  c6_info[62].dominantType = "double";
  c6_info[62].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_alloc.m";
  c6_info[62].fileLength = 2627U;
...
static void mdlSetWorkWidths_c6_aeroutilslib(SimStruct *S)
{
  ...
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    int_T chartIsInlinable =
      (int_T)sf_is_chart_inlinable("aeroutilslib","gtm_design_dbg",6);
    ssSetStateflowIsInlinable(S,chartIsInlinable);
    ssSetRTWCG(S,sf_rtw_info_uint_prop("aeroutilslib","gtm_design_dbg",6,"RTWCG"));
    ssSetEnableFcnIsTrivial(S,1);
    ssSetDisableFcnIsTrivial(S,1);
    ssSetNotMultipleInlinable(S,sf_rtw_info_uint_prop("aeroutilslib",
      "gtm_design_dbg",6,"gatewayCannotBeInlinedMultipleTimes"));
    if (chartIsInlinable) {
      ssSetInputPortOptimOpts(S, 0, SS_REUSABLE_AND_LOCAL);
      sf_mark_chart_expressionable_inputs(S,"aeroutilslib","gtm_design_dbg",6,1);
      sf_mark_chart_reusable_outputs(S,"aeroutilslib","gtm_design_dbg",6,1);
    }

    sf_set_rtw_dwork_info(S,"aeroutilslib","gtm_design_dbg",6);
...
{
  if (sim_mode_is_rtw_gen(S)) {
    sf_write_symbol_mapping(S, "aeroutilslib", "gtm_design_dbg",6);
