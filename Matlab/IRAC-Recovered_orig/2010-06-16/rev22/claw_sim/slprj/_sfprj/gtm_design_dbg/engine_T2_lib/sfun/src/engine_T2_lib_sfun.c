  ...
  if (nrhs>2 && mxIsChar(prhs[1])) {
    ...
    if (!strcmp(commandName,"library")) {
      ...
      if (!strcmp(machineName,"engine_T2_lib")) {
        if (nrhs==3) {
          ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(1518924247U);
          ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(3104605064U);
          ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(2530523828U);
          ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(225111765U);
        } else if (nrhs==4) {
