  ...
  if (nrhs>2 && mxIsChar(prhs[1])) {
    ...
    if (!strcmp(commandName,"library")) {
      ...
      if (!strcmp(machineName,"aeroutilslib")) {
        if (nrhs==3) {
          ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(1141756132U);
          ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(2812985226U);
          ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(3890858103U);
          ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(185963740U);
        } else if (nrhs==4) {
