...
static void c4_info_helper(c4_ResolvedFunctionInfo c4_info[45])
{
  ...
  c4_info[0].name = "false";
  c4_info[0].dominantType = "";
  c4_info[0].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/false.m";
  c4_info[0].fileLength = 238U;
  c4_info[0].fileTime1 = 1192491920U;
  c4_info[0].fileTime2 = 0U;
  c4_info[1].context =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_assert_valid_size_arg.m";
  c4_info[1].name = "intmax";
  c4_info[1].dominantType = "char";
  c4_info[1].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/intmax.m";
  c4_info[1].fileLength = 1535U;
  c4_info[1].fileTime1 = 1192491928U;
  ...
  c4_info[4].resolved = "[B]ones";
  c4_info[4].fileLength = 0U;
  c4_info[4].fileTime1 = 0U;
  c4_info[4].fileTime2 = 0U;
  c4_info[5].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/intmax.m";
  c4_info[5].name = "int32";
  c4_info[5].dominantType = "double";
  c4_info[5].resolved = "[B]int32";
  c4_info[5].fileLength = 0U;
  c4_info[5].fileTime1 = 0U;
  c4_info[5].fileTime2 = 0U;
  c4_info[6].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/false.m";
  c4_info[6].name = "logical";
  c4_info[6].dominantType = "double";
  c4_info[6].resolved = "[B]logical";
  ...
  c4_info[9].name = "isscalar";
  c4_info[9].dominantType = "double";
  c4_info[9].resolved = "[B]isscalar";
  ...
  c4_info[10].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/datafun/min.m";
  c4_info[10].fileLength = 308U;
  c4_info[10].fileTime1 = 1192491834U;
  c4_info[10].fileTime2 = 0U;
  c4_info[11].context =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_assert_valid_size_arg.m/numel_for_size";
  c4_info[11].name = "double";
  c4_info[11].dominantType = "double";
  c4_info[11].resolved = "[B]double";
  ...
  c4_info[19].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/ops/mtimes.m";
  c4_info[19].fileLength = 2336U;
  c4_info[19].fileTime1 = 1213662890U;
  c4_info[19].fileTime2 = 0U;
  c4_info[20].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/datafun/min.m";
  c4_info[20].name = "eml_min_or_max";
  c4_info[20].dominantType = "char";
  c4_info[20].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_min_or_max.m";
  c4_info[20].fileLength = 7562U;
  c4_info[20].fileTime1 = 1213662886U;
  c4_info[20].fileTime2 = 0U;
  c4_info[21].context =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/datatypes/cast.m";
  c4_info[21].name = "ge";
  c4_info[21].dominantType = "double";
  c4_info[21].resolved = "[B]ge";
  ...
  c4_info[28].context =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_min_or_max.m";
  c4_info[28].name = "isreal";
  c4_info[28].dominantType = "double";
  c4_info[28].resolved = "[B]isreal";
  ...
  c4_info[30].context =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/isfinite.m";
  c4_info[30].name = "isnan";
  c4_info[30].dominantType = "double";
  c4_info[30].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/isnan.m";
  c4_info[30].fileLength = 472U;
  c4_info[30].fileTime1 = 1192491936U;
  c4_info[30].fileTime2 = 0U;
  c4_info[31].context =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_assert_valid_size_arg.m/isintegral";
  c4_info[31].name = "ne";
  c4_info[31].dominantType = "double";
  c4_info[31].resolved = "[B]ne";
  c4_info[31].fileLength = 0U;
  c4_info[31].fileTime1 = 0U;
  c4_info[31].fileTime2 = 0U;
  c4_info[32].context =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_scalexp_size.m";
  c4_info[32].name = "eml_scalexp_compatible";
  c4_info[32].dominantType = "double";
  c4_info[32].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_scalexp_compatible.m";
  c4_info[32].fileLength = 502U;
  c4_info[32].fileTime1 = 1208205258U;
  c4_info[32].fileTime2 = 0U;
  c4_info[33].context = "";
  c4_info[33].name = "max";
  c4_info[33].dominantType = "double";
  c4_info[33].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/datafun/max.m";
  c4_info[33].fileLength = 308U;
  c4_info[33].fileTime1 = 1192491830U;
  ...
  c4_info[35].context =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_assert_valid_size_arg.m";
  c4_info[35].name = "eml_index_class";
  c4_info[35].dominantType = "";
  c4_info[35].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_index_class.m";
  c4_info[35].fileLength = 909U;
  c4_info[35].fileTime1 = 1192491982U;
  ...
  c4_info[38].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/datafun/min.m";
  c4_info[38].name = "nargout";
  c4_info[38].dominantType = "";
  c4_info[38].resolved = "[B]nargout";
  ...
  c4_info[40].context =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_alloc.m/zerosum";
  c4_info[40].name = "cast";
  c4_info[40].dominantType = "double";
  c4_info[40].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/datatypes/cast.m";
  c4_info[40].fileLength = 866U;
  c4_info[40].fileTime1 = 1192491844U;
  c4_info[40].fileTime2 = 0U;
  c4_info[41].context =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/isfinite.m";
  c4_info[41].name = "isinf";
  c4_info[41].dominantType = "double";
  c4_info[41].resolved = "[I]$matlabroot$/toolbox/eml/lib/matlab/elmat/isinf.m";
  c4_info[41].fileLength = 472U;
  c4_info[41].fileTime1 = 1192491934U;
  ...
  c4_info[43].context =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_min_or_max.m/eml_bin_extremum";
  c4_info[43].name = "eml_scalexp_size";
  c4_info[43].dominantType = "double";
  c4_info[43].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_scalexp_size.m";
  c4_info[43].fileLength = 1373U;
  c4_info[43].fileTime1 = 1208205260U;
  c4_info[43].fileTime2 = 0U;
  c4_info[44].context = "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_alloc.m";
  c4_info[44].name = "eml_assert_valid_size_arg";
  c4_info[44].dominantType = "double";
  c4_info[44].resolved =
    "[I]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_assert_valid_size_arg.m";
  c4_info[44].fileLength = 2835U;
  c4_info[44].fileTime1 = 1210895844U;
...
static void mdlSetWorkWidths_c4_models(SimStruct *S)
{
  ...
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    int_T chartIsInlinable =
      (int_T)sf_is_chart_inlinable("models","main_sim_claw_main_sf",4);
    ssSetStateflowIsInlinable(S,chartIsInlinable);
    ssSetRTWCG(S,sf_rtw_info_uint_prop("models","main_sim_claw_main_sf",4,
                "RTWCG"));
    ssSetEnableFcnIsTrivial(S,1);
    ssSetDisableFcnIsTrivial(S,1);
    ssSetNotMultipleInlinable(S,sf_rtw_info_uint_prop("models",
      "main_sim_claw_main_sf",4,"gatewayCannotBeInlinedMultipleTimes"));
    if (chartIsInlinable) {
      ssSetInputPortOptimOpts(S, 0, SS_REUSABLE_AND_LOCAL);
      sf_mark_chart_expressionable_inputs(S,"models","main_sim_claw_main_sf",4,1);
      sf_mark_chart_reusable_outputs(S,"models","main_sim_claw_main_sf",4,1);
    }

    sf_set_rtw_dwork_info(S,"models","main_sim_claw_main_sf",4);
...
{
  if (sim_mode_is_rtw_gen(S)) {
    sf_write_symbol_mapping(S, "models", "main_sim_claw_main_sf",4);
